<template><div><h1 id="网关" tabindex="-1"><a class="header-anchor" href="#网关" aria-hidden="true">#</a> 网关</h1>
<h2 id="何为网关-为什么要网关" tabindex="-1"><a class="header-anchor" href="#何为网关-为什么要网关" aria-hidden="true">#</a> 何为网关？为什么要网关？</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">curl</span> <span class="token parameter variable">-X</span> POST http://kong:8001/services/<span class="token punctuation">{</span>service<span class="token punctuation">}</span>/plugins <span class="token punctuation">\</span>
