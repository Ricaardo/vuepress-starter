<template><div><h2 id="一-osi-与-tcp-ip-各层的结构与功能-都有哪些协议" tabindex="-1"><a class="header-anchor" href="#一-osi-与-tcp-ip-各层的结构与功能-都有哪些协议" aria-hidden="true">#</a> 一 OSI 与 TCP/IP 各层的结构与功能, 都有哪些协议?</h2>
...
<h3 id="_1-1-应用层" tabindex="-1"><a class="header-anchor" href="#_1-1-应用层" aria-hidden="true">#</a> 1.1 应用层</h3>
...
<h3 id="_1-2-运输层" tabindex="-1"><a class="header-anchor" href="#_1-2-运输层" aria-hidden="true">#</a> 1.2 运输层</h3>
...
<h3 id="_1-3-网络层" tabindex="-1"><a class="header-anchor" href="#_1-3-网络层" aria-hidden="true">#</a> 1.3 网络层</h3>
...
<h3 id="_1-4-数据链路层" tabindex="-1"><a class="header-anchor" href="#_1-4-数据链路层" aria-hidden="true">#</a> 1.4 数据链路层</h3>
...
<h3 id="_1-5-物理层" tabindex="-1"><a class="header-anchor" href="#_1-5-物理层" aria-hidden="true">#</a> 1.5 物理层</h3>
...
<h3 id="_1-6-总结一下" tabindex="-1"><a class="header-anchor" href="#_1-6-总结一下" aria-hidden="true">#</a> 1.6 总结一下</h3>
<p>上面我们对计算机网络的五层体系结构有了初步的了解，下面附送一张七层体系结构图总结一下（图片来源于网络）。</p>
<p><img src="images/七层体系结构图.png" alt="七层体系结构图"></p>
<h2 id="二-tcp-三次握手和四次挥手-面试常客" tabindex="-1"><a class="header-anchor" href="#二-tcp-三次握手和四次挥手-面试常客" aria-hidden="true">#</a> 二 TCP 三次握手和四次挥手(面试常客)</h2>
<p>为了准确无误地把数据送达目标处，TCP 协议采用了三次握手策略。</p>
<h3 id="_2-1-tcp-三次握手漫画图解" tabindex="-1"><a class="header-anchor" href="#_2-1-tcp-三次握手漫画图解" aria-hidden="true">#</a> 2.1 TCP 三次握手漫画图解</h3>
...
<h3 id="_2-2-为什么要三次握手" tabindex="-1"><a class="header-anchor" href="#_2-2-为什么要三次握手" aria-hidden="true">#</a> 2.2 为什么要三次握手</h3>
...
<h3 id="_2-3-第-2-次握手传回了-ack-为什么还要传回-syn" tabindex="-1"><a class="header-anchor" href="#_2-3-第-2-次握手传回了-ack-为什么还要传回-syn" aria-hidden="true">#</a> 2.3 第 2 次握手传回了 ACK，为什么还要传回 SYN？</h3>
...
<h3 id="_2-5-为什么要四次挥手" tabindex="-1"><a class="header-anchor" href="#_2-5-为什么要四次挥手" aria-hidden="true">#</a> 2.5 为什么要四次挥手</h3>
...
<p>上面讲的比较概括，推荐一篇讲的比较细致的文章：<a href="https://blog.csdn.net/qzcsu/article/details/72861891" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/qzcsu/article/details/72861891<ExternalLinkIcon/></a></p>
<h2 id="三-tcp-udp-协议的区别" tabindex="-1"><a class="header-anchor" href="#三-tcp-udp-协议的区别" aria-hidden="true">#</a> 三 TCP, UDP 协议的区别</h2>
...
<h2 id="四-tcp-协议如何保证可靠传输" tabindex="-1"><a class="header-anchor" href="#四-tcp-协议如何保证可靠传输" aria-hidden="true">#</a> 四 TCP 协议如何保证可靠传输</h2>
<ol>
...
<h3 id="_4-1-arq-协议" tabindex="-1"><a class="header-anchor" href="#_4-1-arq-协议" aria-hidden="true">#</a> 4.1 ARQ 协议</h3>
...
<h4 id="停止等待-arq-协议" tabindex="-1"><a class="header-anchor" href="#停止等待-arq-协议" aria-hidden="true">#</a> 停止等待 ARQ 协议</h4>
...
<h4 id="连续-arq-协议" tabindex="-1"><a class="header-anchor" href="#连续-arq-协议" aria-hidden="true">#</a> 连续 ARQ 协议</h4>
...
<h3 id="_4-2-滑动窗口和流量控制" tabindex="-1"><a class="header-anchor" href="#_4-2-滑动窗口和流量控制" aria-hidden="true">#</a> 4.2 滑动窗口和流量控制</h3>
...
<h3 id="_4-3-拥塞控制" tabindex="-1"><a class="header-anchor" href="#_4-3-拥塞控制" aria-hidden="true">#</a> 4.3 拥塞控制</h3>
...
<h2 id="五-在浏览器中输入-url-地址-显示主页的过程-面试常客" tabindex="-1"><a class="header-anchor" href="#五-在浏览器中输入-url-地址-显示主页的过程-面试常客" aria-hidden="true">#</a> 五 在浏览器中输入 url 地址 -&gt;&gt; 显示主页的过程(面试常客)</h2>
<p>百度好像最喜欢问这个问题。</p>
<blockquote>
...
<p>具体可以参考下面这篇文章：</p>
<ul>
<li><a href="https://segmentfault.com/a/1190000006879700" target="_blank" rel="noopener noreferrer">https://segmentfault.com/a/1190000006879700<ExternalLinkIcon/></a></li>
</ul>
<h2 id="六-状态码" tabindex="-1"><a class="header-anchor" href="#六-状态码" aria-hidden="true">#</a> 六 状态码</h2>
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019/7/状态码.png" alt="状态码"></p>
<h2 id="七-各种协议与-http-协议之间的关系" tabindex="-1"><a class="header-anchor" href="#七-各种协议与-http-协议之间的关系" aria-hidden="true">#</a> 七 各种协议与 HTTP 协议之间的关系</h2>
...
<h2 id="八-http-长连接-短连接" tabindex="-1"><a class="header-anchor" href="#八-http-长连接-短连接" aria-hidden="true">#</a> 八 HTTP 长连接, 短连接</h2>
...
<h2 id="九-http-是不保存状态的协议-如何保存用户状态" tabindex="-1"><a class="header-anchor" href="#九-http-是不保存状态的协议-如何保存用户状态" aria-hidden="true">#</a> 九 HTTP 是不保存状态的协议, 如何保存用户状态?</h2>
...
<h2 id="十-cookie-的作用是什么-和-session-有什么区别" tabindex="-1"><a class="header-anchor" href="#十-cookie-的作用是什么-和-session-有什么区别" aria-hidden="true">#</a> 十 Cookie 的作用是什么? 和 Session 有什么区别？</h2>
...
<h2 id="十一-http-1-0-和-http-1-1-的主要区别是什么" tabindex="-1"><a class="header-anchor" href="#十一-http-1-0-和-http-1-1-的主要区别是什么" aria-hidden="true">#</a> 十一 HTTP 1.0 和 HTTP 1.1 的主要区别是什么?</h2>
<blockquote>
<p>这部分回答引用这篇文章 <a href="https://mp.weixin.qq.com/s/GICbiyJpINrHZ41u_4zT-A?" target="_blank" rel="noopener noreferrer">https://mp.weixin.qq.com/s/GICbiyJpINrHZ41u_4zT-A?<ExternalLinkIcon/></a> 的一些内容。</p>
</blockquote>
...
<h2 id="十二-uri-和-url-的区别是什么" tabindex="-1"><a class="header-anchor" href="#十二-uri-和-url-的区别是什么" aria-hidden="true">#</a> 十二 URI 和 URL 的区别是什么?</h2>
<ul>
...
<h2 id="十三-http-和-https-的区别" tabindex="-1"><a class="header-anchor" href="#十三-http-和-https-的区别" aria-hidden="true">#</a> 十三 HTTP 和 HTTPS 的区别？</h2>
<ol>
...
<ul>
<li><a href="https://blog.csdn.net/qq_16209077/article/details/52718250" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/qq_16209077/article/details/52718250<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/zixiaomuwu/article/details/60965466" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/zixiaomuwu/article/details/60965466<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/turn__back/article/details/73743641" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/turn__back/article/details/73743641<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s/GICbiyJpINrHZ41u_4zT-A?" target="_blank" rel="noopener noreferrer">https://mp.weixin.qq.com/s/GICbiyJpINrHZ41u_4zT-A?<ExternalLinkIcon/></a></li>
</ul>
</div></template>
