<template><div><p>大家好，我是 Guide 哥！</p>
...
<p>关于如何学习操作系统，可以看这篇回答：<a href="https://www.zhihu.com/question/270998611/answer/1640198217" target="_blank" rel="noopener noreferrer">https://www.zhihu.com/question/270998611/answer/1640198217<ExternalLinkIcon/></a>。</p>
<h2 id="一-操作系统基础" tabindex="-1"><a class="header-anchor" href="#一-操作系统基础" aria-hidden="true">#</a> 一 操作系统基础</h2>
...
<h3 id="_1-1-什么是操作系统" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是操作系统" aria-hidden="true">#</a> 1.1 什么是操作系统？</h3>
...
<h3 id="_1-2-系统调用" tabindex="-1"><a class="header-anchor" href="#_1-2-系统调用" aria-hidden="true">#</a> 1.2 系统调用</h3>
...
<h2 id="二-进程和线程" tabindex="-1"><a class="header-anchor" href="#二-进程和线程" aria-hidden="true">#</a> 二 进程和线程</h2>
<h3 id="_2-1-进程和线程的区别" tabindex="-1"><a class="header-anchor" href="#_2-1-进程和线程的区别" aria-hidden="true">#</a> 2.1 进程和线程的区别</h3>
...
<blockquote>
<p>如果你对 Java 内存区域 (运行时数据区) 这部分知识不太了解的话可以阅读一下这篇文章：<a href="https://snailclimb.gitee.io/javaguide/#/docs/java/jvm/Java%E5%86%85%E5%AD%98%E5%8C%BA%E5%9F%9F" target="_blank" rel="noopener noreferrer">《可能是把 Java 内存区域讲的最清楚的一篇文章》<ExternalLinkIcon/></a></p>
</blockquote>
...
<h3 id="_2-3-进程间的通信方式" tabindex="-1"><a class="header-anchor" href="#_2-3-进程间的通信方式" aria-hidden="true">#</a> 2.3 进程间的通信方式</h3>
<p>👨‍💻<strong>面试官</strong> ：<strong>进程间的通信常见的的有哪几种方式呢?</strong></p>
<p>🙋 <strong>我</strong> ：大概有 7 种常见的进程间的通信方式。</p>
<blockquote>
<p>下面这部分总结参考了:<a href="https://www.jianshu.com/p/c1015f5ffa74" target="_blank" rel="noopener noreferrer">《进程间通信 IPC (InterProcess Communication)》<ExternalLinkIcon/></a> 这篇文章，推荐阅读，总结的非常不错。</p>
</blockquote>
<ol>
...
<h3 id="_2-4-线程间的同步的方式" tabindex="-1"><a class="header-anchor" href="#_2-4-线程间的同步的方式" aria-hidden="true">#</a> 2.4 线程间的同步的方式</h3>
...
<li><strong>事件(Event)</strong> ：Wait/Notify：通过通知操作的方式来保持多线程同步，还可以方便地实现多线程优先级的比较操作。</li>
</ol>
<h3 id="_2-5-进程的调度算法" tabindex="-1"><a class="header-anchor" href="#_2-5-进程的调度算法" aria-hidden="true">#</a> 2.5 进程的调度算法</h3>
...
<h3 id="_2-6-什么是死锁" tabindex="-1"><a class="header-anchor" href="#_2-6-什么是死锁" aria-hidden="true">#</a> 2.6 什么是死锁</h3>
...
<h3 id="_2-7-死锁的四个条件" tabindex="-1"><a class="header-anchor" href="#_2-7-死锁的四个条件" aria-hidden="true">#</a> 2.7 死锁的四个条件</h3>
...
<li><strong>循环等待</strong>：有一组等待进程 <code v-pre>{P0, P1,..., Pn}</code>，  <code v-pre>P0</code> 等待的资源被 <code v-pre>P1</code> 占有，<code v-pre>P1</code> 等待的资源被 <code v-pre>P2</code> 占有，......，<code v-pre>Pn-1</code> 等待的资源被 <code v-pre>Pn</code> 占有，<code v-pre>Pn</code> 等待的资源被 <code v-pre>P0</code> 占有。</li>
</ul>
<p>注意，只有四个条件同时成立时，死锁才会出现。</p>
<h2 id="三-操作系统内存管理基础" tabindex="-1"><a class="header-anchor" href="#三-操作系统内存管理基础" aria-hidden="true">#</a> 三 操作系统内存管理基础</h2>
<h3 id="_3-1-内存管理介绍" tabindex="-1"><a class="header-anchor" href="#_3-1-内存管理介绍" aria-hidden="true">#</a> 3.1 内存管理介绍</h3>
...
<h3 id="_3-2-常见的几种内存管理机制" tabindex="-1"><a class="header-anchor" href="#_3-2-常见的几种内存管理机制" aria-hidden="true">#</a> 3.2 常见的几种内存管理机制</h3>
...
<h3 id="_3-3-快表和多级页表" tabindex="-1"><a class="header-anchor" href="#_3-3-快表和多级页表" aria-hidden="true">#</a> 3.3 快表和多级页表</h3>
...
<h4 id="快表" tabindex="-1"><a class="header-anchor" href="#快表" aria-hidden="true">#</a> 快表</h4>
...
<h4 id="多级页表" tabindex="-1"><a class="header-anchor" href="#多级页表" aria-hidden="true">#</a> 多级页表</h4>
<p>引入多级页表的主要目的是为了避免把全部页表一直放在内存中占用过多空间，特别是那些根本就不需要的页表就不需要保留在内存中。多级页表属于时间换空间的典型场景，具体可以查看下面这篇文章</p>
<ul>
<li>多级页表如何节约内存：<a href="https://www.polarxiong.com/archives/%E5%A4%9A%E7%BA%A7%E9%A1%B5%E8%A1%A8%E5%A6%82%E4%BD%95%E8%8A%82%E7%BA%A6%E5%86%85%E5%AD%98.html" target="_blank" rel="noopener noreferrer">https://www.polarxiong.com/archives/多级页表如何节约内存.html<ExternalLinkIcon/></a></li>
</ul>
...
<h3 id="_3-4-分页机制和分段机制的共同点和区别" tabindex="-1"><a class="header-anchor" href="#_3-4-分页机制和分段机制的共同点和区别" aria-hidden="true">#</a> 3.4 分页机制和分段机制的共同点和区别</h3>
...
<h3 id="_3-5-逻辑-虚拟-地址和物理地址" tabindex="-1"><a class="header-anchor" href="#_3-5-逻辑-虚拟-地址和物理地址" aria-hidden="true">#</a> 3.5 逻辑(虚拟)地址和物理地址</h3>
...
<h2 id="四-虚拟内存" tabindex="-1"><a class="header-anchor" href="#四-虚拟内存" aria-hidden="true">#</a> 四 虚拟内存</h2>
<h3 id="_4-1-什么是虚拟内存-virtual-memory" tabindex="-1"><a class="header-anchor" href="#_4-1-什么是虚拟内存-virtual-memory" aria-hidden="true">#</a> 4.1 什么是虚拟内存(Virtual Memory)?</h3>
...
<p><strong>虚拟内存</strong>是计算机系统内存管理的一种技术，我们可以手动设置自己电脑的虚拟内存。不要单纯认为虚拟内存只是“使用硬盘空间来扩展内存“的技术。<strong>虚拟内存的重要意义是它定义了一个连续的虚拟地址空间</strong>，并且 <strong>把内存扩展到硬盘空间</strong>。推荐阅读：<a href="https://juejin.im/post/59f8691b51882534af254317" target="_blank" rel="noopener noreferrer">《虚拟内存的那点事儿》<ExternalLinkIcon/></a></p>
<p>维基百科中有几句话是这样介绍虚拟内存的。</p>
<blockquote>
<p><strong>虚拟内存</strong> 使得应用程序认为它拥有连续的可用的内存（一个连续完整的地址空间），而实际上，它通常是被分隔成多个物理内存碎片，还有部分暂时存储在外部磁盘存储器上，在需要时进行数据交换。与没有使用虚拟内存技术的系统相比，使用这种技术的系统使得大型程序的编写变得更容易，对真正的物理内存（例如 RAM）的使用也更有效率。目前，大多数操作系统都使用了虚拟内存，如 Windows 家族的“虚拟内存”；Linux 的“交换空间”等。From:<a href="https://zh.wikipedia.org/wiki/%E8%99%9A%E6%8B%9F%E5%86%85%E5%AD%98" target="_blank" rel="noopener noreferrer">https://zh.wikipedia.org/wiki/虚拟内存<ExternalLinkIcon/></a></p>
</blockquote>
<h3 id="_4-2-局部性原理" tabindex="-1"><a class="header-anchor" href="#_4-2-局部性原理" aria-hidden="true">#</a> 4.2 局部性原理</h3>
...
<h3 id="_4-3-虚拟存储器" tabindex="-1"><a class="header-anchor" href="#_4-3-虚拟存储器" aria-hidden="true">#</a> 4.3 虚拟存储器</h3>
<blockquote>
...
<p>🙋 <strong>我</strong> ：</p>
<blockquote>
<p>这部分内容来自：<a href="https://wizardforcel.gitbooks.io/wangdaokaoyan-os/content/13.html" target="_blank" rel="noopener noreferrer">王道考研操作系统知识点整理<ExternalLinkIcon/></a>。</p>
</blockquote>
...
<h3 id="_4-4-虚拟内存的技术实现" tabindex="-1"><a class="header-anchor" href="#_4-4-虚拟内存的技术实现" aria-hidden="true">#</a> 4.4 虚拟内存的技术实现</h3>
...
<h3 id="_4-5-页面置换算法" tabindex="-1"><a class="header-anchor" href="#_4-5-页面置换算法" aria-hidden="true">#</a> 4.5 页面置换算法</h3>
...
<li><a href="https://book.douban.com/subject/1230413/" target="_blank" rel="noopener noreferrer">《深入理解计算机系统》<ExternalLinkIcon/></a></li>
<li><a href="https://zh.wikipedia.org/wiki/%E8%BE%93%E5%85%A5%E8%BE%93%E5%87%BA%E5%86%85%E5%AD%98%E7%AE%A1%E7%90%86%E5%8D%95%E5%85%83" target="_blank" rel="noopener noreferrer">https://zh.wikipedia.org/wiki/输入输出内存管理单元<ExternalLinkIcon/></a></li>
<li><a href="https://baike.baidu.com/item/%E5%BF%AB%E8%A1%A8/19781679" target="_blank" rel="noopener noreferrer">https://baike.baidu.com/item/快表/19781679<ExternalLinkIcon/></a></li>
<li>https://www.jianshu.com/p/1d47ed0b46d5</li>
<li><a href="https://www.studytonight.com/operating-system" target="_blank" rel="noopener noreferrer">https://www.studytonight.com/operating-system<ExternalLinkIcon/></a></li>
<li><a href="https://www.geeksforgeeks.org/interprocess-communication-methods/" target="_blank" rel="noopener noreferrer">https://www.geeksforgeeks.org/interprocess-communication-methods/<ExternalLinkIcon/></a></li>
<li><a href="https://juejin.im/post/59f8691b51882534af254317" target="_blank" rel="noopener noreferrer">https://juejin.im/post/59f8691b51882534af254317<ExternalLinkIcon/></a></li>
