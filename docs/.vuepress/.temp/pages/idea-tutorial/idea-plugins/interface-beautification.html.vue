...
<p><img src="@source/idea-tutorial/idea-plugins/pictures/power-mode/Power-Mode-II.gif" alt="Power Mode II 效果图"></p>
...
<p>我们可以在设置中进行相关的配置:</p>
<p><img src="@source/idea-tutorial/idea-plugins/pictures/grep-console/grep-console2.png" alt=""></p>
<p>配置完成之后的 log warn 的效果对比图如下：</p>
<p><img src="@source/idea-tutorial/idea-plugins/pictures/grep-console/grep-console3.png" alt=""></p>
<p><strong>2. 过滤控制台输出</strong></p>
<p><img src="@source/idea-tutorial/idea-plugins/pictures/grep-console/grep-console.gif" alt=""></p>
...
<p><img src="@source/idea-tutorial/idea-plugins/pictures/rainbow-brackets.png" alt=""></p>
</div></template>
