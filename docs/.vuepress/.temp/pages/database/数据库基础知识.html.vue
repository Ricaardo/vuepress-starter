<template><div><p>数据库知识基础，这部分内容一定要理解记忆。虽然这部分内容只是理论知识，但是非常重要，这是后面学习 MySQL 数据库的基础。PS: 这部分内容由于涉及太多概念性内容，所以参考了维基百科和百度百科相应的介绍。</p>
<h2 id="什么是数据库-数据库管理系统-数据库系统-数据库管理员" tabindex="-1"><a class="header-anchor" href="#什么是数据库-数据库管理系统-数据库系统-数据库管理员" aria-hidden="true">#</a> 什么是数据库, 数据库管理系统, 数据库系统, 数据库管理员?</h2>
<ul>
...
<h2 id="什么是元组-码-候选码-主码-外码-主属性-非主属性" tabindex="-1"><a class="header-anchor" href="#什么是元组-码-候选码-主码-外码-主属性-非主属性" aria-hidden="true">#</a> 什么是元组, 码, 候选码, 主码, 外码, 主属性, 非主属性？</h2>
<ul>
...
<h2 id="主键和外键有什么区别" tabindex="-1"><a class="header-anchor" href="#主键和外键有什么区别" aria-hidden="true">#</a> 主键和外键有什么区别?</h2>
<ul>
...
<h2 id="为什么不推荐使用外键与级联" tabindex="-1"><a class="header-anchor" href="#为什么不推荐使用外键与级联" aria-hidden="true">#</a> 为什么不推荐使用外键与级联？</h2>
...
<h2 id="什么是-er-图" tabindex="-1"><a class="header-anchor" href="#什么是-er-图" aria-hidden="true">#</a> 什么是 ER 图？</h2>
<blockquote>
...
<h2 id="数据库范式了解吗" tabindex="-1"><a class="header-anchor" href="#数据库范式了解吗" aria-hidden="true">#</a> 数据库范式了解吗?</h2>
...
<h2 id="什么是存储过程" tabindex="-1"><a class="header-anchor" href="#什么是存储过程" aria-hidden="true">#</a> 什么是存储过程?</h2>
...
<h3 id="用法不同" tabindex="-1"><a class="header-anchor" href="#用法不同" aria-hidden="true">#</a> 用法不同</h3>
<ul>
...
<h3 id="属于不同的数据库语言" tabindex="-1"><a class="header-anchor" href="#属于不同的数据库语言" aria-hidden="true">#</a> 属于不同的数据库语言</h3>
...
<h3 id="执行速度不同" tabindex="-1"><a class="header-anchor" href="#执行速度不同" aria-hidden="true">#</a> 执行速度不同</h3>
<p>一般来说:drop&gt;truncate&gt;delete（这个我没有设计测试过）。</p>
<h2 id="数据库设计通常分为哪几步" tabindex="-1"><a class="header-anchor" href="#数据库设计通常分为哪几步" aria-hidden="true">#</a> 数据库设计通常分为哪几步?</h2>
<ol>
...
<ul>
<li><a href="https://blog.csdn.net/rl529014/article/details/48391465" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/rl529014/article/details/48391465<ExternalLinkIcon/></a></li>
<li><a href="https://www.zhihu.com/question/24696366/answer/29189700" target="_blank" rel="noopener noreferrer">https://www.zhihu.com/question/24696366/answer/29189700<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/bieleyang/article/details/77149954" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/bieleyang/article/details/77149954<ExternalLinkIcon/></a></li>
</ul>
</div></template>
