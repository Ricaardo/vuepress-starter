<template><div><p>编程是一个很奇妙的事情，大部分的我们把大部分时间实际都花在了复制粘贴，而后修改代码上面。</p>
...
<p><img src="@source/docs/idea-tutorial/idea-plugins/pictures/Statistic1.png" alt=""></p>
<p>你还可以使用它看所有类的总行数、有效代码行数、注释行数、以及有效代码比重等等这些东西。</p>
<p><img src="@source/docs/idea-tutorial/idea-plugins/pictures/Statistic2.png" alt=""></p>
