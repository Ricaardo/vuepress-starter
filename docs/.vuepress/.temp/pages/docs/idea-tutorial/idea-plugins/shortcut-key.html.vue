<template><div><p>相信我！下面这两个一定是IDEA必备的插件。</p>
...
<p>举个例子。我直接点击tab栏下的菜单打开 Version Control(版本控制) 的话，这个插件就会提示你可以用快捷键 <code v-pre>command+9</code>或者<code v-pre>shift+command+9</code>打开。如下图所示。</p>
...
<p>举个例子。我使用快捷键 <code v-pre>command+9</code>打开 Version Control ，使用了这个插件之后的效果如下图所示。</p>
