<template><div><h1 id="大白话带你认识jvm" tabindex="-1"><a class="header-anchor" href="#大白话带你认识jvm" aria-hidden="true">#</a> 大白话带你认识JVM</h1>
<blockquote>
<p>来自掘金用户：<a href="https://juejin.im/user/5c2400afe51d45451758aa96" target="_blank" rel="noopener noreferrer">说出你的愿望吧丷<ExternalLinkIcon/></a>投稿，原文地址：https://juejin.im/post/5e1505d0f265da5d5d744050#heading-28</p>
</blockquote>
<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2>
<p>如果在文中用词或者理解方面出现问题，欢迎指出。此文旨在提及而不深究，但会尽量效率地把知识点都抛出来</p>
<h2 id="一、jvm的基本介绍" tabindex="-1"><a class="header-anchor" href="#一、jvm的基本介绍" aria-hidden="true">#</a> 一、JVM的基本介绍</h2>
...
<h3 id="_1-1-java文件是如何被运行的" tabindex="-1"><a class="header-anchor" href="#_1-1-java文件是如何被运行的" aria-hidden="true">#</a> 1.1 Java文件是如何被运行的</h3>
...
<h4 id="_1-类加载器" tabindex="-1"><a class="header-anchor" href="#_1-类加载器" aria-hidden="true">#</a> ① 类加载器</h4>
...
<h4 id="_2-方法区" tabindex="-1"><a class="header-anchor" href="#_2-方法区" aria-hidden="true">#</a> ② 方法区</h4>
<p><strong>方法区</strong> 是用于存放类似于元数据信息方面的数据的，比如类信息，常量，静态变量，编译后代码···等</p>
<p>类加载器将 .class 文件搬过来就是先丢到这一块上</p>
<h4 id="_3-堆" tabindex="-1"><a class="header-anchor" href="#_3-堆" aria-hidden="true">#</a> ③ 堆</h4>
<p><strong>堆</strong> 主要放了一些存储的数据，比如对象实例，数组···等，它和方法区都同属于 <strong>线程共享区域</strong> 。也就是说它们都是 <strong>线程不安全</strong> 的</p>
<h4 id="_4-栈" tabindex="-1"><a class="header-anchor" href="#_4-栈" aria-hidden="true">#</a> ④ 栈</h4>
...
<h4 id="_5-程序计数器" tabindex="-1"><a class="header-anchor" href="#_5-程序计数器" aria-hidden="true">#</a> ⑤ 程序计数器</h4>
...
<h4 id="小总结" tabindex="-1"><a class="header-anchor" href="#小总结" aria-hidden="true">#</a> 小总结</h4>
<ol>
...
<h3 id="_1-2-简单的代码例子" tabindex="-1"><a class="header-anchor" href="#_1-2-简单的代码例子" aria-hidden="true">#</a> 1.2 简单的代码例子</h3>
<p>一个简单的学生类</p>
...
<h2 id="二、类加载器的介绍" tabindex="-1"><a class="header-anchor" href="#二、类加载器的介绍" aria-hidden="true">#</a> 二、类加载器的介绍</h2>
...
<h3 id="_2-1-类加载器的流程" tabindex="-1"><a class="header-anchor" href="#_2-1-类加载器的流程" aria-hidden="true">#</a> 2.1 类加载器的流程</h3>
<p>从类被加载到虚拟机内存中开始，到释放内存总共有7个步骤：加载，验证，准备，解析，初始化，使用，卸载。其中<strong>验证，准备，解析三个部分统称为连接</strong></p>
<h4 id="_2-1-1-加载" tabindex="-1"><a class="header-anchor" href="#_2-1-1-加载" aria-hidden="true">#</a> 2.1.1 加载</h4>
<ol>
<li>将class文件加载到内存</li>
<li>将静态数据结构转化成方法区中运行时的数据结构</li>
<li>在堆中生成一个代表这个类的 java.lang.Class对象作为数据访问的入口</li>
</ol>
<h4 id="_2-1-2-链接" tabindex="-1"><a class="header-anchor" href="#_2-1-2-链接" aria-hidden="true">#</a> 2.1.2 链接</h4>
<ol>
...
<h4 id="_2-1-3-初始化" tabindex="-1"><a class="header-anchor" href="#_2-1-3-初始化" aria-hidden="true">#</a> 2.1.3 初始化</h4>
<p>初始化其实就是执行类构造器方法的<code v-pre>&lt;clinit&gt;()</code>的过程，而且要保证执行前父类的<code v-pre>&lt;clinit&gt;()</code>方法执行完毕。这个方法由编译器收集，顺序执行所有类变量（static修饰的成员变量）显式初始化和静态代码块中语句。此时准备阶段时的那个 <code v-pre>static int a</code> 由默认初始化的0变成了显式初始化的3。 由于执行顺序缘故，初始化阶段类变量如果在静态代码块中又进行了更改，会覆盖类变量的显式初始化，最终值会为静态代码块中的赋值。</p>
<blockquote>
<p>注意：字节码文件中初始化方法有两种，非静态资源初始化的<code v-pre>&lt;init&gt;</code>和静态资源初始化的<code v-pre>&lt;clinit&gt;</code>，类构造器方法<code v-pre>&lt;clinit&gt;()</code>不同于类的构造器，这些方法都是字节码文件中只能给JVM识别的特殊方法。</p>
</blockquote>
<h4 id="_2-1-4-卸载" tabindex="-1"><a class="header-anchor" href="#_2-1-4-卸载" aria-hidden="true">#</a> 2.1.4 卸载</h4>
<p>GC将无用对象从内存中卸载</p>
<h3 id="_2-2-类加载器的加载顺序" tabindex="-1"><a class="header-anchor" href="#_2-2-类加载器的加载顺序" aria-hidden="true">#</a> 2.2 类加载器的加载顺序</h3>
...
<h3 id="_2-3-双亲委派机制" tabindex="-1"><a class="header-anchor" href="#_2-3-双亲委派机制" aria-hidden="true">#</a> 2.3 双亲委派机制</h3>
...
<p>其实这个也是一个隔离的作用，避免了我们的代码影响了 JDK 的代码，比如我现在自己定义一个 <code v-pre>java.lang.String</code> ：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">java<span class="token punctuation">.</span>lang</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>尝试运行当前类的 <code v-pre>main</code> 函数的时候，我们的代码肯定会报错。这是因为在加载的时候其实是找到了 rt.jar 中的<code v-pre>java.lang.String</code>，然而发现这个里面并没有 <code v-pre>main</code> 方法。</p>
<h2 id="三、运行时数据区" tabindex="-1"><a class="header-anchor" href="#三、运行时数据区" aria-hidden="true">#</a> 三、运行时数据区</h2>
<h3 id="_3-1-本地方法栈和程序计数器" tabindex="-1"><a class="header-anchor" href="#_3-1-本地方法栈和程序计数器" aria-hidden="true">#</a> 3.1 本地方法栈和程序计数器</h3>
...
<h3 id="_3-2-方法区" tabindex="-1"><a class="header-anchor" href="#_3-2-方法区" aria-hidden="true">#</a> 3.2 方法区</h3>
<p>方法区主要的作用是存放类的元数据信息，常量和静态变量···等。当它存储的信息过大时，会在无法满足内存分配时报错。</p>
<h3 id="_3-3-虚拟机栈和虚拟机堆" tabindex="-1"><a class="header-anchor" href="#_3-3-虚拟机栈和虚拟机堆" aria-hidden="true">#</a> 3.3 虚拟机栈和虚拟机堆</h3>
<p>一句话便是：栈管运行，堆管存储。则虚拟机栈负责运行代码，而虚拟机堆负责存储数据。</p>
<h4 id="_3-3-1-虚拟机栈的概念" tabindex="-1"><a class="header-anchor" href="#_3-3-1-虚拟机栈的概念" aria-hidden="true">#</a> 3.3.1 虚拟机栈的概念</h4>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-2-虚拟机栈存在的异常" tabindex="-1"><a class="header-anchor" href="#_3-3-2-虚拟机栈存在的异常" aria-hidden="true">#</a> 3.3.2 虚拟机栈存在的异常</h4>
...
<h4 id="_3-3-3-虚拟机栈的生命周期" tabindex="-1"><a class="header-anchor" href="#_3-3-3-虚拟机栈的生命周期" aria-hidden="true">#</a> 3.3.3 虚拟机栈的生命周期</h4>
<p>对于栈来说，不存在垃圾回收。只要程序运行结束，栈的空间自然就会释放了。栈的生命周期和所处的线程是一致的。</p>
<p>这里补充一句：8种基本类型的变量+对象的引用变量+实例方法都是在栈里面分配内存。</p>
<h4 id="_3-3-4-虚拟机栈的执行" tabindex="-1"><a class="header-anchor" href="#_3-3-4-虚拟机栈的执行" aria-hidden="true">#</a> 3.3.4 虚拟机栈的执行</h4>
...
<h4 id="_3-3-5-局部变量的复用" tabindex="-1"><a class="header-anchor" href="#_3-3-5-局部变量的复用" aria-hidden="true">#</a> 3.3.5 局部变量的复用</h4>
...
<h4 id="_3-3-6-虚拟机堆的概念" tabindex="-1"><a class="header-anchor" href="#_3-3-6-虚拟机堆的概念" aria-hidden="true">#</a> 3.3.6 虚拟机堆的概念</h4>
...
<h4 id="_3-3-7-eden年轻代的介绍" tabindex="-1"><a class="header-anchor" href="#_3-3-7-eden年轻代的介绍" aria-hidden="true">#</a> 3.3.7 Eden年轻代的介绍</h4>
...
<h4 id="_3-3-8-如何判断一个对象需要被干掉" tabindex="-1"><a class="header-anchor" href="#_3-3-8-如何判断一个对象需要被干掉" aria-hidden="true">#</a> 3.3.8 如何判断一个对象需要被干掉</h4>
...
<h4 id="_3-3-9-如何宣告一个对象的真正死亡" tabindex="-1"><a class="header-anchor" href="#_3-3-9-如何宣告一个对象的真正死亡" aria-hidden="true">#</a> 3.3.9 如何宣告一个对象的真正死亡</h4>
...
<p>补充一句：并不提倡在程序中调用finalize()来进行自救。建议忘掉Java程序中该方法的存在。因为它执行的时间不确定，甚至是否被执行也不确定（Java程序的不正常退出），而且运行代价高昂，无法保证各个对象的调用顺序（甚至有不同线程中调用）。在Java9中已经被标记为 <strong>deprecated</strong> ，且java.lang.ref.Cleaner（也就是强、软、弱、幻象引用的那一套）中已经逐步替换掉它，会比finalize来的更加的轻量及可靠。
　　
...
<h3 id="_3-4-垃圾回收算法" tabindex="-1"><a class="header-anchor" href="#_3-4-垃圾回收算法" aria-hidden="true">#</a> 3.4 垃圾回收算法</h3>
<p>不会非常详细的展开，常用的有标记清除，复制，标记整理和分代收集算法</p>
<h4 id="_3-4-1-标记清除算法" tabindex="-1"><a class="header-anchor" href="#_3-4-1-标记清除算法" aria-hidden="true">#</a> 3.4.1 标记清除算法</h4>
...
<h4 id="_3-4-2-复制算法" tabindex="-1"><a class="header-anchor" href="#_3-4-2-复制算法" aria-hidden="true">#</a> 3.4.2 复制算法</h4>
...
<h4 id="_3-4-3-标记整理算法" tabindex="-1"><a class="header-anchor" href="#_3-4-3-标记整理算法" aria-hidden="true">#</a> 3.4.3 标记整理算法</h4>
...
<h4 id="_3-4-4-分代收集算法" tabindex="-1"><a class="header-anchor" href="#_3-4-4-分代收集算法" aria-hidden="true">#</a> 3.4.4 分代收集算法</h4>
...
<h3 id="_3-5-了解-各种各样的垃圾回收器" tabindex="-1"><a class="header-anchor" href="#_3-5-了解-各种各样的垃圾回收器" aria-hidden="true">#</a> 3.5 （了解）各种各样的垃圾回收器</h3>
...
<h3 id="_3-6-了解-jvm的常用参数" tabindex="-1"><a class="header-anchor" href="#_3-6-了解-jvm的常用参数" aria-hidden="true">#</a> 3.6 （了解）JVM的常用参数</h3>
...
<h2 id="四、关于jvm调优的一些方面" tabindex="-1"><a class="header-anchor" href="#四、关于jvm调优的一些方面" aria-hidden="true">#</a> 四、关于JVM调优的一些方面</h2>
...
<h3 id="_4-1-调整最大堆内存和最小堆内存" tabindex="-1"><a class="header-anchor" href="#_4-1-调整最大堆内存和最小堆内存" aria-hidden="true">#</a> 4.1 调整最大堆内存和最小堆内存</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：此处设置的是Java堆大小，也就是新生代大小 + 老年代大小</p>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/fe99e355f4754fa4be7427cb65261f3d-new-imagebb5cf485-99f8-43eb-8809-2a89e6a1768e.png" alt=""></p>
<p>再次启动main方法</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/bdd717d0a3394be7a733760052773374-new-image371b5d59-0020-4091-9874-603c0ab0073d.png" alt=""></p>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/0fd7550ae2144adca8ed2ede12d5fb96-new-image0c31ff20-289d-4088-8c67-a846d0c5d1e0.png" alt=""></p>
<p>这时候我们创建了一个10M的字节数据，这时候最小堆内存是顶不住的。我们会发现现在的total memory已经变成了15M，这就是已经申请了一次内存的结果。</p>
<p>此时我们再跑一下这个代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">System</span><span class="token punctuation">.</span><span class="token function">gc</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"Xmx="</span> <span class="token operator">+</span> <span class="token class-name">Runtime</span><span class="token punctuation">.</span><span class="token function">getRuntime</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">maxMemory</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">/</span> <span class="token number">1024.0</span> <span class="token operator">/</span> <span class="token number">1024</span> <span class="token operator">+</span> <span class="token string">"M"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>    <span class="token comment">//系统的最大空间</span>
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"free mem="</span> <span class="token operator">+</span> <span class="token class-name">Runtime</span><span class="token punctuation">.</span><span class="token function">getRuntime</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">freeMemory</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">/</span> <span class="token number">1024.0</span> <span class="token operator">/</span> <span class="token number">1024</span> <span class="token operator">+</span> <span class="token string">"M"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>  <span class="token comment">//系统的空闲空间</span>
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"total mem="</span> <span class="token operator">+</span> <span class="token class-name">Runtime</span><span class="token punctuation">.</span><span class="token function">getRuntime</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">totalMemory</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">/</span> <span class="token number">1024.0</span> <span class="token operator">/</span> <span class="token number">1024</span> <span class="token operator">+</span> <span class="token string">"M"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>  <span class="token comment">//当前可用的总空间</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/4cc44b5d5d1c40c48640ece6a296b1ac-new-image4b57baf6-085b-4150-9c60-ac51b0f815d7.png" alt=""></p>
<p>此时我们手动执行了一次fullgc，此时total memory的内存空间又变回5.5M了，此时又是把申请的内存释放掉的结果。</p>
<h3 id="_4-2-调整新生代和老年代的比值" tabindex="-1"><a class="header-anchor" href="#_4-2-调整新生代和老年代的比值" aria-hidden="true">#</a> 4.2 调整新生代和老年代的比值</h3>
...
<h3 id="_4-3-调整survivor区和eden区的比值" tabindex="-1"><a class="header-anchor" href="#_4-3-调整survivor区和eden区的比值" aria-hidden="true">#</a> 4.3 调整Survivor区和Eden区的比值</h3>
<p>-XX:SurvivorRatio（幸存代）--- 设置两个Survivor区和eden的比值</p>
<p>例如：8，表示两个Survivor:eden=2:8，即一个Survivor占年轻代的1/10</p>
<h3 id="_4-4-设置年轻代和老年代的大小" tabindex="-1"><a class="header-anchor" href="#_4-4-设置年轻代和老年代的大小" aria-hidden="true">#</a> 4.4 设置年轻代和老年代的大小</h3>
...
<h3 id="_4-5-小总结" tabindex="-1"><a class="header-anchor" href="#_4-5-小总结" aria-hidden="true">#</a> 4.5 小总结</h3>
...
<h3 id="_4-6-永久区的设置" tabindex="-1"><a class="header-anchor" href="#_4-6-永久区的设置" aria-hidden="true">#</a> 4.6 永久区的设置</h3>
...
<h3 id="_4-7-jvm的栈参数调优" tabindex="-1"><a class="header-anchor" href="#_4-7-jvm的栈参数调优" aria-hidden="true">#</a> 4.7 JVM的栈参数调优</h3>
<h4 id="_4-7-1-调整每个线程栈空间的大小" tabindex="-1"><a class="header-anchor" href="#_4-7-1-调整每个线程栈空间的大小" aria-hidden="true">#</a> 4.7.1 调整每个线程栈空间的大小</h4>
...
<h4 id="_4-7-2-设置线程栈的大小" tabindex="-1"><a class="header-anchor" href="#_4-7-2-设置线程栈的大小" aria-hidden="true">#</a> 4.7.2 设置线程栈的大小</h4>
<pre><code>-XXThreadStackSize：
    设置线程栈的大小(0 means use default stack size)
</code></pre>
<p>这些参数都是可以通过自己编写程序去简单测试的，这里碍于篇幅问题就不再提供demo了</p>
<h3 id="_4-8-可以直接跳过了-jvm其他参数介绍" tabindex="-1"><a class="header-anchor" href="#_4-8-可以直接跳过了-jvm其他参数介绍" aria-hidden="true">#</a> 4.8 (可以直接跳过了)JVM其他参数介绍</h3>
<p>形形色色的参数很多，就不会说把所有都扯个遍了，因为大家其实也不会说一定要去深究到底。</p>
<h4 id="_4-8-1-设置内存页的大小" tabindex="-1"><a class="header-anchor" href="#_4-8-1-设置内存页的大小" aria-hidden="true">#</a> 4.8.1 设置内存页的大小</h4>
<pre><code>-XXThreadStackSize：
    设置内存页的大小，不可设置过大，会影响Perm的大小
</code></pre>
<h4 id="_4-8-2-设置原始类型的快速优化" tabindex="-1"><a class="header-anchor" href="#_4-8-2-设置原始类型的快速优化" aria-hidden="true">#</a> 4.8.2 设置原始类型的快速优化</h4>
<pre><code>-XX:+UseFastAccessorMethods：
    设置原始类型的快速优化
</code></pre>
<h4 id="_4-8-3-设置关闭手动gc" tabindex="-1"><a class="header-anchor" href="#_4-8-3-设置关闭手动gc" aria-hidden="true">#</a> 4.8.3 设置关闭手动GC</h4>
<pre><code>-XX:+DisableExplicitGC：
    设置关闭System.gc()(这个参数需要严格的测试)
</code></pre>
<h4 id="_4-8-4-设置垃圾最大年龄" tabindex="-1"><a class="header-anchor" href="#_4-8-4-设置垃圾最大年龄" aria-hidden="true">#</a> 4.8.4 设置垃圾最大年龄</h4>
...
<h4 id="_4-8-5-加快编译速度" tabindex="-1"><a class="header-anchor" href="#_4-8-5-加快编译速度" aria-hidden="true">#</a> 4.8.5 加快编译速度</h4>
<pre><code>-XX:+AggressiveOpts
</code></pre>
<p>加快编译速度</p>
<h4 id="_4-8-6-改善锁机制性能" tabindex="-1"><a class="header-anchor" href="#_4-8-6-改善锁机制性能" aria-hidden="true">#</a> 4.8.6 改善锁机制性能</h4>
<pre><code>-XX:+UseBiasedLocking
</code></pre>
<h4 id="_4-8-7-禁用垃圾回收" tabindex="-1"><a class="header-anchor" href="#_4-8-7-禁用垃圾回收" aria-hidden="true">#</a> 4.8.7 禁用垃圾回收</h4>
<pre><code>-Xnoclassgc
</code></pre>
<h4 id="_4-8-8-设置堆空间存活时间" tabindex="-1"><a class="header-anchor" href="#_4-8-8-设置堆空间存活时间" aria-hidden="true">#</a> 4.8.8 设置堆空间存活时间</h4>
<pre><code>-XX:SoftRefLRUPolicyMSPerMB
    设置每兆堆空闲空间中SoftReference的存活时间，默认值是1s。
</code></pre>
<h4 id="_4-8-9-设置对象直接分配在老年代" tabindex="-1"><a class="header-anchor" href="#_4-8-9-设置对象直接分配在老年代" aria-hidden="true">#</a> 4.8.9 设置对象直接分配在老年代</h4>
<pre><code>-XX:PretenureSizeThreshold
    设置对象超过多大时直接在老年代分配，默认值是0。
</code></pre>
<h4 id="_4-8-10-设置tlab占eden区的比例" tabindex="-1"><a class="header-anchor" href="#_4-8-10-设置tlab占eden区的比例" aria-hidden="true">#</a> 4.8.10 设置TLAB占eden区的比例</h4>
<pre><code>-XX:TLABWasteTargetPercent
    设置TLAB占eden区的百分比，默认值是1% 。 
</code></pre>
<h4 id="_4-8-11设置是否优先ygc" tabindex="-1"><a class="header-anchor" href="#_4-8-11设置是否优先ygc" aria-hidden="true">#</a> 4.8.11设置是否优先YGC</h4>
