<template><div><h1 id="jvm-垃圾回收详解" tabindex="-1"><a class="header-anchor" href="#jvm-垃圾回收详解" aria-hidden="true">#</a> JVM 垃圾回收详解</h1>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/29176325.png" alt=""></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/01d330d8-2710-4fad-a91c-7bbbfaaefc0e.png" alt=""></p>
<p>上图所示的 Eden 区、From Survivor0(&quot;From&quot;) 区、To Survivor1(&quot;To&quot;) 区都属于新生代，Old Memory 区属于老年代。</p>
<p>大部分情况，对象都会首先在 Eden 区域分配，在一次新生代垃圾回收后，如果对象还存活，则会进入 s0 或者 s1，并且对象的年龄还会加 1(Eden 区-&gt;Survivor 区后对象的初始年龄变为 1)，当它的年龄增加到一定程度（默认为大于 15 岁），就会被晋升到老年代中。对象晋升到老年代的年龄阈值，可以通过参数 <code v-pre>-XX:MaxTenuringThreshold</code> 来设置默认值，这个值会在虚拟机运行过程中进行调整，可以通过<code v-pre>-XX:+PrintTenuringDistribution</code>来打印出当次GC后的Threshold。</p>
<blockquote>
...
<p>经过这次 GC 后，Eden 区和&quot;From&quot;区已经被清空。这个时候，&quot;From&quot;和&quot;To&quot;会交换他们的角色，也就是新的&quot;To&quot;就是上次 GC 前的“From”，新的&quot;From&quot;就是上次 GC 前的&quot;To&quot;。不管怎样，都会保证名为 To 的 Survivor 区域是空的。Minor GC 会一直重复这样的过程，在这个过程中，有可能当次Minor GC后，Survivor 的&quot;From&quot;区域空间不够用，有一些还达不到进入老年代条件的实例放不下，则放不下的部分会提前进入老年代。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意:如下输出结果中老年代的信息为 <code v-pre>concurrent mark-sweep generation</code> 和以前版本略有不同。另外，还列出了某次GC后是否重新生成了threshold，以及各个年龄占用空间的大小。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token number">2021</span>-07-01T10:41:32.257+0800: <span class="token punctuation">[</span>GC <span class="token punctuation">(</span>Allocation Failure<span class="token punctuation">)</span> <span class="token number">2021</span>-07-01T10:41:32.257+0800: <span class="token punctuation">[</span>ParNew
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/堆内存.png" alt="堆内存常见分配策略 "></p>
<h3 id="_1-1-对象优先在-eden-区分配" tabindex="-1"><a class="header-anchor" href="#_1-1-对象优先在-eden-区分配" aria-hidden="true">#</a> 1.1 对象优先在 eden 区分配</h3>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GCTest</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过以下方式运行：
<img src="@source/docs/java/jvm/pictures/jvm垃圾回收/25178350.png" alt=""></p>
<p>添加的参数：<code v-pre>-XX:+PrintGCDetails</code>
<img src="@source/docs/java/jvm/pictures/jvm垃圾回收/10317146.png" alt=""></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-8-26/28128785.jpg" alt=""></p>
...
<p>jdk8官方文档引用 ：https://docs.oracle.com/javase/8/docs/technotes/tools/unix/java.html 。</p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/11034259.png" alt=""></p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReferenceCountingGc</span> <span class="token punctuation">{</span>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/72762049.png" alt="可达性分析算法 "></p>
...
<h3 id="_2-4-不可达的对象并非-非死不可" tabindex="-1"><a class="header-anchor" href="#_2-4-不可达的对象并非-非死不可" aria-hidden="true">#</a> 2.4 不可达的对象并非“非死不可”</h3>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/垃圾收集算法.png" alt="垃圾收集算法分类"></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/标记-清除算法.jpeg" alt=""></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/90984624.png" alt="复制算法"></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/94057049.png" alt="标记-整理算法 "></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/垃圾收集器.png" alt="垃圾收集器分类"></p>
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/46873026.png" alt=" Serial 收集器 "></p>
...
<p><strong>新生代采用标记-复制算法，老年代采用标记-整理算法。</strong></p>
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/22018368.png" alt="ParNew 收集器 "></p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>-XX:+UseParallelGC
...
<p><strong>新生代采用标记-复制算法，老年代采用标记-整理算法。</strong></p>
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/parllel-scavenge收集器.png" alt="Parallel Scavenge 收集器 "></p>
<p><strong>这是 JDK1.8 默认收集器</strong></p>
<p>使用 java -XX:+PrintCommandLineFlags -version 命令查看</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>-XX:InitialHeapSize=262921408 -XX:MaxHeapSize=4206742528 -XX:+PrintCommandLineFlags -XX:+UseCompressedClassPointers -XX:+UseCompressedOops -XX:+UseParallelGC
...
<p><img src="@source/docs/java/jvm/pictures/jvm垃圾回收/CMS收集器.png" alt="CMS 垃圾收集器 "></p>
