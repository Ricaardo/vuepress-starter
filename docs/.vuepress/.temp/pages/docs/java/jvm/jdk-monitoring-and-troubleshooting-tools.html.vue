...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jps
7360 NettyClient2
17396
7972 Launcher
16504 Jps
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jps <span class="token operator">-</span>l
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jinfo  <span class="token operator">-</span>flag MaxHeapSize 17340
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jinfo  <span class="token operator">-</span>flag  PrintGC 17340
<span class="token operator">-</span>XX:<span class="token operator">-</span>PrintGC
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jmap <span class="token operator">-</span>dump:format=b<span class="token punctuation">,</span>file=C:\Users\SnailClimb\Desktop\heap<span class="token punctuation">.</span>hprof 17340
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jhat C:\Users\SnailClimb\Desktop\heap<span class="token punctuation">.</span>hprof
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>Found one Java-level deadlock:
=============================
...
<p><img src="@source/docs/java/jvm/pictures/jdk监控和故障处理工具总结/1JConsole连接.png" alt="连接 Jconsole"></p>
<p>如果需要使用 JConsole 连接远程进程，可以在远程 Java 程序启动时加上下面这些参数:</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">-Djava.rmi.server.hostname</span><span class="token punctuation">=</span><span class="token value attr-value">外网访问 ip 地址 </span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>外网访问 ip 地址:60001 
...
<p><img src="@source/docs/java/jvm/pictures/jdk监控和故障处理工具总结/2查看Java程序概况.png" alt="查看 Java 程序概况 "></p>
...
<p><img src="@source/docs/java/jvm/pictures/jdk监控和故障处理工具总结/3内存监控.png" alt="内存监控 "></p>
...
<p><img src="@source/docs/java/jvm/pictures/jdk监控和故障处理工具总结/4线程监控.png" alt="线程监控 "></p>
