<template><div><h2 id="_1-synchronized-关键字" tabindex="-1"><a class="header-anchor" href="#_1-synchronized-关键字" aria-hidden="true">#</a> 1.synchronized 关键字</h2>
<p><img src="images/interview-questions/synchronized关键字.png" alt=""></p>
<h3 id="_1-1-说一说自己对于-synchronized-关键字的了解" tabindex="-1"><a class="header-anchor" href="#_1-1-说一说自己对于-synchronized-关键字的了解" aria-hidden="true">#</a> 1.1.说一说自己对于 synchronized 关键字的了解</h3>
...
<h3 id="_1-2-说说自己是怎么使用-synchronized-关键字" tabindex="-1"><a class="header-anchor" href="#_1-2-说说自己是怎么使用-synchronized-关键字" aria-hidden="true">#</a> 1.2. 说说自己是怎么使用 synchronized 关键字</h3>
...
<h3 id="_1-3-构造方法可以使用-synchronized-关键字修饰么" tabindex="-1"><a class="header-anchor" href="#_1-3-构造方法可以使用-synchronized-关键字修饰么" aria-hidden="true">#</a> 1.3. 构造方法可以使用 synchronized 关键字修饰么？</h3>
<p>先说结论：<strong>构造方法不能使用 synchronized 关键字修饰。</strong></p>
<p>构造方法本身就属于线程安全的，不存在同步的构造方法一说。</p>
<h3 id="_1-3-讲一下-synchronized-关键字的底层原理" tabindex="-1"><a class="header-anchor" href="#_1-3-讲一下-synchronized-关键字的底层原理" aria-hidden="true">#</a> 1.3. 讲一下 synchronized 关键字的底层原理</h3>
<p><strong>synchronized 关键字底层原理属于 JVM 层面。</strong></p>
<h4 id="_1-3-1-synchronized-同步语句块的情况" tabindex="-1"><a class="header-anchor" href="#_1-3-1-synchronized-同步语句块的情况" aria-hidden="true">#</a> 1.3.1. synchronized 同步语句块的情况</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SynchronizedDemo</span> <span class="token punctuation">{</span>
...
<p>从上面我们可以看出：</p>
<p><strong><code v-pre>synchronized</code> 同步语句块的实现使用的是 <code v-pre>monitorenter</code> 和 <code v-pre>monitorexit</code> 指令，其中 <code v-pre>monitorenter</code> 指令指向同步代码块的开始位置，<code v-pre>monitorexit</code> 指令则指明同步代码块的结束位置。</strong></p>
...
<p>在执行 <code v-pre>monitorexit</code> 指令后，将锁计数器设为 0，表明锁被释放。如果获取对象锁失败，那当前线程就要阻塞等待，直到锁被另外一个线程释放为止。</p>
<h4 id="_1-3-2-synchronized-修饰方法的的情况" tabindex="-1"><a class="header-anchor" href="#_1-3-2-synchronized-修饰方法的的情况" aria-hidden="true">#</a> 1.3.2. synchronized 修饰方法的的情况</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SynchronizedDemo2</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-6/synchronized关键字原理2.png" alt="synchronized关键字原理"></p>
...
<h4 id="_1-3-3-总结" tabindex="-1"><a class="header-anchor" href="#_1-3-3-总结" aria-hidden="true">#</a> 1.3.3.总结</h4>
...
<h3 id="_1-4-说说-jdk1-6-之后的-synchronized-关键字底层做了哪些优化-可以详细介绍一下这些优化吗" tabindex="-1"><a class="header-anchor" href="#_1-4-说说-jdk1-6-之后的-synchronized-关键字底层做了哪些优化-可以详细介绍一下这些优化吗" aria-hidden="true">#</a> 1.4. 说说 JDK1.6 之后的 synchronized 关键字底层做了哪些优化，可以详细介绍一下这些优化吗</h3>
...
<h3 id="_1-5-谈谈-synchronized-和-reentrantlock-的区别" tabindex="-1"><a class="header-anchor" href="#_1-5-谈谈-synchronized-和-reentrantlock-的区别" aria-hidden="true">#</a> 1.5. 谈谈 synchronized 和 ReentrantLock 的区别</h3>
<h4 id="_1-5-1-两者都是可重入锁" tabindex="-1"><a class="header-anchor" href="#_1-5-1-两者都是可重入锁" aria-hidden="true">#</a> 1.5.1. 两者都是可重入锁</h4>
...
<h4 id="_1-5-2-synchronized-依赖于-jvm-而-reentrantlock-依赖于-api" tabindex="-1"><a class="header-anchor" href="#_1-5-2-synchronized-依赖于-jvm-而-reentrantlock-依赖于-api" aria-hidden="true">#</a> 1.5.2.synchronized 依赖于 JVM 而 ReentrantLock 依赖于 API</h4>
...
<h4 id="_1-5-3-reentrantlock-比-synchronized-增加了一些高级功能" tabindex="-1"><a class="header-anchor" href="#_1-5-3-reentrantlock-比-synchronized-增加了一些高级功能" aria-hidden="true">#</a> 1.5.3.ReentrantLock 比 synchronized 增加了一些高级功能</h4>
...
<h2 id="_2-volatile-关键字" tabindex="-1"><a class="header-anchor" href="#_2-volatile-关键字" aria-hidden="true">#</a> 2. volatile 关键字</h2>
<p>我们先要从 <strong>CPU 缓存模型</strong> 说起！</p>
<h3 id="_2-1-cpu-缓存模型" tabindex="-1"><a class="header-anchor" href="#_2-1-cpu-缓存模型" aria-hidden="true">#</a> 2.1. CPU 缓存模型</h3>
...
<h3 id="_2-2-讲一下-jmm-java-内存模型" tabindex="-1"><a class="header-anchor" href="#_2-2-讲一下-jmm-java-内存模型" aria-hidden="true">#</a> 2.2. 讲一下 JMM(Java 内存模型)</h3>
...
<h3 id="_2-3-并发编程的三个重要特性" tabindex="-1"><a class="header-anchor" href="#_2-3-并发编程的三个重要特性" aria-hidden="true">#</a> 2.3. 并发编程的三个重要特性</h3>
<ol>
<li><strong>原子性</strong> : 一个的操作或者多次操作，要么所有的操作全部都得到执行并且不会收到任何因素的干扰而中断，要么所有的操作都执行，要么都不执行。<code v-pre>synchronized</code> 可以保证代码片段的原子性。</li>
...
<h3 id="_2-4-说说-synchronized-关键字和-volatile-关键字的区别" tabindex="-1"><a class="header-anchor" href="#_2-4-说说-synchronized-关键字和-volatile-关键字的区别" aria-hidden="true">#</a> 2.4. 说说 synchronized 关键字和 volatile 关键字的区别</h3>
...
<h2 id="_3-threadlocal" tabindex="-1"><a class="header-anchor" href="#_3-threadlocal" aria-hidden="true">#</a> 3. ThreadLocal</h2>
<h3 id="_3-1-threadlocal-简介" tabindex="-1"><a class="header-anchor" href="#_3-1-threadlocal-简介" aria-hidden="true">#</a> 3.1. ThreadLocal 简介</h3>
...
<h3 id="_3-2-threadlocal-示例" tabindex="-1"><a class="header-anchor" href="#_3-2-threadlocal-示例" aria-hidden="true">#</a> 3.2. ThreadLocal 示例</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>Thread Name= 0 default Formatter = yyyyMMdd HHmm
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">ThreadLocal</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">SimpleDateFormat</span><span class="token punctuation">></span></span> formatter <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ThreadLocal</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">SimpleDateFormat</span><span class="token punctuation">></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-threadlocal-原理" tabindex="-1"><a class="header-anchor" href="#_3-3-threadlocal-原理" aria-hidden="true">#</a> 3.3. ThreadLocal 原理</h3>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">ThreadLocalMap</span><span class="token punctuation">(</span><span class="token class-name">ThreadLocal</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> firstKey<span class="token punctuation">,</span> <span class="token class-name">Object</span> firstValue<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">//......</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>比如我们在同一个线程中声明了两个 <code v-pre>ThreadLocal</code> 对象的话，会使用 <code v-pre>Thread</code>内部都是使用仅有那个<code v-pre>ThreadLocalMap</code> 存放数据的，<code v-pre>ThreadLocalMap</code>的 key 就是 <code v-pre>ThreadLocal</code>对象，value 就是 <code v-pre>ThreadLocal</code> 对象调用<code v-pre>set</code>方法设置的值。</p>
...
<h3 id="_3-4-threadlocal-内存泄露问题" tabindex="-1"><a class="header-anchor" href="#_3-4-threadlocal-内存泄露问题" aria-hidden="true">#</a> 3.4. ThreadLocal 内存泄露问题</h3>
...
<h2 id="_4-线程池" tabindex="-1"><a class="header-anchor" href="#_4-线程池" aria-hidden="true">#</a> 4. 线程池</h2>
<h3 id="_4-1-为什么要用线程池" tabindex="-1"><a class="header-anchor" href="#_4-1-为什么要用线程池" aria-hidden="true">#</a> 4.1. 为什么要用线程池？</h3>
<blockquote>
...
<h3 id="_4-2-实现-runnable-接口和-callable-接口的区别" tabindex="-1"><a class="header-anchor" href="#_4-2-实现-runnable-接口和-callable-接口的区别" aria-hidden="true">#</a> 4.2. 实现 Runnable 接口和 Callable 接口的区别</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-执行-execute-方法和-submit-方法的区别是什么呢" tabindex="-1"><a class="header-anchor" href="#_4-3-执行-execute-方法和-submit-方法的区别是什么呢" aria-hidden="true">#</a> 4.3. 执行 execute()方法和 submit()方法的区别是什么呢？</h3>
<ol>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-如何创建线程池" tabindex="-1"><a class="header-anchor" href="#_4-4-如何创建线程池" aria-hidden="true">#</a> 4.4. 如何创建线程池</h3>
...
<h3 id="_4-5-threadpoolexecutor-类分析" tabindex="-1"><a class="header-anchor" href="#_4-5-threadpoolexecutor-类分析" aria-hidden="true">#</a> 4.5 ThreadPoolExecutor 类分析</h3>
...
<h4 id="_4-5-1-threadpoolexecutor构造函数重要参数分析" tabindex="-1"><a class="header-anchor" href="#_4-5-1-threadpoolexecutor构造函数重要参数分析" aria-hidden="true">#</a> 4.5.1 <code v-pre>ThreadPoolExecutor</code>构造函数重要参数分析</h4>
...
<h4 id="_4-5-2-threadpoolexecutor-饱和策略" tabindex="-1"><a class="header-anchor" href="#_4-5-2-threadpoolexecutor-饱和策略" aria-hidden="true">#</a> 4.5.2 <code v-pre>ThreadPoolExecutor</code> 饱和策略</h4>
...
<h3 id="_4-6-一个简单的线程池-demo" tabindex="-1"><a class="header-anchor" href="#_4-6-一个简单的线程池-demo" aria-hidden="true">#</a> 4.6 一个简单的线程池 Demo</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>pool-1-thread-3 Start. Time = Sun Apr 12 11:14:37 CST 2020
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-7-线程池原理分析" tabindex="-1"><a class="header-anchor" href="#_4-7-线程池原理分析" aria-hidden="true">#</a> 4.7 线程池原理分析</h3>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 存放线程池的运行状态 (runState) 和线程池内有效线程的数量 (workerCount)</span>
...
<h2 id="_5-atomic-原子类" tabindex="-1"><a class="header-anchor" href="#_5-atomic-原子类" aria-hidden="true">#</a> 5. Atomic 原子类</h2>
<h3 id="_5-1-介绍一下-atomic-原子类" tabindex="-1"><a class="header-anchor" href="#_5-1-介绍一下-atomic-原子类" aria-hidden="true">#</a> 5.1. 介绍一下 Atomic 原子类</h3>
...
<h3 id="_5-2-juc-包中的原子类是哪-4-类" tabindex="-1"><a class="header-anchor" href="#_5-2-juc-包中的原子类是哪-4-类" aria-hidden="true">#</a> 5.2. JUC 包中的原子类是哪 4 类?</h3>
<p><strong>基本类型</strong></p>
<p>使用原子的方式更新基本类型</p>
<ul>
<li><code v-pre>AtomicInteger</code>：整形原子类</li>
...
<ul>
<li><code v-pre>AtomicIntegerArray</code>：整形数组原子类</li>
<li><code v-pre>AtomicLongArray</code>：长整形数组原子类</li>
...
<ul>
<li><code v-pre>AtomicIntegerFieldUpdater</code>：原子更新整形字段的更新器</li>
<li><code v-pre>AtomicLongFieldUpdater</code>：原子更新长整形字段的更新器</li>
<li><code v-pre>AtomicReferenceFieldUpdater</code>：原子更新引用类型字段的更新器</li>
</ul>
<h3 id="_5-3-讲讲-atomicinteger-的使用" tabindex="-1"><a class="header-anchor" href="#_5-3-讲讲-atomicinteger-的使用" aria-hidden="true">#</a> 5.3. 讲讲 AtomicInteger 的使用</h3>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">AtomicIntegerTest</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-能不能给我简单介绍一下-atomicinteger-类的原理" tabindex="-1"><a class="header-anchor" href="#_5-4-能不能给我简单介绍一下-atomicinteger-类的原理" aria-hidden="true">#</a> 5.4. 能不能给我简单介绍一下 AtomicInteger 类的原理</h3>
<p>AtomicInteger 线程安全原理简单分析</p>
<p>AtomicInteger 类的部分源码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// setup to use Unsafe.compareAndSwapInt for updates（更新操作时提供“比较并替换”的作用）</span>
...
<h2 id="_6-aqs" tabindex="-1"><a class="header-anchor" href="#_6-aqs" aria-hidden="true">#</a> 6. AQS</h2>
<h3 id="_6-1-aqs-介绍" tabindex="-1"><a class="header-anchor" href="#_6-1-aqs-介绍" aria-hidden="true">#</a> 6.1. AQS 介绍</h3>
...
<h3 id="_6-2-aqs-原理分析" tabindex="-1"><a class="header-anchor" href="#_6-2-aqs-原理分析" aria-hidden="true">#</a> 6.2. AQS 原理分析</h3>
...
<h4 id="_6-2-1-aqs-原理概览" tabindex="-1"><a class="header-anchor" href="#_6-2-1-aqs-原理概览" aria-hidden="true">#</a> 6.2.1. AQS 原理概览</h4>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">volatile</span> <span class="token keyword">int</span> state<span class="token punctuation">;</span><span class="token comment">//共享变量，使用volatile修饰保证线程可见性</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-2-2-aqs-对资源的共享方式" tabindex="-1"><a class="header-anchor" href="#_6-2-2-aqs-对资源的共享方式" aria-hidden="true">#</a> 6.2.2. AQS 对资源的共享方式</h4>
...
<h4 id="_6-2-3-aqs-底层使用了模板方法模式" tabindex="-1"><a class="header-anchor" href="#_6-2-3-aqs-底层使用了模板方法模式" aria-hidden="true">#</a> 6.2.3. AQS 底层使用了模板方法模式</h4>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token function">isHeldExclusively</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token comment">//该线程是否正在独占资源。只有用到condition才需要去实现它。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>默认情况下，每个方法都抛出 <code v-pre>UnsupportedOperationException</code>。 这些方法的实现必须是内部线程安全的，并且通常应该简短而不是阻塞。AQS 类中的其他方法都是 final ，所以无法被其他类使用，只有这几个方法可以被其他类使用。</p>
...
<p>再以 <code v-pre>CountDownLatch</code> 以例，任务分为 N 个子线程去执行，state 也初始化为 N（注意 N 要与线程个数一致）。这 N 个子线程是并行执行的，每个子线程执行完后<code v-pre> countDown()</code> 一次，state 会 CAS(Compare and Swap)减 1。等到所有子线程都执行完后(即 state=0)，会 unpark()主调用线程，然后主调用线程就会从 <code v-pre>await()</code> 函数返回，继续后余动作。</p>
...
<h3 id="_6-3-aqs-组件总结" tabindex="-1"><a class="header-anchor" href="#_6-3-aqs-组件总结" aria-hidden="true">#</a> 6.3. AQS 组件总结</h3>
<ul>
...
<h3 id="_6-4-用过-countdownlatch-么-什么场景下用的" tabindex="-1"><a class="header-anchor" href="#_6-4-用过-countdownlatch-么-什么场景下用的" aria-hidden="true">#</a> 6.4. 用过 CountDownLatch 么？什么场景下用的？</h3>
...
<p>伪代码是下面这样的：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CountDownLatchExample1</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的代码还可以接续优化，当任务过多的时候，把每一个 task 都列出来不太现实，可以考虑通过循环来添加任务。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//文件夹位置</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-reference" tabindex="-1"><a class="header-anchor" href="#_7-reference" aria-hidden="true">#</a> 7 Reference</h2>
<ul>
<li>《深入理解 Java 虚拟机》</li>
