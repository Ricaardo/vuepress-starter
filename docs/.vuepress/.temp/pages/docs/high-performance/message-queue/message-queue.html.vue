<template><div><h1 id="消息队列知识点-面试题总结" tabindex="-1"><a class="header-anchor" href="#消息队列知识点-面试题总结" aria-hidden="true">#</a> 消息队列知识点&amp;面试题总结</h1>
...
<h2 id="一-什么是消息队列" tabindex="-1"><a class="header-anchor" href="#一-什么是消息队列" aria-hidden="true">#</a> 一 什么是消息队列</h2>
...
<h2 id="二-为什么要用消息队列" tabindex="-1"><a class="header-anchor" href="#二-为什么要用消息队列" aria-hidden="true">#</a> 二 为什么要用消息队列</h2>
...
<h3 id="_2-1-通过异步处理提高系统性能-减少响应所需时间" tabindex="-1"><a class="header-anchor" href="#_2-1-通过异步处理提高系统性能-减少响应所需时间" aria-hidden="true">#</a> 2.1 通过异步处理提高系统性能（减少响应所需时间）</h3>
...
<h3 id="_2-2-削峰-限流" tabindex="-1"><a class="header-anchor" href="#_2-2-削峰-限流" aria-hidden="true">#</a> 2.2 削峰/限流</h3>
...
<h3 id="_2-3-降低系统耦合性" tabindex="-1"><a class="header-anchor" href="#_2-3-降低系统耦合性" aria-hidden="true">#</a> 2.3 降低系统耦合性</h3>
...
<h2 id="三-使用消息队列带来的一些问题" tabindex="-1"><a class="header-anchor" href="#三-使用消息队列带来的一些问题" aria-hidden="true">#</a> 三 使用消息队列带来的一些问题</h2>
<ul>
...
<h2 id="四-jms-vs-amqp" tabindex="-1"><a class="header-anchor" href="#四-jms-vs-amqp" aria-hidden="true">#</a> 四 JMS VS AMQP</h2>
<h3 id="_4-1-jms" tabindex="-1"><a class="header-anchor" href="#_4-1-jms" aria-hidden="true">#</a> 4.1 JMS</h3>
<h4 id="_4-1-1-jms-简介" tabindex="-1"><a class="header-anchor" href="#_4-1-1-jms-简介" aria-hidden="true">#</a> 4.1.1 JMS 简介</h4>
...
<h4 id="_4-1-2-jms-两种消息模型" tabindex="-1"><a class="header-anchor" href="#_4-1-2-jms-两种消息模型" aria-hidden="true">#</a> 4.1.2 JMS 两种消息模型</h4>
...
<h4 id="_4-1-3-jms-五种不同的消息正文格式" tabindex="-1"><a class="header-anchor" href="#_4-1-3-jms-五种不同的消息正文格式" aria-hidden="true">#</a> 4.1.3 JMS 五种不同的消息正文格式</h4>
...
<h3 id="_4-2-amqp" tabindex="-1"><a class="header-anchor" href="#_4-2-amqp" aria-hidden="true">#</a> 4.2 AMQP</h3>
...
<h3 id="_4-3-jms-vs-amqp" tabindex="-1"><a class="header-anchor" href="#_4-3-jms-vs-amqp" aria-hidden="true">#</a> 4.3 JMS vs AMQP</h3>
<table>
<thead>
<tr>
...
<h2 id="五-常见的消息队列对比" tabindex="-1"><a class="header-anchor" href="#五-常见的消息队列对比" aria-hidden="true">#</a> 五 常见的消息队列对比</h2>
<table>
<thead>
<tr>
<th>对比方向</th>
