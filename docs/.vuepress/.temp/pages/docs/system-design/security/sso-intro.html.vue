<template><div><h1 id="sso-单点登录" tabindex="-1"><a class="header-anchor" href="#sso-单点登录" aria-hidden="true">#</a> SSO 单点登录</h1>
<blockquote>
<p>本文授权转载自 ： https://ken.io/note/sso-design-implement 作者：ken.io</p>
<p>相关推荐阅读：<strong><a href="https://www.imooc.com/article/286710" target="_blank" rel="noopener noreferrer">系统的讲解 - SSO单点登录<ExternalLinkIcon/></a></strong></p>
</blockquote>
...
<p>常见的Web框架对于<a href="https://ken.io/note/session-principle-skill" target="_blank" rel="noopener noreferrer">Session<ExternalLinkIcon/></a>的实现都是生成一个SessionId存储在浏览器Cookie中。然后将Session内容存储在服务器端内存中，这个 ken.io 在之前<a href="https://ken.io/note/session-principle-skill" target="_blank" rel="noopener noreferrer">Session工作原理<ExternalLinkIcon/></a>中也提到过。整体也是借鉴这个思路。
