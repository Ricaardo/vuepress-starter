<template><div><h1 id="spring设计模式总结" tabindex="-1"><a class="header-anchor" href="#spring设计模式总结" aria-hidden="true">#</a> Spring设计模式总结</h1>
...
<p>Example:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 定义一个事件,继承自ApplicationEvent并且写相应的构造函数</span>
