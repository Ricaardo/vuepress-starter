<template><div><h1 id="spring-事务总结" tabindex="-1"><a class="header-anchor" href="#spring-事务总结" aria-hidden="true">#</a> Spring 事务总结</h1>
<p>大家好，我是 Guide 哥，前段时间答应读者的 <strong>Spring 事务</strong>分析总结终于来了。这部分内容比较重要，不论是对于工作还是面试，但是网上比较好的参考资料比较少。</p>
<p>如果本文有任何不对或者需要完善的地方，请帮忙指出！Guide 哥感激不尽！</p>
<h2 id="_1-什么是事务" tabindex="-1"><a class="header-anchor" href="#_1-什么是事务" aria-hidden="true">#</a> 1. 什么是事务？</h2>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OrdersService</span> <span class="token punctuation">{</span>
...
<h2 id="_2-事务的特性-acid-了解么" tabindex="-1"><a class="header-anchor" href="#_2-事务的特性-acid-了解么" aria-hidden="true">#</a> 2. 事务的特性（ACID）了解么?</h2>
...
<h2 id="_3-详谈-spring-对事务的支持" tabindex="-1"><a class="header-anchor" href="#_3-详谈-spring-对事务的支持" aria-hidden="true">#</a> 3. 详谈 Spring 对事务的支持</h2>
...
<h3 id="_3-1-spring-支持两种方式的事务管理" tabindex="-1"><a class="header-anchor" href="#_3-1-spring-支持两种方式的事务管理" aria-hidden="true">#</a> 3.1. Spring 支持两种方式的事务管理</h3>
<h4 id="_1-编程式事务管理" tabindex="-1"><a class="header-anchor" href="#_1-编程式事务管理" aria-hidden="true">#</a> 1).编程式事务管理</h4>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testTransaction</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token class-name">TransactionStatus</span> status <span class="token operator">=</span> transactionManager<span class="token punctuation">.</span><span class="token function">getTransaction</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">DefaultTransactionDefinition</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
          ...
          <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-声明式事务管理" tabindex="-1"><a class="header-anchor" href="#_2-声明式事务管理" aria-hidden="true">#</a> 2)声明式事务管理</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-spring-事务管理接口介绍" tabindex="-1"><a class="header-anchor" href="#_3-2-spring-事务管理接口介绍" aria-hidden="true">#</a> 3.2. Spring 事务管理接口介绍</h3>
...
<h4 id="_3-2-1-platformtransactionmanager-事务管理接口" tabindex="-1"><a class="header-anchor" href="#_3-2-1-platformtransactionmanager-事务管理接口" aria-hidden="true">#</a> 3.2.1. PlatformTransactionManager:事务管理接口</h4>
...
<h4 id="_3-2-2-transactiondefinition-事务属性" tabindex="-1"><a class="header-anchor" href="#_3-2-2-transactiondefinition-事务属性" aria-hidden="true">#</a> 3.2.2. TransactionDefinition:事务属性</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-3-transactionstatus-事务状态" tabindex="-1"><a class="header-anchor" href="#_3-2-3-transactionstatus-事务状态" aria-hidden="true">#</a> 3.2.3. TransactionStatus:事务状态</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-事务属性详解" tabindex="-1"><a class="header-anchor" href="#_3-3-事务属性详解" aria-hidden="true">#</a> 3.3. 事务属性详解</h3>
<p><em>实际业务开发中，大家一般都是使用 <code v-pre>@Transactional</code> 注解来开启事务，很多人并不清楚这个参数里面的参数是什么意思，有什么用。为了更好的在项目中使用事务管理，强烈推荐好好阅读一下下面的内容。</em></p>
<h4 id="_3-3-1-事务传播行为" tabindex="-1"><a class="header-anchor" href="#_3-3-1-事务传播行为" aria-hidden="true">#</a> 3.3.1. 事务传播行为</h4>
...
<p>我们在 A 类的<code v-pre>aMethod（）</code>方法中调用了 B 类的 <code v-pre>bMethod()</code> 方法。这个时候就涉及到业务层方法之间互相调用的事务问题。如果我们的 <code v-pre>bMethod()</code>如果发生异常需要回滚，如何配置事务传播行为才能让 <code v-pre>aMethod()</code>也跟着回滚呢？这个时候就需要事务传播行为的知识了，如果你不知道的话一定要好好看一下。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Class</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">TransactionDefinition</span> <span class="token punctuation">{</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_REQUIRED</span> <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_SUPPORTS</span> <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_MANDATORY</span> <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_REQUIRES_NEW</span> <span class="token operator">=</span> <span class="token number">3</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不过如此，为了方便使用，Spring 会相应地定义了一个枚举类：<code v-pre>Propagation</code></p>
...
<p>如果当前存在事务，则创建一个事务作为当前事务的嵌套事务来运行；如果当前没有事务，则该取值等价于<code v-pre>TransactionDefinition.PROPAGATION_REQUIRED</code>。也就是说：</p>
<ol>
<li>在外部方法未开启事务的情况下<code v-pre>Propagation.NESTED</code>和<code v-pre>Propagation.REQUIRED</code>作用相同，修饰的内部方法都会新开启自己的事务，且开启的事务相互独立，互不干扰。</li>
<li>如果外部方法开启事务的话，<code v-pre>Propagation.NESTED</code>修饰的内部方法属于外部事务的子事务，外部主事务回滚的话，子事务也会回滚，而内部子事务可以单独回滚而不影响外部主事务和其他子事务。</li>
</ol>
<p>这里还是简单举个例子：</p>
<p>如果 <code v-pre>aMethod()</code> 回滚的话，<code v-pre>bMethod()</code>和<code v-pre>bMethod2()</code>都要回滚，而<code v-pre>bMethod()</code>回滚的话，并不会造成 <code v-pre>aMethod()</code> 和<code v-pre>bMethod()2</code>回滚。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Class</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Transactional</span><span class="token punctuation">(</span>propagation<span class="token operator">=</span>propagation<span class="token punctuation">.</span><span class="token constant">PROPAGATION_REQUIRED</span><span class="token punctuation">)</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> aMethod <span class="token punctuation">{</span>
        <span class="token comment">//do something</span>
...
<h4 id="_3-3-2-事务隔离级别" tabindex="-1"><a class="header-anchor" href="#_3-3-2-事务隔离级别" aria-hidden="true">#</a> 3.3.2 事务隔离级别</h4>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">TransactionDefinition</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>和事务传播行为这块一样，为了方便使用，Spring 也相应地定义了一个枚举类：<code v-pre>Isolation</code></p>
...
<h4 id="_3-3-3-事务超时属性" tabindex="-1"><a class="header-anchor" href="#_3-3-3-事务超时属性" aria-hidden="true">#</a> 3.3.3. 事务超时属性</h4>
<p>所谓事务超时，就是指一个事务所允许执行的最长时间，如果超过该时间限制但事务还没有完成，则自动回滚事务。在 <code v-pre>TransactionDefinition</code> 中以 int 的值来表示超时时间，其单位是秒，默认值为-1。</p>
<h4 id="_3-3-4-事务只读属性" tabindex="-1"><a class="header-anchor" href="#_3-3-4-事务只读属性" aria-hidden="true">#</a> 3.3.4. 事务只读属性</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>transaction</span><span class="token punctuation">;</span>
...
<h4 id="_3-3-5-事务回滚规则" tabindex="-1"><a class="header-anchor" href="#_3-3-5-事务回滚规则" aria-hidden="true">#</a> 3.3.5. 事务回滚规则</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3-4-transactional-注解使用详解" tabindex="-1"><a class="header-anchor" href="#_3-4-transactional-注解使用详解" aria-hidden="true">#</a> 3.4. @Transactional 注解使用详解</h3>
<h4 id="_1-transactional-的作用范围" tabindex="-1"><a class="header-anchor" href="#_1-transactional-的作用范围" aria-hidden="true">#</a> 1) <code v-pre>@Transactional</code> 的作用范围</h4>
<ol>
...
<h4 id="_2-transactional-的常用配置参数" tabindex="-1"><a class="header-anchor" href="#_2-transactional-的常用配置参数" aria-hidden="true">#</a> 2) <code v-pre>@Transactional</code> 的常用配置参数</h4>
...
<h4 id="_3-transactional-事务注解原理" tabindex="-1"><a class="header-anchor" href="#_3-transactional-事务注解原理" aria-hidden="true">#</a> 3)<code v-pre>@Transactional</code> 事务注解原理</h4>
...
<h4 id="_4-spring-aop-自调用问题" tabindex="-1"><a class="header-anchor" href="#_4-spring-aop-自调用问题" aria-hidden="true">#</a> 4)Spring AOP 自调用问题</h4>
...
<h4 id="_5-transactional-的使用注意事项总结" tabindex="-1"><a class="header-anchor" href="#_5-transactional-的使用注意事项总结" aria-hidden="true">#</a> 5) <code v-pre>@Transactional</code> 的使用注意事项总结</h4>
<ol>
...
<li>正确的设置 <code v-pre>@Transactional</code> 的 rollbackFor 和 propagation 属性，否则事务可能会回滚失败</li>
<li>......</li>
</ol>
<h2 id="_4-reference" tabindex="-1"><a class="header-anchor" href="#_4-reference" aria-hidden="true">#</a> 4. Reference</h2>
<ol>
<li>
<p>[总结]Spring 事务管理中@Transactional 的参数:<a href="http://www.mobabel.net/spring%E4%BA%8B%E5%8A%A1%E7%AE%A1%E7%90%86%E4%B8%ADtransactional%E7%9A%84%E5%8F%82%E6%95%B0/" target="_blank" rel="noopener noreferrer">http://www.mobabel.net/spring 事务管理中 transactional 的参数/<ExternalLinkIcon/></a></p>
</li>
<li>
<p>Spring 官方文档：<a href="https://docs.spring.io/spring/docs/4.2.x/spring-framework-reference/html/transaction.html" target="_blank" rel="noopener noreferrer">https://docs.spring.io/spring/docs/4.2.x/spring-framework-reference/html/transaction.html<ExternalLinkIcon/></a></p>
</li>
<li>
<p>《Spring5 高级编程》</p>
</li>
<li>
<p>透彻的掌握 Spring 中@transactional 的使用: <a href="https://www.ibm.com/developerworks/cn/java/j-master-spring-transactional-use/index.html" target="_blank" rel="noopener noreferrer">https://www.ibm.com/developerworks/cn/java/j-master-spring-transactional-use/index.html<ExternalLinkIcon/></a></p>
</li>
<li>
<p>Spring 事务的传播特性：<a href="https://github.com/love-somnus/Spring/wiki/Spring%E4%BA%8B%E5%8A%A1%E7%9A%84%E4%BC%A0%E6%92%AD%E7%89%B9%E6%80%A7" target="_blank" rel="noopener noreferrer">https://github.com/love-somnus/Spring/wiki/Spring 事务的传播特性<ExternalLinkIcon/></a></p>
</li>
<li>
<p><a href="https://segmentfault.com/a/1190000013341344" target="_blank" rel="noopener noreferrer">Spring 事务传播行为详解<ExternalLinkIcon/></a> ：<a href="https://segmentfault.com/a/1190000013341344" target="_blank" rel="noopener noreferrer">https://segmentfault.com/a/1190000013341344<ExternalLinkIcon/></a></p>
</li>
<li>
<p>全面分析 Spring 的编程式事务管理及声明式事务管理：<a href="https://www.ibm.com/developerworks/cn/education/opensource/os-cn-spring-trans/index.html" target="_blank" rel="noopener noreferrer">https://www.ibm.com/developerworks/cn/education/opensource/os-cn-spring-trans/index.html<ExternalLinkIcon/></a></p>
</li>
</ol>
</div></template>
