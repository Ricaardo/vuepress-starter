<template><div><h1 id="restful-api-简明教程" tabindex="-1"><a class="header-anchor" href="#restful-api-简明教程" aria-hidden="true">#</a> RestFul API 简明教程</h1>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>GET    /classes：列出所有班级
POST   /classes：新建一个班级
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>/getAllclasses
/createNewclass
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>GET    /classes?state=active&amp;name=guidegege
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>比如我们要实现分页查询：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>GET    /classes?page=1&amp;size=10 //指定第1页，每页10个数据
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span><span class="token string-property property">"link"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
