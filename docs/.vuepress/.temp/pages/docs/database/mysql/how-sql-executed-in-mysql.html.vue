<template><div><p>本文来自<a href="https://github.com/kinglaw1204" target="_blank" rel="noopener noreferrer">木木匠<ExternalLinkIcon/></a>投稿。</p>
...
<h2 id="一-mysql-基础架构分析" tabindex="-1"><a class="header-anchor" href="#一-mysql-基础架构分析" aria-hidden="true">#</a> 一 MySQL 基础架构分析</h2>
<h3 id="_1-1-mysql-基本架构概览" tabindex="-1"><a class="header-anchor" href="#_1-1-mysql-基本架构概览" aria-hidden="true">#</a> 1.1 MySQL 基本架构概览</h3>
...
<h3 id="_1-2-server-层基本组件介绍" tabindex="-1"><a class="header-anchor" href="#_1-2-server-层基本组件介绍" aria-hidden="true">#</a> 1.2 Server 层基本组件介绍</h3>
<h4 id="_1-连接器" tabindex="-1"><a class="header-anchor" href="#_1-连接器" aria-hidden="true">#</a> 1) 连接器</h4>
...
<h4 id="_2-查询缓存-mysql-8-0-版本后移除" tabindex="-1"><a class="header-anchor" href="#_2-查询缓存-mysql-8-0-版本后移除" aria-hidden="true">#</a> 2) 查询缓存(MySQL 8.0 版本后移除)</h4>
...
<h4 id="_3-分析器" tabindex="-1"><a class="header-anchor" href="#_3-分析器" aria-hidden="true">#</a> 3) 分析器</h4>
...
<h4 id="_4-优化器" tabindex="-1"><a class="header-anchor" href="#_4-优化器" aria-hidden="true">#</a> 4) 优化器</h4>
...
<h4 id="_5-执行器" tabindex="-1"><a class="header-anchor" href="#_5-执行器" aria-hidden="true">#</a> 5) 执行器</h4>
<p>当选择了执行方案后，MySQL 就准备开始执行了，首先执行前会校验该用户有没有权限，如果没有权限，就会返回错误信息，如果有权限，就会去调用引擎的接口，返回接口执行的结果。</p>
<h2 id="二-语句分析" tabindex="-1"><a class="header-anchor" href="#二-语句分析" aria-hidden="true">#</a> 二 语句分析</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>结合上面的说明，我们分析下这个语句的执行流程：</p>
<ul>
<li>
...
<h3 id="_2-2-更新语句" tabindex="-1"><a class="header-anchor" href="#_2-2-更新语句" aria-hidden="true">#</a> 2.2 更新语句</h3>
<p>以上就是一条查询 sql 的执行流程，那么接下来我们看看一条更新语句如何执行的呢？sql 语句如下：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>update tb_student A set A.age='19' where A.name=' 张三 ';
...
<ul>
<li>《MySQL 实战45讲》</li>
<li>MySQL 5.6参考手册:<a href="https://dev.MySQL.com/doc/refman/5.6/en/" target="_blank" rel="noopener noreferrer">https://dev.MySQL.com/doc/refman/5.6/en/<ExternalLinkIcon/></a></li>
</ul>
</div></template>
