...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code>class ReadView <span class="token punctuation">{</span>
...
<ol>
<li>
<p><strong><code v-pre>假设时间线来到 T4 ，那么此时数据行 id = 1 的版本链为</code>：</strong></p>
...
<ol start="2">
<li>
<p><strong><code v-pre>时间线来到 T6 ，数据的版本链为</code>：</strong></p>
...
<ol start="3">
<li><strong><code v-pre>时间线来到 T9 ，数据的版本链为</code>：</strong></li>
</ol>
...
<ol>
<li><strong><code v-pre>在 T4 情况下的版本链为</code>：</strong></li>
</ol>
...
<ol start="2">
<li>
<p><strong><code v-pre>时间点 T6 情况下</code>：</strong></p>
