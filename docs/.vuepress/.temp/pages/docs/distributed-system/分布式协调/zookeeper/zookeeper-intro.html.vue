<template><div><h1 id="zookeeper-相关概念总结-入门" tabindex="-1"><a class="header-anchor" href="#zookeeper-相关概念总结-入门" aria-hidden="true">#</a> ZooKeeper 相关概念总结(入门)</h1>
...
<h2 id="_2-zookeeper-介绍" tabindex="-1"><a class="header-anchor" href="#_2-zookeeper-介绍" aria-hidden="true">#</a> 2. ZooKeeper 介绍</h2>
<h3 id="_2-1-zookeeper-由来" tabindex="-1"><a class="header-anchor" href="#_2-1-zookeeper-由来" aria-hidden="true">#</a> 2.1. ZooKeeper 由来</h3>
...
<h3 id="_2-2-zookeeper-概览" tabindex="-1"><a class="header-anchor" href="#_2-2-zookeeper-概览" aria-hidden="true">#</a> 2.2. ZooKeeper 概览</h3>
...
<h3 id="_2-3-zookeeper-特点" tabindex="-1"><a class="header-anchor" href="#_2-3-zookeeper-特点" aria-hidden="true">#</a> 2.3. ZooKeeper 特点</h3>
<ul>
...
<h3 id="_2-4-zookeeper-典型应用场景" tabindex="-1"><a class="header-anchor" href="#_2-4-zookeeper-典型应用场景" aria-hidden="true">#</a> 2.4. ZooKeeper 典型应用场景</h3>
...
<h3 id="_2-5-有哪些著名的开源项目用到了-zookeeper" tabindex="-1"><a class="header-anchor" href="#_2-5-有哪些著名的开源项目用到了-zookeeper" aria-hidden="true">#</a> 2.5. 有哪些著名的开源项目用到了 ZooKeeper?</h3>
<ol>
...
<h2 id="_3-zookeeper-重要概念解读" tabindex="-1"><a class="header-anchor" href="#_3-zookeeper-重要概念解读" aria-hidden="true">#</a> 3. ZooKeeper 重要概念解读</h2>
<p><em>破音：拿出小本本，下面的内容非常重要哦！</em></p>
<h3 id="_3-1-data-model-数据模型" tabindex="-1"><a class="header-anchor" href="#_3-1-data-model-数据模型" aria-hidden="true">#</a> 3.1. Data model（数据模型）</h3>
...
<h3 id="_3-2-znode-数据节点" tabindex="-1"><a class="header-anchor" href="#_3-2-znode-数据节点" aria-hidden="true">#</a> 3.2. znode（数据节点）</h3>
...
<h4 id="_3-2-1-znode-4-种类型" tabindex="-1"><a class="header-anchor" href="#_3-2-1-znode-4-种类型" aria-hidden="true">#</a> 3.2.1. znode 4 种类型</h4>
...
<h4 id="_3-2-2-znode-数据结构" tabindex="-1"><a class="header-anchor" href="#_3-2-2-znode-数据结构" aria-hidden="true">#</a> 3.2.2. znode 数据结构</h4>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>zk: <span class="token number">127.0</span>.0.1:2181<span class="token punctuation">(</span>CONNECTED<span class="token punctuation">)</span> <span class="token number">6</span><span class="token punctuation">]</span> get /dubbo
...
<h3 id="_3-3-版本-version" tabindex="-1"><a class="header-anchor" href="#_3-3-版本-version" aria-hidden="true">#</a> 3.3. 版本（version）</h3>
...
<h3 id="_3-4-acl-权限控制" tabindex="-1"><a class="header-anchor" href="#_3-4-acl-权限控制" aria-hidden="true">#</a> 3.4. ACL（权限控制）</h3>
...
<h3 id="_3-5-watcher-事件监听器" tabindex="-1"><a class="header-anchor" href="#_3-5-watcher-事件监听器" aria-hidden="true">#</a> 3.5. Watcher（事件监听器）</h3>
...
<h3 id="_3-6-会话-session" tabindex="-1"><a class="header-anchor" href="#_3-6-会话-session" aria-hidden="true">#</a> 3.6. 会话（Session）</h3>
...
<p>Session 有一个属性叫做：<code v-pre>sessionTimeout</code> ，<code v-pre>sessionTimeout</code> 代表会话的超时时间。当由于服务器压力太大、网络故障或是客户端主动断开连接等各种原因导致客户端连接断开时，只要在<code v-pre>sessionTimeout</code>规定的时间内能够重新连接上集群中任意一台服务器，那么之前创建的会话仍然有效。</p>
<p>另外，在为客户端创建会话之前，服务端首先会为每个客户端都分配一个 <code v-pre>sessionID</code>。由于 <code v-pre>sessionID</code>是 ZooKeeper 会话的一个重要标识，许多与会话相关的运行机制都是基于这个 <code v-pre>sessionID</code> 的，因此，无论是哪台服务器为客户端分配的 <code v-pre>sessionID</code>，都务必保证全局唯一。</p>
<h2 id="_4-zookeeper-集群" tabindex="-1"><a class="header-anchor" href="#_4-zookeeper-集群" aria-hidden="true">#</a> 4. ZooKeeper 集群</h2>
...
<h3 id="_4-1-zookeeper-集群角色" tabindex="-1"><a class="header-anchor" href="#_4-1-zookeeper-集群角色" aria-hidden="true">#</a> 4.1. ZooKeeper 集群角色</h3>
...
<h3 id="_4-2-zookeeper-集群中的服务器状态" tabindex="-1"><a class="header-anchor" href="#_4-2-zookeeper-集群中的服务器状态" aria-hidden="true">#</a> 4.2. ZooKeeper 集群中的服务器状态</h3>
<ul>
...
<h3 id="_4-3-zookeeper-集群为啥最好奇数台" tabindex="-1"><a class="header-anchor" href="#_4-3-zookeeper-集群为啥最好奇数台" aria-hidden="true">#</a> 4.3. ZooKeeper 集群为啥最好奇数台？</h3>
...
<h3 id="_4-4-zookeeper-选举的过半机制防止脑裂" tabindex="-1"><a class="header-anchor" href="#_4-4-zookeeper-选举的过半机制防止脑裂" aria-hidden="true">#</a> 4.4. ZooKeeper 选举的过半机制防止脑裂</h3>
...
<h2 id="_5-zab-协议和-paxos-算法" tabindex="-1"><a class="header-anchor" href="#_5-zab-协议和-paxos-算法" aria-hidden="true">#</a> 5. ZAB 协议和 Paxos 算法</h2>
...
<h3 id="_5-1-zab-协议介绍" tabindex="-1"><a class="header-anchor" href="#_5-1-zab-协议介绍" aria-hidden="true">#</a> 5.1. ZAB 协议介绍</h3>
...
<h3 id="_5-2-zab-协议两种基本的模式-崩溃恢复和消息广播" tabindex="-1"><a class="header-anchor" href="#_5-2-zab-协议两种基本的模式-崩溃恢复和消息广播" aria-hidden="true">#</a> 5.2. ZAB 协议两种基本的模式：崩溃恢复和消息广播</h3>
...
<ul>
<li><a href="http://codemacro.com/2014/10/15/explain-poxos/" target="_blank" rel="noopener noreferrer">图解 Paxos 一致性协议<ExternalLinkIcon/></a></li>
<li><a href="https://dbaplus.cn/news-141-1875-1.html" target="_blank" rel="noopener noreferrer">Zookeeper ZAB 协议分析<ExternalLinkIcon/></a></li>
</ul>
...
<h2 id="_7-参考" tabindex="-1"><a class="header-anchor" href="#_7-参考" aria-hidden="true">#</a> 7. 参考</h2>
<ol>
