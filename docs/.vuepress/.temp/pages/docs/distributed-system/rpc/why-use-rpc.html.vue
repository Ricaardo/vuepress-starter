<template><div><h1 id="服务之间的调用为啥不直接用-http-而用-rpc" tabindex="-1"><a class="header-anchor" href="#服务之间的调用为啥不直接用-http-而用-rpc" aria-hidden="true">#</a> 服务之间的调用为啥不直接用 HTTP 而用 RPC？</h1>
<h2 id="什么是-rpc-rpc原理是什么" tabindex="-1"><a class="header-anchor" href="#什么是-rpc-rpc原理是什么" aria-hidden="true">#</a> 什么是 RPC?RPC原理是什么?</h2>
<h3 id="什么是-rpc" tabindex="-1"><a class="header-anchor" href="#什么是-rpc" aria-hidden="true">#</a> <strong>什么是 RPC？</strong></h3>
...
<h3 id="rpc原理是什么" tabindex="-1"><a class="header-anchor" href="#rpc原理是什么" aria-hidden="true">#</a> <strong>RPC原理是什么？</strong></h3>
...
<li>客户端 Stub（client stub）接收到消息并将消息反序列化为Java对象:<code v-pre>RpcResponse</code> ，这样也就得到了最终结果。</li>
</ol>
<p>下面再贴一个网上的时序图，辅助理解：</p>
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-12-6/32527396.jpg" alt="RPC原理时序图"></p>
<h3 id="rpc-解决了什么问题" tabindex="-1"><a class="header-anchor" href="#rpc-解决了什么问题" aria-hidden="true">#</a> RPC 解决了什么问题？</h3>
<p>从上面对 RPC 介绍的内容中，概括来讲RPC 主要解决了：<strong>让分布式或者微服务系统中不同服务之间的调用像本地调用一样简单。</strong></p>
<h3 id="常见的-rpc-框架总结" tabindex="-1"><a class="header-anchor" href="#常见的-rpc-框架总结" aria-hidden="true">#</a> 常见的 RPC 框架总结?</h3>
<ul>
...
<h3 id="rpc学习材料" tabindex="-1"><a class="header-anchor" href="#rpc学习材料" aria-hidden="true">#</a> RPC学习材料</h3>
<ul>
<li><a href="https://github.com/Snailclimb/guide-rpc-framework" target="_blank" rel="noopener noreferrer">跟着 Guide 哥造轮子<ExternalLinkIcon/></a></li>
</ul>
<h2 id="既有-http-为啥用-rpc-进行服务调用" tabindex="-1"><a class="header-anchor" href="#既有-http-为啥用-rpc-进行服务调用" aria-hidden="true">#</a> 既有 HTTP ,为啥用 RPC 进行服务调用?</h2>
<h3 id="rpc-只是一种设计而已" tabindex="-1"><a class="header-anchor" href="#rpc-只是一种设计而已" aria-hidden="true">#</a> RPC 只是一种设计而已</h3>
...
<h3 id="http-和-tcp" tabindex="-1"><a class="header-anchor" href="#http-和-tcp" aria-hidden="true">#</a> HTTP 和 TCP</h3>
...
<h3 id="rpc框架功能更齐全" tabindex="-1"><a class="header-anchor" href="#rpc框架功能更齐全" aria-hidden="true">#</a> RPC框架功能更齐全</h3>
...
<h3 id="一个常见的错误观点" tabindex="-1"><a class="header-anchor" href="#一个常见的错误观点" aria-hidden="true">#</a> 一个常见的错误观点</h3>
