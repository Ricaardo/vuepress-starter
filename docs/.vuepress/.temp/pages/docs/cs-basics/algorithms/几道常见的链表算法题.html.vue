<template><div><h1 id="几道常见的链表算法题" tabindex="-1"><a class="header-anchor" href="#几道常见的链表算法题" aria-hidden="true">#</a> 几道常见的链表算法题</h1>
<h2 id="_1-两数相加" tabindex="-1"><a class="header-anchor" href="#_1-两数相加" aria-hidden="true">#</a> 1. 两数相加</h2>
...
<p>示例：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：(2 -> 4 -> 3) + (5 -> 6 -> 4)
输出：7 -> 0 -> 8
原因：342 + 465 = 807
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>给定一个链表: 1->2->3->4->5, 和 n = 2.
