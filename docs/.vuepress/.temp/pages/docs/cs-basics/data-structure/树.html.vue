...
<p><strong>二叉树</strong> 的第 i 层至多拥有 <code v-pre>2^(i-1)</code> 个节点，深度为 k 的二叉树至多总共有 <code v-pre>2^k-1</code> 个节点</p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/满二叉树.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/完全二叉树.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/斜树.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/平衡二叉树.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/链式存储二叉树.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/顺序存储.png" alt=""></p>
<p>大家可以试着填写一下存储如下二叉树的数组，比较一下和完全二叉树的顺序存储有何区别：</p>
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/顺序存储2.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/先序遍历.png" alt=""></p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/中序遍历.png" alt=""></p>
<p>二叉树的中序遍历，就是先递归中序遍历左子树，再输出根结点的值，再递归中序遍历右子树，大家可以想象成一巴掌把树压扁，父结点被拍到了左子节点和右子节点的中间，如下图所示：</p>
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/中序遍历2.png" alt=""></p>
<p>代码如下：</p>
...
<p><img src="@source/docs/cs-basics/data-structure/pictures/树/后序遍历.png" alt=""></p>
