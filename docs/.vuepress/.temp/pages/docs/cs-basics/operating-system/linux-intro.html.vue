...
<h2 id="_1-从认识操作系统开始" tabindex="-1"><a class="header-anchor" href="#_1-从认识操作系统开始" aria-hidden="true">#</a> 1. 从认识操作系统开始</h2>
...
<h3 id="_1-1-操作系统简介" tabindex="-1"><a class="header-anchor" href="#_1-1-操作系统简介" aria-hidden="true">#</a> 1.1. 操作系统简介</h3>
...
<h3 id="_1-2-操作系统简单分类" tabindex="-1"><a class="header-anchor" href="#_1-2-操作系统简单分类" aria-hidden="true">#</a> 1.2. 操作系统简单分类</h3>
<h4 id="_1-2-1-windows" tabindex="-1"><a class="header-anchor" href="#_1-2-1-windows" aria-hidden="true">#</a> 1.2.1. Windows</h4>
...
<h4 id="_1-2-2-unix" tabindex="-1"><a class="header-anchor" href="#_1-2-2-unix" aria-hidden="true">#</a> 1.2.2. Unix</h4>
<p>最早的多用户、多任务操作系统 。后面崛起的 Linux 在很多方面都参考了 Unix。</p>
<p>目前这款操作系统已经逐渐逐渐退出操作系统的舞台。</p>
<p><img src="images/unix.png" alt="unix"></p>
<h4 id="_1-2-3-linux" tabindex="-1"><a class="header-anchor" href="#_1-2-3-linux" aria-hidden="true">#</a> 1.2.3. Linux</h4>
...
<h4 id="_1-2-4-mac-os" tabindex="-1"><a class="header-anchor" href="#_1-2-4-mac-os" aria-hidden="true">#</a> 1.2.4. Mac OS</h4>
<p>苹果自家的操作系统，编程体验和 Linux 相当，但是界面、软件生态以及用户体验各方面都要比 Linux 操作系统更好。</p>
<p><img src="images/macos.png" alt="macos"></p>
<h3 id="_1-3-操作系统的内核-kernel" tabindex="-1"><a class="header-anchor" href="#_1-3-操作系统的内核-kernel" aria-hidden="true">#</a> 1.3. 操作系统的内核（Kernel）</h3>
...
<h3 id="_1-4-中央处理器-cpu-central-processing-unit" tabindex="-1"><a class="header-anchor" href="#_1-4-中央处理器-cpu-central-processing-unit" aria-hidden="true">#</a> 1.4. 中央处理器（CPU，Central Processing Unit）</h3>
<p>关于 CPU 简单概括三点：</p>
<ol>
...
<h3 id="_1-5-cpu-vs-kernel-内核" tabindex="-1"><a class="header-anchor" href="#_1-5-cpu-vs-kernel-内核" aria-hidden="true">#</a> 1.5. CPU vs Kernel(内核)</h3>
...
<p><img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/2020-8/Kernel_Layout.png" alt="Kernel_Layout"></p>
<h3 id="_1-6-系统调用" tabindex="-1"><a class="header-anchor" href="#_1-6-系统调用" aria-hidden="true">#</a> 1.6. 系统调用</h3>
...
<h2 id="_2-初探-linux" tabindex="-1"><a class="header-anchor" href="#_2-初探-linux" aria-hidden="true">#</a> 2. 初探 Linux</h2>
<h3 id="_2-1-linux-简介" tabindex="-1"><a class="header-anchor" href="#_2-1-linux-简介" aria-hidden="true">#</a> 2.1. Linux 简介</h3>
...
<h3 id="_2-2-linux-诞生" tabindex="-1"><a class="header-anchor" href="#_2-2-linux-诞生" aria-hidden="true">#</a> 2.2. Linux 诞生</h3>
...
<h3 id="_2-3-常见-linux-发行版本有哪些" tabindex="-1"><a class="header-anchor" href="#_2-3-常见-linux-发行版本有哪些" aria-hidden="true">#</a> 2.3. 常见 Linux 发行版本有哪些？</h3>
...
<h2 id="_3-linux-文件系统概览" tabindex="-1"><a class="header-anchor" href="#_3-linux-文件系统概览" aria-hidden="true">#</a> 3. Linux 文件系统概览</h2>
<h3 id="_3-1-linux-文件系统简介" tabindex="-1"><a class="header-anchor" href="#_3-1-linux-文件系统简介" aria-hidden="true">#</a> 3.1. Linux 文件系统简介</h3>
...
<h3 id="_3-2-inode-介绍" tabindex="-1"><a class="header-anchor" href="#_3-2-inode-介绍" aria-hidden="true">#</a> 3.2. inode 介绍</h3>
...
<h3 id="_3-3-linux-文件类型" tabindex="-1"><a class="header-anchor" href="#_3-3-linux-文件类型" aria-hidden="true">#</a> 3.3. Linux 文件类型</h3>
...
<h3 id="_3-4-linux-目录树" tabindex="-1"><a class="header-anchor" href="#_3-4-linux-目录树" aria-hidden="true">#</a> 3.4. Linux 目录树</h3>
...
<h2 id="_4-linux-基本命令" tabindex="-1"><a class="header-anchor" href="#_4-linux-基本命令" aria-hidden="true">#</a> 4. Linux 基本命令</h2>
<p>下面只是给出了一些比较常用的命令。推荐一个 Linux 命令快查网站，非常不错，大家如果遗忘某些命令或者对某些命令不理解都可以在这里得到解决。</p>
<p>Linux 命令大全：<a href="http://man.linuxde.net/" target="_blank" rel="noopener noreferrer">http://man.linuxde.net/<ExternalLinkIcon/></a></p>
<h3 id="_4-1-目录切换命令" tabindex="-1"><a class="header-anchor" href="#_4-1-目录切换命令" aria-hidden="true">#</a> 4.1. 目录切换命令</h3>
<ul>
...
<h3 id="_4-2-目录的操作命令-增删改查" tabindex="-1"><a class="header-anchor" href="#_4-2-目录的操作命令-增删改查" aria-hidden="true">#</a> 4.2. 目录的操作命令(增删改查)</h3>
<ul>
...
<h3 id="_4-3-文件的操作命令-增删改查" tabindex="-1"><a class="header-anchor" href="#_4-3-文件的操作命令-增删改查" aria-hidden="true">#</a> 4.3. 文件的操作命令(增删改查)</h3>
<ul>
...
<h3 id="_4-4-压缩文件的操作命令" tabindex="-1"><a class="header-anchor" href="#_4-4-压缩文件的操作命令" aria-hidden="true">#</a> 4.4. 压缩文件的操作命令</h3>
...
<h3 id="_4-5-linux-的权限命令" tabindex="-1"><a class="header-anchor" href="#_4-5-linux-的权限命令" aria-hidden="true">#</a> 4.5. Linux 的权限命令</h3>
...
<h3 id="_4-6-linux-用户管理" tabindex="-1"><a class="header-anchor" href="#_4-6-linux-用户管理" aria-hidden="true">#</a> 4.6. Linux 用户管理</h3>
...
<h3 id="_4-7-linux-系统用户组的管理" tabindex="-1"><a class="header-anchor" href="#_4-7-linux-系统用户组的管理" aria-hidden="true">#</a> 4.7. Linux 系统用户组的管理</h3>
...
<h3 id="_4-8-其他常用命令" tabindex="-1"><a class="header-anchor" href="#_4-8-其他常用命令" aria-hidden="true">#</a> 4.8. 其他常用命令</h3>
<ul>
<li>
