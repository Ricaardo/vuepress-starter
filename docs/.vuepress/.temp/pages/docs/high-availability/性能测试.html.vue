<template><div><h1 id="性能测试入门" tabindex="-1"><a class="header-anchor" href="#性能测试入门" aria-hidden="true">#</a> 性能测试入门</h1>
...
<h2 id="一-不同角色看网站性能" tabindex="-1"><a class="header-anchor" href="#一-不同角色看网站性能" aria-hidden="true">#</a> 一 不同角色看网站性能</h2>
<h3 id="_1-1-用户" tabindex="-1"><a class="header-anchor" href="#_1-1-用户" aria-hidden="true">#</a> 1.1 用户</h3>
...
<h3 id="_1-2-开发人员" tabindex="-1"><a class="header-anchor" href="#_1-2-开发人员" aria-hidden="true">#</a> 1.2 开发人员</h3>
...
<h3 id="_1-3-测试人员" tabindex="-1"><a class="header-anchor" href="#_1-3-测试人员" aria-hidden="true">#</a> 1.3 测试人员</h3>
...
<h3 id="_1-4-运维人员" tabindex="-1"><a class="header-anchor" href="#_1-4-运维人员" aria-hidden="true">#</a> 1.4 运维人员</h3>
<p>运维人员会倾向于根据基础设施和资源的利用率来判断网站的性能，比如我们的服务器资源使用是否合理、数据库资源是否存在滥用的情况、当然，这是传统的运维人员，现在 Devpos 火起来后，单纯干运维的很少了。我们这里暂且还保留有这个角色。</p>
<h2 id="二-性能测试需要注意的点" tabindex="-1"><a class="header-anchor" href="#二-性能测试需要注意的点" aria-hidden="true">#</a> 二 性能测试需要注意的点</h2>
<p>几乎没有文章在讲性能测试的时候提到这个问题，大家都会讲如何去性能测试，有哪些性能测试指标这些东西。</p>
<h3 id="_2-1-了解系统的业务场景" tabindex="-1"><a class="header-anchor" href="#_2-1-了解系统的业务场景" aria-hidden="true">#</a> 2.1 了解系统的业务场景</h3>
...
<h3 id="_2-2-历史数据非常有用" tabindex="-1"><a class="header-anchor" href="#_2-2-历史数据非常有用" aria-hidden="true">#</a> 2.2 历史数据非常有用</h3>
...
<h3 id="三-性能测试的指标" tabindex="-1"><a class="header-anchor" href="#三-性能测试的指标" aria-hidden="true">#</a> 三 性能测试的指标</h3>
<h3 id="_3-1-响应时间" tabindex="-1"><a class="header-anchor" href="#_3-1-响应时间" aria-hidden="true">#</a> 3.1 响应时间</h3>
...
<h3 id="_3-2-并发数" tabindex="-1"><a class="header-anchor" href="#_3-2-并发数" aria-hidden="true">#</a> 3.2 并发数</h3>
...
<h3 id="_3-3-吞吐量" tabindex="-1"><a class="header-anchor" href="#_3-3-吞吐量" aria-hidden="true">#</a> 3.3 吞吐量</h3>
...
<h3 id="_3-4-性能计数器" tabindex="-1"><a class="header-anchor" href="#_3-4-性能计数器" aria-hidden="true">#</a> 3.4 性能计数器</h3>
<p><strong>性能计数器是描述服务器或者操作系统的一些数据指标如内存使用、CPU使用、磁盘与网络I/O等情况。</strong></p>
<h3 id="四-几种常见的性能测试" tabindex="-1"><a class="header-anchor" href="#四-几种常见的性能测试" aria-hidden="true">#</a> 四 几种常见的性能测试</h3>
<h3 id="性能测试" tabindex="-1"><a class="header-anchor" href="#性能测试" aria-hidden="true">#</a> 性能测试</h3>
<p>性能测试方法是通过测试工具模拟用户请求系统，目的主要是为了测试系统的性能是否满足要求。通俗地说，这种方法就是要在特定的运行条件下验证系统的能力状态。</p>
<p>性能测试是你在对系统性能已经有了解的前提之后进行的，并且有明确的性能指标。</p>
<h3 id="负载测试" tabindex="-1"><a class="header-anchor" href="#负载测试" aria-hidden="true">#</a> 负载测试</h3>
<p>对被测试的系统继续加大请求压力，直到服务器的某个资源已经达到饱和了，比如系统的缓存已经不够用了或者系统的响应时间已经不满足要求了。</p>
<p>负载测试说白点就是测试系统的上线。</p>
<h3 id="压力测试" tabindex="-1"><a class="header-anchor" href="#压力测试" aria-hidden="true">#</a> 压力测试</h3>
<p>不去管系统资源的使用情况，对系统继续加大请求压力，直到服务器崩溃无法再继续提供服务。</p>
<h3 id="稳定性测试" tabindex="-1"><a class="header-anchor" href="#稳定性测试" aria-hidden="true">#</a> 稳定性测试</h3>
<p>模拟真实场景，给系统一定压力，看看业务是否能稳定运行。</p>
<h2 id="五-常用性能测试工具" tabindex="-1"><a class="header-anchor" href="#五-常用性能测试工具" aria-hidden="true">#</a> 五 常用性能测试工具</h2>
<p>这里就不多扩展了，有时间的话会单独拎一个熟悉的说一下。</p>
<h3 id="_5-1-后端常用" tabindex="-1"><a class="header-anchor" href="#_5-1-后端常用" aria-hidden="true">#</a> 5.1 后端常用</h3>
...
<h3 id="_5-2-前端常用" tabindex="-1"><a class="header-anchor" href="#_5-2-前端常用" aria-hidden="true">#</a> 5.2 前端常用</h3>
<ol>
<li>Fiddler：抓包工具，它可以修改请求的数据，甚至可以修改服务器返回的数据，功能非常强大，是Web 调试的利器。</li>
<li>HttpWatch: 可用于录制HTTP请求信息的工具。</li>
</ol>
<h2 id="六-常见的性能优化策略" tabindex="-1"><a class="header-anchor" href="#六-常见的性能优化策略" aria-hidden="true">#</a> 六 常见的性能优化策略</h2>
