<template><div><h1 id="高可用系统设计" tabindex="-1"><a class="header-anchor" href="#高可用系统设计" aria-hidden="true">#</a> 高可用系统设计</h1>
...
<h2 id="什么是高可用-可用性的判断标准是啥" tabindex="-1"><a class="header-anchor" href="#什么是高可用-可用性的判断标准是啥" aria-hidden="true">#</a> 什么是高可用？可用性的判断标准是啥？</h2>
...
<h2 id="哪些情况会导致系统不可用" tabindex="-1"><a class="header-anchor" href="#哪些情况会导致系统不可用" aria-hidden="true">#</a> 哪些情况会导致系统不可用？</h2>
<ol>
<li>黑客攻击；</li>
<li>硬件故障，比如服务器坏掉。</li>
...
<h2 id="有哪些提高系统可用性的方法" tabindex="-1"><a class="header-anchor" href="#有哪些提高系统可用性的方法" aria-hidden="true">#</a> 有哪些提高系统可用性的方法？</h2>
<h3 id="_1-注重代码质量-测试严格把关" tabindex="-1"><a class="header-anchor" href="#_1-注重代码质量-测试严格把关" aria-hidden="true">#</a> 1. 注重代码质量，测试严格把关</h3>
...
<h3 id="_2-使用集群-减少单点故障" tabindex="-1"><a class="header-anchor" href="#_2-使用集群-减少单点故障" aria-hidden="true">#</a> 2.使用集群，减少单点故障</h3>
...
<h3 id="_3-限流" tabindex="-1"><a class="header-anchor" href="#_3-限流" aria-hidden="true">#</a> 3.限流</h3>
<p>流量控制（flow control），其原理是监控应用流量的 QPS 或并发线程数等指标，当达到指定的阈值时对流量进行控制，以避免被瞬时的流量高峰冲垮，从而保障应用的高可用性。——来自 alibaba-<a href="https://github.com/alibaba/Sentinel" title="Sentinel" target="_blank" rel="noopener noreferrer">Sentinel<ExternalLinkIcon/></a> 的 wiki。</p>
<h3 id="_4-超时和重试机制设置" tabindex="-1"><a class="header-anchor" href="#_4-超时和重试机制设置" aria-hidden="true">#</a> 4.超时和重试机制设置</h3>
...
<h3 id="_5-熔断机制" tabindex="-1"><a class="header-anchor" href="#_5-熔断机制" aria-hidden="true">#</a> 5.熔断机制</h3>
...
<h3 id="_6-异步调用" tabindex="-1"><a class="header-anchor" href="#_6-异步调用" aria-hidden="true">#</a> 6.异步调用</h3>
...
<h3 id="_7-使用缓存" tabindex="-1"><a class="header-anchor" href="#_7-使用缓存" aria-hidden="true">#</a> 7.使用缓存</h3>
<p>如果我们的系统属于并发量比较高的话，如果我们单纯使用数据库的话，当大量请求直接落到数据库可能数据库就会直接挂掉。使用缓存缓存热点数据，因为缓存存储在内存中，所以速度相当地快！</p>
<h3 id="_8-其他" tabindex="-1"><a class="header-anchor" href="#_8-其他" aria-hidden="true">#</a> 8.其他</h3>
<ol>
