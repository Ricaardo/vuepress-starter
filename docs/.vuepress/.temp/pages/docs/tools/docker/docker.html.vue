<template><div><h1 id="docker-基本概念解读" tabindex="-1"><a class="header-anchor" href="#docker-基本概念解读" aria-hidden="true">#</a> Docker 基本概念解读</h1>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> version <span class="token comment"># 查看docker版本</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> search mysql <span class="token comment"># 查看mysql相关镜像</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> rmi f6509bac4980 <span class="token comment">#  或者 docker rmi mysql </span>
...
<blockquote>
<p>虚拟化技术是一种资源管理技术，是将计算机的各种[实体资源](https://zh.wikipedia.org/wiki/資源_(計算機科學 &quot;实体资源&quot;))（<a href="https://zh.wikipedia.org/wiki/CPU" title="CPU" target="_blank" rel="noopener noreferrer">CPU<ExternalLinkIcon/></a>、<a href="https://zh.wikipedia.org/wiki/%E5%86%85%E5%AD%98" title="内存" target="_blank" rel="noopener noreferrer">内存<ExternalLinkIcon/></a>、<a href="https://zh.wikipedia.org/wiki/%E7%A3%81%E7%9B%98%E7%A9%BA%E9%97%B4" title="磁盘空间" target="_blank" rel="noopener noreferrer">磁盘空间<ExternalLinkIcon/></a>、<a href="https://zh.wikipedia.org/wiki/%E7%B6%B2%E8%B7%AF%E9%81%A9%E9%85%8D%E5%99%A8" title="网络适配器" target="_blank" rel="noopener noreferrer">网络适配器<ExternalLinkIcon/></a>等），予以抽象、转换后呈现出来并可供分割、组合为一个或多个电脑配置环境。由此，打破实体结构间的不可切割的障碍，使用户可以比原本的配置更好的方式来应用这些电脑硬件资源。这些资源的新虚拟部分是不受现有资源的架设方式，地域或物理配置所限制。一般所指的虚拟化资源包括计算能力和数据存储。</p>
</blockquote>
