...
<p><code v-pre>StringBuilder </code>是 Java SE5 引入的，在这之前用的是 <code v-pre>StringBuffer</code>。后者是线程安全的（参见<RouterLink to="/24-Concurrent-Programming.html">并发编程</RouterLink>），因此开销也会大些。使用 <code v-pre>StringBuilder</code> 进行字符串操作更快一点。</p>
...
<p>Java SE5 引入了 <code v-pre>format()</code> 方法，可用于 <code v-pre>PrintStream</code> 或者 <code v-pre>PrintWriter</code> 对象（你可以在 <RouterLink to="/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 了解更多内容），其中也包括 <code v-pre>System.out</code> 对象。<code v-pre>format()</code> 方法模仿了 C 语言的 <code v-pre>printf()</code>。如果你比较怀旧的话，也可以使用 <code v-pre>printf()</code>。以下是一个简单的示例：</p>
...
<p>所有的 <code v-pre>tommy</code> 都将输出到 <code v-pre>System.out</code>，而所有的 <code v-pre>terry</code> 则都输出到 <code v-pre>System.out</code> 的一个别名中。<code v-pre>Formatter</code> 的重载构造器支持输出到多个路径，不过最常用的还是 <code v-pre>PrintStream()</code>（如上例）、<code v-pre>OutputStream</code> 和 <code v-pre>File</code>。你可以在 <RouterLink to="/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 中了解更多信息。</p>
...
00050: 45 0A 00 14 00 46 0A 00 47 00 48 07 00 49 01 00
                  ... 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了打开及读入二进制文件，我们用到了另一个工具 <code v-pre>Files.readAllBytes()</code>，这已经在 <RouterLink to="/17-Files.html">Files章节</RouterLink> 介绍过了。这里的 <code v-pre>readAllBytes()</code> 方法将整个文件以 <code v-pre>byte</code> 数组的形式返回。</p>
<!-- Regular Expressions -->
...
ExtrActEd blOck. 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此处使用上一章介绍过的 <RouterLink to="/17-Files.html"><code v-pre>Files</code></RouterLink> 类打开并读入文件。<code v-pre>Files.lines()</code> 返回一个 <code v-pre>Stream</code> 对象，包含读入的所有行，<code v-pre>Collectors.joining()</code> 在每一行的结尾追加参数字符序列，最终拼接成一个 <code v-pre>String</code> 对象。</p>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>input</code> 字段使用的类来自 <code v-pre>java.io</code>，<RouterLink to="/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 详细介绍了相关内容。<code v-pre>StringReader</code> 将 <code v-pre>String</code> 转化为可读的流对象，然后用这个对象来构造 <code v-pre>BufferedReader</code> 对象，因为我们要使用 <code v-pre>BufferedReader</code> 的 <code v-pre>readLine()</code> 方法。最终，我们可以使用 <code v-pre>input</code> 对象一次读取一行文本，就像从控制台读入标准输入一样。</p>
