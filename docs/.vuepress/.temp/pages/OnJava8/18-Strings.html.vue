...
<!-- Strings -->
<h1 id="第十八章-字符串" tabindex="-1"><a class="header-anchor" href="#第十八章-字符串" aria-hidden="true">#</a> 第十八章 字符串</h1>
<blockquote>
<p>字符串操作毫无疑问是计算机程序设计中最常见的行为之一。</p>
</blockquote>
<p>在 Java 大展拳脚的 Web 系统中更是如此。在本章中，我们将深入学习在 Java 语言中应用最广泛的 <code v-pre>String</code> 类，并研究与之相关的类及工具。</p>
<!-- Immutable Strings -->
<h2 id="字符串的不可变" tabindex="-1"><a class="header-anchor" href="#字符串的不可变" aria-hidden="true">#</a> 字符串的不可变</h2>
<p><code v-pre>String</code> 对象是不可变的。查看 JDK 文档你就会发现，<code v-pre>String</code> 类中每一个看起来会修改 <code v-pre>String</code> 值的方法，实际上都是创建了一个全新的 <code v-pre>String</code> 对象，以包含修改后的字符串内容。而最初的 <code v-pre>String</code> 对象则丝毫未动。</p>
<p>看看下面的代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Immutable.java</span>
...
howdy
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当把 <code v-pre>q</code> 传递给 <code v-pre>upcase()</code> 方法时，实际传递的是引用的一个拷贝。其实，每当把 String 对象作为方法的参数时，都会复制一份引用，而该引用所指向的对象其实一直待在单一的物理位置上，从未动过。</p>
<p>回到 <code v-pre>upcase()</code> 的定义，传入其中的引用有了名字 <code v-pre>s</code>，只有 <code v-pre>upcase()</code> 运行的时候，局部引用 <code v-pre>s</code> 才存在。一旦 <code v-pre>upcase()</code> 运行结束，<code v-pre>s</code> 就消失了。当然了，<code v-pre>upcase()</code> 的返回值，其实是最终结果的引用。这足以说明，<code v-pre>upcase()</code> 返回的引用已经指向了一个新的对象，而 <code v-pre>q</code> 仍然在原来的位置。</p>
<p><code v-pre>String</code> 的这种行为正是我们想要的。例如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s <span class="token operator">=</span> <span class="token string">"asdf"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>难道你真的希望 <code v-pre>upcase()</code> 方法改变其参数吗？对于一个方法而言，参数是为该方法提供信息的，而不是想让该方法改变自己的。在阅读这段代码时，读者自然会有这样的感觉。这一点很重要，正是有了这种保障，才使得代码易于编写和阅读。</p>
<!-- Overloading + vs. StringBuilder -->
<h2 id="的重载与-stringbuilder" tabindex="-1"><a class="header-anchor" href="#的重载与-stringbuilder" aria-hidden="true">#</a> + 的重载与 StringBuilder</h2>
<p><code v-pre>String</code> 对象是不可变的，你可以给一个 <code v-pre>String</code> 对象添加任意多的别名。因为 <code v-pre>String</code> 是只读的，所以指向它的任何引用都不可能修改它的值，因此，也就不会影响到其他引用。</p>
<p>不可变性会带来一定的效率问题。为 <code v-pre>String</code> 对象重载的 <code v-pre>+</code> 操作符就是一个例子。重载的意思是，一个操作符在用于特定的类时，被赋予了特殊的意义（用于 <code v-pre>String</code> 的 <code v-pre>+</code> 与 <code v-pre>+=</code> 是 Java 中仅有的两个重载过的操作符，Java 不允许程序员重载任何其他的操作符 [^1]）。</p>
<p>操作符 <code v-pre>+</code> 可以用来连接 <code v-pre>String</code>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Concatenation.java</span>
...
abcmangodef47 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以想象一下，这段代码是这样工作的：<code v-pre>String</code> 可能有一个 <code v-pre>append()</code> 方法，它会生成一个新的 <code v-pre>String</code> 对象，以包含“abc”与 <code v-pre>mango</code> 连接后的字符串。该对象会再创建另一个新的 <code v-pre>String</code> 对象，然后与“def”相连，生成另一个新的对象，依此类推。</p>
<p>这种方式当然是可行的，但是为了生成最终的 <code v-pre>String</code> 对象，会产生一大堆需要垃圾回收的中间对象。我猜想，Java 设计者一开始就是这么做的（这也是软件设计中的一个教训：除非你用代码将系统实现，并让它运行起来，否则你无法真正了解它会有什么问题），然后他们发现其性能相当糟糕。</p>
<p>想看看以上代码到底是如何工作的吗？可以用 JDK 自带的 <code v-pre>javap</code> 工具来反编译以上代码。命令如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>javap <span class="token operator">-</span>c <span class="token class-name">Concatenation</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里的 <code v-pre>-c</code> 标志表示将生成 JVM 字节码。我们剔除不感兴趣的部分，然后做细微的修改，于是有了以下的字节码：</p>
<div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre v-pre class="language-x86asm"><code>public static void main(java.lang.String[]); 
 Code:
  ...
  40: return
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果你有汇编语言的经验，以上代码应该很眼熟(其中的 <code v-pre>dup</code> 和 <code v-pre>invokevirtual</code> 语句相当于Java虚拟机上的汇编语句。即使你完全不了解汇编语言也无需担心)。需要重点注意的是：编译器自动引入了 <code v-pre>java.lang.StringBuilder</code> 类。虽然源代码中并没有使用 <code v-pre>StringBuilder</code> 类，但是编译器却自作主张地使用了它，就因为它更高效。</p>
<p>在这里，编译器创建了一个 <code v-pre>StringBuilder</code> 对象，用于构建最终的 <code v-pre>String</code>，并对每个字符串调用了一次 <code v-pre>append()</code> 方法，共计 4 次。最后调用 <code v-pre>toString()</code> 生成结果，并存为 <code v-pre>s</code> (使用的命令为 <code v-pre>astore_2</code>)。</p>
<p>现在，也许你会觉得可以随意使用 <code v-pre>String</code> 对象，反正编译器会自动为你做性能优化。可是在这之前，让我们更深入地看看编译器能为我们优化到什么程度。下面的例子采用两种方式生成一个 <code v-pre>String</code>：方法一使用了多个 <code v-pre>String</code> 对象；方法二在代码中使用了 <code v-pre>StringBuilder</code>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/WhitherStringBuilder.java</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">WhitherStringBuilder</span> <span class="token punctuation">{</span> 
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在运行 <code v-pre>javap -c WhitherStringBuilder</code>，可以看到两种不同方法（我已经去掉不相关的细节）对应的字节码。首先是 <code v-pre>implicit()</code> 方法：</p>
<div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre v-pre class="language-x86asm"><code>public java.lang.String implicit(java.lang.String[]); 
0: ldc #2 // String 
2: astore_2
3: aload_1 
4: astore_3 
...
51: aload_2 
52: areturn
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意从第 16 行到第 48 行构成了一个循环体。第 16 行：对堆栈中的操作数进行“大于或等于的整数比较运算”，循环结束时跳转到第 51 行。第 48 行：重新回到循环体的起始位置（第 12 行）。注意：<code v-pre>StringBuilder</code> 是在循环内构造的，这意味着每进行一次循环，会创建一个新的 <code v-pre>StringBuilder</code> 对象。</p>
<p>下面是 <code v-pre>explicit()</code> 方法对应的字节码：</p>
<div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre v-pre class="language-x86asm"><code>public java.lang.String explicit(java.lang.String[]); 
...
47: areturn
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到，不仅循环部分的代码更简短、更简单，而且它只生成了一个 <code v-pre>StringBuilder</code> 对象。显式地创建 <code v-pre>StringBuilder</code> 还允许你预先为其指定大小。如果你已经知道最终字符串的大概长度，那预先指定 <code v-pre>StringBuilder</code> 的大小可以避免频繁地重新分配缓冲。</p>
<p>因此，当你为一个类编写 <code v-pre>toString()</code> 方法时，如果字符串操作比较简单，那就可以信赖编译器，它会为你合理地构造最终的字符串结果。但是，如果你要在 <code v-pre>toString()</code> 方法中使用循环，且可能有性能问题，那么最好自己创建一个 <code v-pre>StringBuilder</code> 对象，用它来构建最终结果。请参考以下示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/UsingStringBuilder.java </span>
...
9, 78, 98, 61, 20, 58, 16, 40, 11, 22, 4] 
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在方法 <code v-pre>string1()</code> 中，最终结果是用 <code v-pre>append()</code> 语句拼接起来的。如果你想走捷径，例如：<code v-pre>append(a + &quot;: &quot; + c)</code>，编译器就会掉入陷阱，从而为你另外创建一个 <code v-pre>StringBuilder</code> 对象处理括号内的字符串操作。如果拿不准该用哪种方式，随时可以用 <code v-pre>javap</code> 来分析你的程序。</p>
<p><code v-pre>StringBuilder</code> 提供了丰富而全面的方法，包括 <code v-pre>insert()</code>、<code v-pre>replace()</code>、<code v-pre>substring()</code>，甚至还有<code v-pre>reverse()</code>，但是最常用的还是 <code v-pre>append()</code> 和 <code v-pre>toString()</code>。还有 <code v-pre>delete()</code>，上面的例子中我们用它删除最后一个逗号和空格，以便添加右括号。</p>
<p><code v-pre>string2()</code> 使用了 <code v-pre>Stream</code>，这样代码更加简洁美观。可以证明，<code v-pre>Collectors.joining()</code> 内部也是使用的 <code v-pre>StringBuilder</code>，这种写法不会影响性能！</p>
<p><code v-pre>StringBuilder </code>是 Java SE5 引入的，在这之前用的是 <code v-pre>StringBuffer</code>。后者是线程安全的（参见<RouterLink to="/OnJava8/24-Concurrent-Programming.html">并发编程</RouterLink>），因此开销也会大些。使用 <code v-pre>StringBuilder</code> 进行字符串操作更快一点。</p>
<!-- Unintended Recursion -->
<h2 id="意外递归" tabindex="-1"><a class="header-anchor" href="#意外递归" aria-hidden="true">#</a> 意外递归</h2>
<p>Java 中的每个类从根本上都是继承自 <code v-pre>Object</code>，标准集合类也是如此，它们都有 <code v-pre>toString()</code> 方法，并且覆盖了该方法，使得它生成的 <code v-pre>String</code> 结果能够表达集合自身，以及集合包含的对象。例如 <code v-pre>ArrayList.toString()</code>，它会遍历 <code v-pre>ArrayList</code> 中包含的所有对象，调用每个元素上的 <code v-pre>toString()</code> 方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ArrayListDisplay.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>stream<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果你希望 <code v-pre>toString()</code> 打印出类的内存地址，也许你会考虑使用 <code v-pre>this</code> 关键字：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/InfiniteRecursion.java </span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InfiniteRecursion</span> <span class="token punctuation">{</span> 
    ...
    <span class="token punctuation">}</span> 
<span class="token punctuation">}</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当你创建了 <code v-pre>InfiniteRecursion</code> 对象，并将其打印出来的时候，你会得到一串很长的异常信息。如果你将该 <code v-pre>InfiniteRecursion</code> 对象存入一个 <code v-pre>ArrayList</code> 中，然后打印该 <code v-pre>ArrayList</code>，同样也会抛出异常。其实，当运行到如下代码时：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token string">"InfiniteRecursion address: "</span> <span class="token operator">+</span> <span class="token keyword">this</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里发生了自动类型转换，由 <code v-pre>InfiniteRecursion</code> 类型转换为 <code v-pre>String</code> 类型。因为编译器发现一个 <code v-pre>String</code> 对象后面跟着一个 “+”，而 “+” 后面的对象不是 <code v-pre>String</code>，于是编译器试着将 <code v-pre>this</code> 转换成一个 <code v-pre>String</code>。它怎么转换呢？正是通过调用 <code v-pre>this</code> 上的 <code v-pre>toString()</code> 方法，于是就发生了递归调用。</p>
<p>如果你真的想要打印对象的内存地址，应该调用 <code v-pre>Object.toString()</code> 方法，这才是负责此任务的方法。所以，不要使用 <code v-pre>this</code>，而是应该调用 <code v-pre>super.toString()</code> 方法。</p>
<!-- Operations on Strings -->
<h2 id="字符串操作" tabindex="-1"><a class="header-anchor" href="#字符串操作" aria-hidden="true">#</a> 字符串操作</h2>
<p>以下是 <code v-pre>String</code> 对象具备的一些基本方法。重载的方法归纳在同一行中：</p>
<table>
<thead>
<tr>
<th>方法</th>
...
<tr>
<td>构造方法</td>
<td>默认版本，<code v-pre>String</code>，<code v-pre>StringBuilder</code>，<code v-pre>StringBuffer</code>，<code v-pre>char</code>数组，<code v-pre>byte</code>数组</td>
<td>创建<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>length()</code></td>
<td></td>
<td><code v-pre>String</code>中字符的个数</td>
</tr>
<tr>
<td><code v-pre>charAt()</code></td>
<td><code v-pre>int</code>索引</td>
<td>获取<code v-pre>String</code>中索引位置上的<code v-pre>char</code></td>
</tr>
<tr>
<td><code v-pre>getChars()</code>，<code v-pre>getBytes()</code></td>
<td>待复制部分的开始和结束索引，复制的目标数组，目标数组的开始索引</td>
<td>复制<code v-pre>char</code>或<code v-pre>byte</code>到一个目标数组中</td>
</tr>
<tr>
<td><code v-pre>toCharArray()</code></td>
<td></td>
<td>生成一个<code v-pre>char[]</code>，包含<code v-pre>String</code>中的所有字符</td>
</tr>
<tr>
<td><code v-pre>equals()</code>，<code v-pre>equalsIgnoreCase()</code></td>
<td>与之进行比较的<code v-pre>String</code></td>
<td>比较两个<code v-pre>String</code>的内容是否相同。如果相同，结果为<code v-pre>true</code></td>
</tr>
<tr>
<td><code v-pre>compareTo()</code>，<code v-pre>compareToIgnoreCase()</code></td>
<td>与之进行比较的<code v-pre>String</code></td>
<td>按词典顺序比较<code v-pre>String</code>的内容，比较结果为负数、零或正数。注意，大小写不等价</td>
</tr>
<tr>
<td><code v-pre>contains()</code></td>
<td>要搜索的<code v-pre>CharSequence</code></td>
<td>如果该<code v-pre>String</code>对象包含参数的内容，则返回<code v-pre>true</code></td>
</tr>
<tr>
<td><code v-pre>contentEquals()</code></td>
<td>与之进行比较的<code v-pre>CharSequence</code>或<code v-pre>StringBuffer</code></td>
<td>如果该<code v-pre>String</code>对象与参数的内容完全一致，则返回<code v-pre>true</code></td>
</tr>
<tr>
<td><code v-pre>isEmpty()</code></td>
<td></td>
<td>返回<code v-pre>boolean</code>结果，以表明<code v-pre>String</code>对象的长度是否为0</td>
</tr>
<tr>
<td><code v-pre>regionMatches()</code></td>
<td>该<code v-pre>String</code>的索引偏移量，另一个<code v-pre>String</code>及其索引偏移量，要比较的长度。重载版本增加了“忽略大小写”功能</td>
<td>返回<code v-pre>boolean</code>结果，以表明所比较区域是否相等</td>
</tr>
<tr>
<td><code v-pre>startsWith()</code></td>
<td>可能的起始<code v-pre>String</code>。重载版本在参数中增加了偏移量</td>
<td>返回<code v-pre>boolean</code>结果，以表明该<code v-pre>String</code>是否以传入参数开始</td>
</tr>
<tr>
<td><code v-pre>endsWith()</code></td>
<td>该<code v-pre>String</code>可能的后缀<code v-pre>String</code></td>
<td>返回<code v-pre>boolean</code>结果，以表明此参数是否是该字符串的后缀</td>
</tr>
<tr>
<td><code v-pre>indexOf()</code>，<code v-pre>lastIndexOf()</code></td>
<td>重载版本包括：<code v-pre>char</code>，<code v-pre>char</code>与起始索引，<code v-pre>String</code>，<code v-pre>String</code>与起始索引</td>
<td>如果该<code v-pre>String</code>并不包含此参数，就返回-1；否则返回此参数在<code v-pre>String</code>中的起始索引。<code v-pre>lastIndexOf</code>()是从后往前搜索</td>
</tr>
<tr>
<td><code v-pre>matches()</code></td>
<td>一个正则表达式</td>
<td>返回<code v-pre>boolean</code>结果，以表明该<code v-pre>String</code>和给出的正则表达式是否匹配</td>
</tr>
<tr>
<td><code v-pre>split()</code></td>
<td>一个正则表达式。可选参数为需要拆分的最大数量</td>
<td>按照正则表达式拆分<code v-pre>String</code>，返回一个结果数组</td>
</tr>
<tr>
<td><code v-pre>join()</code>（Java8引入的）</td>
<td>分隔符，待拼字符序列。用分隔符将字符序列拼接成一个新的<code v-pre>String</code></td>
<td>用分隔符拼接字符片段，产生一个新的<code v-pre>String</code></td>
</tr>
<tr>
<td><code v-pre>substring()</code>（即<code v-pre>subSequence()</code>）</td>
<td>重载版本：起始索引；起始索引+终止索引</td>
<td>返回一个新的<code v-pre>String</code>对象，以包含参数指定的子串</td>
</tr>
<tr>
<td><code v-pre>concat()</code></td>
<td>要连接的<code v-pre>String</code></td>
<td>返回一个新的<code v-pre>String</code>对象，内容为原始<code v-pre>String</code>连接上参数<code v-pre>String</code></td>
</tr>
<tr>
<td><code v-pre>replace()</code></td>
<td>要替换的字符，用来进行替换的新字符。也可以用一个<code v-pre>CharSequence</code>替换另一个<code v-pre>CharSequence</code></td>
<td>返回替换字符后的新<code v-pre>String</code>对象。如果没有替换发生，则返回原始的<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>replaceFirst()</code></td>
<td>要替换的正则表达式，用来进行替换的<code v-pre>String</code></td>
<td>返回替换首个目标字符串后的<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>replaceAll()</code></td>
<td>要替换的正则表达式，用来进行替换的<code v-pre>String</code></td>
<td>返回替换所有目标字符串后的<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>toLowerCase()</code>，<code v-pre>toUpperCase()</code></td>
<td></td>
<td>将字符的大小写改变后，返回一个新的<code v-pre>String</code>对象。如果没有任何改变，则返回原始的<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>trim()</code></td>
<td></td>
<td>将<code v-pre>String</code>两端的空白符删除后，返回一个新的<code v-pre>String</code>对象。如果没有任何改变，则返回原始的<code v-pre>String</code>对象</td>
</tr>
<tr>
<td><code v-pre>valueOf()</code>（<code v-pre>static</code>）</td>
<td>重载版本：<code v-pre>Object</code>；<code v-pre>char[]</code>；<code v-pre>char[]</code>，偏移量，与字符个数；<code v-pre>boolean</code>；<code v-pre>char</code>；<code v-pre>int</code>；<code v-pre>long</code>；<code v-pre>float</code>；<code v-pre>double</code></td>
<td>返回一个表示参数内容的<code v-pre>String</code></td>
</tr>
<tr>
<td><code v-pre>intern()</code></td>
<td></td>
<td>为每个唯一的字符序列生成一个且仅生成一个<code v-pre>String</code>引用</td>
</tr>
<tr>
<td><code v-pre>format()</code></td>
<td>要格式化的字符串，要替换到格式化字符串的参数</td>
<td>返回格式化结果<code v-pre>String</code></td>
</tr>
</tbody>
</table>
<p>从这个表可以看出，当需要改变字符串的内容时，<code v-pre>String</code> 类的方法都会返回一个新的 <code v-pre>String</code> 对象。同时，如果内容不改变，<code v-pre>String</code> 方法只是返回原始对象的一个引用而已。这可以节约存储空间以及避免额外的开销。</p>
<p>本章稍后还将介绍正则表达式在 <code v-pre>String</code> 方法中的应用。</p>
<!-- Formatting Output -->
<h2 id="格式化输出" tabindex="-1"><a class="header-anchor" href="#格式化输出" aria-hidden="true">#</a> 格式化输出</h2>
<p>在长久的等待之后，Java SE5 终于推出了 C 语言中 <code v-pre>printf()</code> 风格的格式化输出这一功能。这不仅使得控制输出的代码更加简单，同时也给与Java开发者对于输出格式与排列更强大的控制能力。</p>
<h3 id="printf" tabindex="-1"><a class="header-anchor" href="#printf" aria-hidden="true">#</a> <code v-pre>printf()</code></h3>
<p>C 语言的 <code v-pre>printf()</code> 并不像 Java 那样连接字符串，它使用一个简单的格式化字符串，加上要插入其中的值，然后将其格式化输出。 <code v-pre>printf()</code> 并不使用重载的 <code v-pre>+</code> 操作符（C语言没有重载）来连接引号内的字符串或字符串变量，而是使用特殊的占位符来表示数据将来的位置。而且它还将插入格式化字符串的参数，以逗号分隔，排成一行。例如：</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code>System<span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">printf</span><span class="token punctuation">(</span><span class="token string">"Row 1: [%d %f]%n"</span><span class="token punctuation">,</span> x<span class="token punctuation">,</span> y<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这一行代码在运行的时候，首先将 <code v-pre>x</code> 的值插入到 <code v-pre>%d_</code> 的位置，然后将 <code v-pre>y</code> 的值插入到 <code v-pre>%f</code> 的位置。这些占位符叫做<em>格式修饰符</em>，它们不仅指明了插入数据的位置，同时还指明了将会插入什么类型的变量，以及如何格式化。在这个例子中 <code v-pre>%d</code> 表示 <code v-pre>x</code> 是一个整数，<code v-pre>%f</code> 表示 <code v-pre>y</code> 是一个浮点数（<code v-pre>float</code> 或者 <code v-pre>double</code>）。</p>
<h3 id="system-out-format" tabindex="-1"><a class="header-anchor" href="#system-out-format" aria-hidden="true">#</a> <code v-pre>System.out.format()</code></h3>
<p>Java SE5 引入了 <code v-pre>format()</code> 方法，可用于 <code v-pre>PrintStream</code> 或者 <code v-pre>PrintWriter</code> 对象（你可以在 <RouterLink to="/OnJava8/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 了解更多内容），其中也包括 <code v-pre>System.out</code> 对象。<code v-pre>format()</code> 方法模仿了 C 语言的 <code v-pre>printf()</code>。如果你比较怀旧的话，也可以使用 <code v-pre>printf()</code>。以下是一个简单的示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/SimpleFormat.java </span>
...
Row 1: [5 5.332542] 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到，<code v-pre>format()</code> 和  <code v-pre>printf()</code> 是等价的，它们只需要一个简单的格式化字符串，加上一串参数即可，每个参数对应一个格式修饰符。</p>
<p><code v-pre>String</code> 类也有一个 <code v-pre>static format()</code> 方法，可以格式化字符串。</p>
<h3 id="formatter-类" tabindex="-1"><a class="header-anchor" href="#formatter-类" aria-hidden="true">#</a> <code v-pre>Formatter</code> 类</h3>
<p>在 Java 中，所有的格式化功能都是由 <code v-pre>java.util.Formatter</code> 类处理的。可以将 <code v-pre>Formatter</code> 看做一个翻译器，它将你的格式化字符串与数据翻译成需要的结果。当你创建一个 <code v-pre>Formatter</code> 对象时，需要向其构造器传递一些信息，告诉它最终的结果将向哪里输出：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Turtle.java </span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>格式化修饰符 <code v-pre>%s</code> 表明这里需要 <code v-pre>String</code> 参数。</p>
<p>所有的 <code v-pre>tommy</code> 都将输出到 <code v-pre>System.out</code>，而所有的 <code v-pre>terry</code> 则都输出到 <code v-pre>System.out</code> 的一个别名中。<code v-pre>Formatter</code> 的重载构造器支持输出到多个路径，不过最常用的还是 <code v-pre>PrintStream()</code>（如上例）、<code v-pre>OutputStream</code> 和 <code v-pre>File</code>。你可以在 <RouterLink to="/OnJava8/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 中了解更多信息。</p>
<h3 id="格式化修饰符" tabindex="-1"><a class="header-anchor" href="#格式化修饰符" aria-hidden="true">#</a> 格式化修饰符</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>最常见的应用是控制一个字段的最小长度，这可以通过指定 <em>width</em> 来实现。<code v-pre>Formatter </code>对象通过在必要时添加空格，来确保一个字段至少达到设定长度。默认情况下，数据是右对齐的，不过可以通过使用 <code v-pre>-</code> 标志来改变对齐方向。</p>
<p>与 <em>width</em> 相对的是 <em>precision</em>，用于指定最大长度。<em>width</em> 可以应用于各种类型的数据转换，并且其行为方式都一样。<em>precision</em> 则不然，当应用于不同类型的数据转换时，<em>precision</em> 的意义也不同。在将 <em>precision</em> 应用于 <code v-pre>String</code> 时，它表示打印 <code v-pre>string</code> 时输出字符的最大数量。而在将 <em>precision</em> 应用于浮点数时，它表示小数部分要显示出来的位数（默认是 6 位小数），如果小数位数过多则舍入，太少则在尾部补零。由于整数没有小数部分，所以 <em>precision</em> 无法应用于整数，如果你对整数应用 <em>precision</em>，则会触发异常。</p>
<p>下面的程序应用格式修饰符来打印一个购物收据。这是 <em>Builder</em> 设计模式的一个简单实现，即先创建一个初始对象，然后逐渐添加新东西，最后调用 <code v-pre>build()</code> 方法完成构建：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ReceiptBuilder.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
Total                      49.39 
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过传入一个 <code v-pre>StringBuilder</code> 对象到 <code v-pre>Formatter</code> 的构造器，我们指定了一个容器来构建目标 <code v-pre>String</code>。你也可以通过不同的构造器参数，把结果输出到标准输出，甚至是一个文件里。</p>
<p>正如你所见，通过相当简洁的语法，<code v-pre>Formatter </code> 提供了对空格与对齐的强大控制能力。在该程序中，为了恰当地控制间隔，格式化字符串被重复利用了多遍。</p>
<h3 id="formatter-转换" tabindex="-1"><a class="header-anchor" href="#formatter-转换" aria-hidden="true">#</a> <code v-pre>Formatter</code> 转换</h3>
...
<td style="text-align:left">整型（十进制）</td>
</tr>
<tr>
...
<tr>
<td style="text-align:center"><code v-pre>b</code></td>
<td style="text-align:left">Boolean值</td>
</tr>
<tr>
...
<td style="text-align:left">浮点数（十进制）</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>e</code></td>
<td style="text-align:left">浮点数（科学计数）</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>x</code></td>
<td style="text-align:left">整型（十六进制）</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>h</code></td>
<td style="text-align:left">散列码（十六进制）</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>%</code></td>
<td style="text-align:left">字面值“%”</td>
</tr>
</tbody>
</table>
<p>下面的程序演示了这些转换是如何工作的：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Conversion.java </span>
...
<p>注意，程序中的每个变量都用到了 <code v-pre>b</code> 转换。虽然它对各种类型都是合法的，但其行为却不一定与你想象的一致。对于 <code v-pre>boolean</code> 基本类型或 <code v-pre>Boolean</code> 对象，其转换结果是对应的 <code v-pre>true</code> 或 <code v-pre>false</code>。但是，对其他类型的参数，只要该参数不为 <code v-pre>null</code>，其转换结果永远都是 <code v-pre>true</code>。即使是数字 0，转换结果依然为 <code v-pre>true</code>，而这在其他语言中（包括C），往往转换为 <code v-pre>false</code>。所以，将 <code v-pre>b</code> 应用于非布尔类型的对象时请格外小心。</p>
<p>还有许多不常用的类型转换与格式修饰符选项，你可以在 JDK 文档中的 <code v-pre>Formatter</code> 类部分找到它们。</p>
<h3 id="string-format" tabindex="-1"><a class="header-anchor" href="#string-format" aria-hidden="true">#</a> <code v-pre>String.format()</code></h3>
<p>Java SE5 也参考了 C 中的 <code v-pre>sprintf()</code> 方法，以生成格式化的 <code v-pre>String</code> 对象。<code v-pre>String.format()</code> 是一个 <code v-pre>static</code> 方法，它接受与 <code v-pre>Formatter.format()</code> 方法一样的参数，但返回一个 <code v-pre>String</code> 对象。当你只需使用一次 <code v-pre>format()</code> 方法的时候，<code v-pre>String.format()</code> 用起来很方便。例如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/DatabaseException.java </span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其实在 <code v-pre>String.format()</code> 内部，它也是创建了一个 <code v-pre>Formatter</code> 对象，然后将你传入的参数转给 <code v-pre>Formatter</code>。不过，与其自己做这些事情，不如使用便捷的 <code v-pre>String.format()</code> 方法，何况这样的代码更清晰易读。</p>
<h4 id="一个十六进制转储-dump-工具" tabindex="-1"><a class="header-anchor" href="#一个十六进制转储-dump-工具" aria-hidden="true">#</a> 一个十六进制转储（dump）工具</h4>
<p>在第二个例子中，我们把二进制文件转换为十六进制格式。下面的小工具使用了 <code v-pre>String.format()</code> 方法，以可读的十六进制格式将字节数组打印出来：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Hex.java </span>
...
00050: 45 0A 00 14 00 46 0A 00 47 00 48 07 00 49 01 00
                  ... 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了打开及读入二进制文件，我们用到了另一个工具 <code v-pre>Files.readAllBytes()</code>，这已经在 <RouterLink to="/OnJava8/17-Files.html">Files章节</RouterLink> 介绍过了。这里的 <code v-pre>readAllBytes()</code> 方法将整个文件以 <code v-pre>byte</code> 数组的形式返回。</p>
<!-- Regular Expressions -->
<h2 id="正则表达式" tabindex="-1"><a class="header-anchor" href="#正则表达式" aria-hidden="true">#</a> 正则表达式</h2>
<p>很久之前，<em>正则表达式</em>就已经整合到标准 Unix 工具集之中，例如 sed、awk 和程序语言之中了，如 Python 和Perl（有些人认为正是正则表达式促成了 Perl 的成功）。而在 Java 中，字符串操作还主要集中于<code v-pre>String</code>、<code v-pre>StringBuffer</code> 和 <code v-pre>StringTokenizer</code> 类。与正则表达式相比较，它们只能提供相当简单的功能。</p>
<p>正则表达式是一种强大而灵活的文本处理工具。使用正则表达式，我们能够以编程的方式，构造复杂的文本模式，并对输入 <code v-pre>String</code> 进行搜索。一旦找到了匹配这些模式的部分，你就能随心所欲地对它们进行处理。初学正则表达式时，其语法是一个难点，但它确实是一种简洁、动态的语言。正则表达式提供了一种完全通用的方式，能够解决各种 <code v-pre>String</code> 处理相关的问题：匹配、选择、编辑以及验证。</p>
<h3 id="基础" tabindex="-1"><a class="header-anchor" href="#基础" aria-hidden="true">#</a> 基础</h3>
<p>一般来说，正则表达式就是以某种方式来描述字符串，因此你可以说：“如果一个字符串含有这些东西，那么它就是我正在找的东西。”例如，要找一个数字，它可能有一个负号在最前面，那你就写一个负号加上一个问号，就像这样：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token operator">?</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>要描述一个整数，你可以说它有一位或多位阿拉伯数字。在正则表达式中，用 <code v-pre>\d</code> 表示一位数字。如果在其他语言中使用过正则表达式，那你可能就能发现 Java 对反斜线 \ 的不同处理方式。在其他语言中，<code v-pre>\\</code> 表示“我想要在正则表达式中插入一个普通的（字面上的）反斜线，请不要给它任何特殊的意义。”而在Java中，<code v-pre>\\</code> 的意思是“我要插入一个正则表达式的反斜线，所以其后的字符具有特殊的意义。”例如，如果你想表示一位数字，那么正则表达式应该是 <code v-pre>\\d</code>。如果你想插入一个普通的反斜线，应该这样写 <code v-pre>\\\</code>。不过换行符和制表符之类的东西只需要使用单反斜线：<code v-pre>\n\t</code>。 <a href="Java%E5%B9%B6%E9%9D%9E%E5%9C%A8%E4%B8%80%E5%BC%80%E5%A7%8B%E5%B0%B1%E6%94%AF%E6%8C%81%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F%EF%BC%8C%E5%9B%A0%E6%AD%A4%E8%BF%99%E4%B8%AA%E4%BB%A4%E4%BA%BA%E8%B4%B9%E8%A7%A3%E7%9A%84%E8%AF%AD%E6%B3%95%E6%98%AF%E7%A1%AC%E5%A1%9E%E8%BF%9B%E6%9D%A5%E7%9A%84%E3%80%82">^2</a></p>
<p>要表示“一个或多个之前的表达式”，应该使用 <code v-pre>+</code>。所以，如果要表示“可能有一个负号，后面跟着一位或多位数字”，可以这样：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token operator">?</span>\\d<span class="token operator">+</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>应用正则表达式最简单的途径，就是利用 <code v-pre>String</code> 类内建的功能。例如，你可以检查一个 <code v-pre>String</code> 是否匹配如上所述的正则表达式：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/IntegerMatch.java </span>
...
true 
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>前两个字符串都满足对应的正则表达式，匹配成功。第三个字符串以 <code v-pre>+</code> 开头，这也是一个合法的符号，但与对应的正则表达式却不匹配。因此，我们的正则表达式应该描述为：“可能以一个加号或减号开头”。在正则表达式中，用括号将表达式进行分组，用竖线 <code v-pre>|</code> 表示或操作。也就是：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token punctuation">(</span><span class="token operator">-</span><span class="token operator">|</span>\\<span class="token operator">+</span><span class="token punctuation">)</span><span class="token operator">?</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这个正则表达式表示字符串的起始字符可能是一个 <code v-pre>-</code> 或 <code v-pre>+</code>，或者二者都没有（因为后面跟着 <code v-pre>?</code> 修饰符）。因为字符 <code v-pre>+</code> 在正则表达式中有特殊的意义，所以必须使用 <code v-pre>\\</code> 将其转义，使之成为表达式中的一个普通字符。</p>
<p><code v-pre>String</code>类还自带了一个非常有用的正则表达式工具——<code v-pre>split()</code> 方法，其功能是“将字符串从正则表达式匹配的地方切开。”</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Splitting.java import java.util.*; </span>
...
herring!]
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>首先看第一个语句，注意这里用的是普通的字符作为正则表达式，其中并不包含任何特殊字符。因此第一个 <code v-pre>split()</code> 只是按空格来划分字符串。</p>
<p>第二个和第三个 <code v-pre>split()</code> 都用到了 <code v-pre>\\W</code>，它的意思是一个非单词字符（如果 W 小写，<code v-pre>\\w</code>，则表示一个单词字符）。通过第二个例子可以看到，它将标点字符删除了。第三个 <code v-pre>split()</code> 表示“字母 <code v-pre>n</code> 后面跟着一个或多个非单词字符。”可以看到，在原始字符串中，与正则表达式匹配的部分，在最终结果中都不存在了。</p>
<p><code v-pre>String.split()</code> 还有一个重载的版本，它允许你限制字符串分割的次数。</p>
<p>用正则表达式进行替换操作时，你可以只替换第一处匹配，也可以替换所有的匹配：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Replacing.java </span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第一个表达式要匹配的是，以字母 <code v-pre>f</code> 开头，后面跟一个或多个字母（注意这里的 <code v-pre>w</code> 是小写的）。并且只替换掉第一个匹配的部分，所以 “found” 被替换成 “located”。</p>
<p>第二个表达式要匹配的是三个单词中的任意一个，因为它们以竖线分割表示“或”，并且替换所有匹配的部分。</p>
<p>稍后你会看到，<code v-pre>String</code> 之外的正则表达式还有更强大的替换工具，例如，可以通过方法调用执行替换。而且，如果正则表达式不是只使用一次的话，非 <code v-pre>String</code> 对象的正则表达式明显具备更佳的性能。</p>
<h3 id="创建正则表达式" tabindex="-1"><a class="header-anchor" href="#创建正则表达式" aria-hidden="true">#</a> 创建正则表达式</h3>
<p>我们首先从正则表达式可能存在的构造集中选取一个很有用的子集，以此开始学习正则表达式。正则表达式的完整构造子列表，请参考JDK文档 <code v-pre>java.util.regex</code> 包中的 <code v-pre>Pattern</code>类。</p>
<table>
<thead>
<tr>
...
<td style="text-align:left">指定字符<code v-pre>B</code></td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\xhh</code></td>
<td style="text-align:left">十六进制值为<code v-pre>0xhh</code>的字符</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\uhhhh</code></td>
<td style="text-align:left">十六进制表现为<code v-pre>0xhhhh</code>的Unicode字符</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\t</code></td>
<td style="text-align:left">制表符Tab</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\n</code></td>
...
<tr>
<td style="text-align:left"><code v-pre>\f</code></td>
<td style="text-align:left">换页</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\e</code></td>
<td style="text-align:left">转义（Escape）</td>
</tr>
</tbody>
</table>
<p>当你学会了使用字符类（character classes）之后，正则表达式的威力才能真正显现出来。以下是一些创建字符类的典型方式，以及一些预定义的类：</p>
<table>
<thead>
<tr>
<th style="text-align:left">表达式</th>
...
<tr>
<td style="text-align:left"><code v-pre>[abc]</code></td>
<td style="text-align:left">包含<code v-pre>a</code>、<code v-pre>b</code>或<code v-pre>c</code>的任何字符（和`a</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>[^abc]</code></td>
<td style="text-align:left">除<code v-pre>a</code>、<code v-pre>b</code>和<code v-pre>c</code>之外的任何字符（否定）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>[a-zA-Z]</code></td>
<td style="text-align:left">从<code v-pre>a</code>到<code v-pre>z</code>或从<code v-pre>A</code>到<code v-pre>Z</code>的任何字符（范围）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>[abc[hij]]</code></td>
<td style="text-align:left"><code v-pre>a</code>、<code v-pre>b</code>、<code v-pre>c</code>、<code v-pre>h</code>、<code v-pre>i</code>、<code v-pre>j</code>中的任意字符（与`a</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>[a-z&amp;&amp;[hij]]</code></td>
<td style="text-align:left">任意<code v-pre>h</code>、<code v-pre>i</code>或<code v-pre>j</code>（交）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\s</code></td>
<td style="text-align:left">空白符（空格、tab、换行、换页、回车）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\S</code></td>
<td style="text-align:left">非空白符（<code v-pre>[^\s]</code>）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\d</code></td>
<td style="text-align:left">数字（<code v-pre>[0-9]</code>）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\D</code></td>
<td style="text-align:left">非数字（<code v-pre>[^0-9]</code>）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\w</code></td>
<td style="text-align:left">词字符（<code v-pre>[a-zA-Z_0-9]</code>）</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>\W</code></td>
<td style="text-align:left">非词字符（<code v-pre>[^\w]</code>）</td>
</tr>
</tbody>
</table>
<p>这里只列出了部分常用的表达式，你应该将JDK文档中 <code v-pre>java.util.regex.Pattern</code> 那一页加入浏览器书签中，以便在需要的时候方便查询。</p>
<table>
<thead>
<tr>
<th style="text-align:center">逻辑操作符</th>
<th style="text-align:left">含义</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center"><code v-pre>XY</code></td>
<td style="text-align:left"><code v-pre>Y</code>跟在<code v-pre>X</code>后面</td>
</tr>
<tr>
...
<tr>
<td style="text-align:center"><code v-pre>(X)</code></td>
<td style="text-align:left">捕获组（capturing group）。可以在表达式中用<code v-pre>\i</code>引用第i个捕获组</td>
</tr>
</tbody>
</table>
<p>下面是不同的边界匹配符：</p>
...
<thead>
<tr>
<th style="text-align:center">边界匹配符</th>
<th style="text-align:left">含义</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center"><code v-pre>^</code></td>
<td style="text-align:left">一行的开始</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>$</code></td>
<td style="text-align:left">一行的结束</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>\b</code></td>
<td style="text-align:left">词的边界</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>\B</code></td>
<td style="text-align:left">非词的边界</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>\G</code></td>
<td style="text-align:left">前一个匹配的结束</td>
</tr>
</tbody>
</table>
<p>作为演示，下面的每一个正则表达式都能成功匹配字符序列“Rudolph”：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Rudolph.java </span>
...
true 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们的目的并不是编写最难理解的正则表达式，而是尽量编写能够完成任务的、最简单以及最必要的正则表达式。一旦真正开始使用正则表达式了，你就会发现，在编写新的表达式之前，你通常会参考代码中已经用到的正则表达式。</p>
<h3 id="量词" tabindex="-1"><a class="header-anchor" href="#量词" aria-hidden="true">#</a> 量词</h3>
<p>量词描述了一个模式捕获输入文本的方式：</p>
<ul>
<li>
<p><strong>贪婪型</strong>：
量词总是贪婪的，除非有其他的选项被设置。贪婪表达式会为所有可能的模式发现尽可能多的匹配。导致此问题的一个典型理由就是假定我们的模式仅能匹配第一个可能的字符组，如果它是贪婪的，那么它就会继续往下匹配。</p>
</li>
<li>
<p><strong>勉强型</strong>：
用问号来指定，这个量词匹配满足模式所需的最少字符数。因此也被称作懒惰的、最少匹配的、非贪婪的或不贪婪的。</p>
</li>
<li>
<p><strong>占有型</strong>：
目前，这种类型的量词只有在 Java 语言中才可用（在其他语言中不可用），并且也更高级，因此我们大概不会立刻用到它。当正则表达式被应用于 <code v-pre>String</code> 时，它会产生相当多的状态，以便在匹配失败时可以回溯。而“占有的”量词并不保存这些中间状态，因此它们可以防止回溯。它们常常用于防止正则表达式失控，因此可以使正则表达式执行起来更高效。</p>
</li>
</ul>
<table>
<thead>
...
<td><code v-pre>X??</code></td>
<td><code v-pre>X?+</code></td>
<td>一个或零个<code v-pre>X</code></td>
</tr>
<tr>
<td><code v-pre>X*</code></td>
<td><code v-pre>X*?</code></td>
<td><code v-pre>X*+</code></td>
<td>零个或多个<code v-pre>X</code></td>
</tr>
<tr>
<td><code v-pre>X+</code></td>
<td><code v-pre>X+?</code></td>
<td><code v-pre>X++</code></td>
<td>一个或多个<code v-pre>X</code></td>
</tr>
<tr>
<td><code v-pre>X{n}</code></td>
<td><code v-pre>X{n}?</code></td>
<td><code v-pre>X{n}+</code></td>
<td>恰好<code v-pre>n</code>次<code v-pre>X</code></td>
</tr>
<tr>
<td><code v-pre>X{n,}</code></td>
<td><code v-pre>X{n,}?</code></td>
<td><code v-pre>X{n,}+</code></td>
<td>至少<code v-pre>n</code>次<code v-pre>X</code></td>
</tr>
<tr>
<td><code v-pre>X{n,m}</code></td>
<td><code v-pre>X{n,m}?</code></td>
<td><code v-pre>X{n,m}+</code></td>
<td><code v-pre>X</code>至少<code v-pre>n</code>次，但不超过<code v-pre>m</code>次</td>
</tr>
</tbody>
</table>
<p>应该非常清楚地意识到，表达式 <code v-pre>X</code> 通常必须要用圆括号括起来，以便它能够按照我们期望的效果去执行。例如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>abc<span class="token operator">+</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>看起来它似乎应该匹配1个或多个<code v-pre>abc</code>序列，如果我们把它应用于输入字符串<code v-pre>abcabcabc</code>，则实际上会获得3个匹配。然而，这个表达式实际上表示的是：匹配<code v-pre>ab</code>，后面跟随1个或多个<code v-pre>c</code>。要表明匹配1个或多个完整的字符串<code v-pre>abc</code>，我们必须这样表示：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token punctuation">(</span>abc<span class="token punctuation">)</span><span class="token operator">+</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你会发现，在使用正则表达式时很容易混淆，因为它是一种在 Java 之上的新语言。</p>
<h3 id="charsequence" tabindex="-1"><a class="header-anchor" href="#charsequence" aria-hidden="true">#</a> <code v-pre>CharSequence</code></h3>
<p>接口 <code v-pre>CharSequence</code> 从 <code v-pre>CharBuffer</code>、<code v-pre>String</code>、<code v-pre>StringBuffer</code>、<code v-pre>StringBuilder</code> 类中抽象出了字符序列的一般化定义：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">CharSequence</span> <span class="token punctuation">{</span>   
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因此，这些类都实现了该接口。多数正则表达式操作都接受 <code v-pre>CharSequence</code> 类型参数。</p>
<h3 id="pattern-和-matcher" tabindex="-1"><a class="header-anchor" href="#pattern-和-matcher" aria-hidden="true">#</a> <code v-pre>Pattern</code> 和 <code v-pre>Matcher</code></h3>
<p>通常，比起功能有限的 <code v-pre>String</code> 类，我们更愿意构造功能强大的正则表达式对象。只需导入 <code v-pre>java.util.regex</code>包，然后用 <code v-pre>static Pattern.compile()</code> 方法来编译你的正则表达式即可。它会根据你的 <code v-pre>String</code> 类型的正则表达式生成一个 <code v-pre>Pattern</code> 对象。接下来，把你想要检索的字符串传入 <code v-pre>Pattern</code> 对象的 <code v-pre>matcher()</code> 方法。<code v-pre>matcher()</code> 方法会生成一个 <code v-pre>Matcher</code> 对象，它有很多功能可用（可以参考 <code v-pre>java.util.regext.Matcher</code> 的 JDK 文档）。例如，它的 <code v-pre>replaceAll()</code> 方法能将所有匹配的部分都替换成你传入的参数。</p>
<p>作为第一个示例，下面的类可以用来测试正则表达式，看看它们能否匹配一个输入字符串。第一个控制台参数是将要用来搜索匹配的输入字符串，后面的一个或多个参数都是正则表达式，它们将被用来在输入的第一个字符串中查找匹配。在Unix/Linux上，命令行中的正则表达式必须用引号括起来。这个程序在测试正则表达式时很有用，特别是当你想验证它们是否具备你所期待的匹配功能的时候。<a href="%E7%BD%91%E4%B8%8A%E8%BF%98%E6%9C%89%E5%BE%88%E5%A4%9A%E5%AE%9E%E7%94%A8%E5%B9%B6%E4%B8%94%E6%88%90%E7%86%9F%E7%9A%84%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F%E5%B7%A5%E5%85%B7%E3%80%82">^3</a></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/TestRegularExpression.java </span>
...
Match "abc" at positions 12-14 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还可以在控制台参数中加入<code v-pre>“(abc){2,}”</code>，看看执行结果。</p>
<p><code v-pre>Pattern</code> 对象表示编译后的正则表达式。从这个例子可以看到，我们使用已编译的 <code v-pre>Pattern</code> 对象上的 <code v-pre>matcher()</code> 方法，加上一个输入字符串，从而共同构造了一个 <code v-pre>Matcher</code> 对象。同时，<code v-pre>Pattern</code> 类还提供了一个<code v-pre>static</code>方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>该方法用以检查 <code v-pre>regex</code> 是否匹配整个 <code v-pre>CharSequence</code> 类型的 <code v-pre>input</code> 参数。编译后的 <code v-pre>Pattern</code> 对象还提供了 <code v-pre>split()</code> 方法，它从匹配了 <code v-pre>regex</code> 的地方分割输入字符串，返回分割后的子字符串 <code v-pre>String</code> 数组。</p>
<p>通过调用 <code v-pre>Pattern.matcher()</code> 方法，并传入一个字符串参数，我们得到了一个 <code v-pre>Matcher</code> 对象。使用 <code v-pre>Matcher</code> 上的方法，我们将能够判断各种不同类型的匹配是否成功：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">boolean</span> <span class="token function">matches</span><span class="token punctuation">(</span><span class="token punctuation">)</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中的 <code v-pre>matches()</code> 方法用来判断整个输入字符串是否匹配正则表达式模式，而 <code v-pre>lookingAt()</code> 则用来判断该字符串（不必是整个字符串）的起始部分是否能够匹配模式。</p>
<h3 id="find" tabindex="-1"><a class="header-anchor" href="#find" aria-hidden="true">#</a> <code v-pre>find()</code></h3>
<p><code v-pre>Matcher.find()</code> 方法可用来在 <code v-pre>CharSequence</code> 中查找多个匹配。例如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Finding.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>模式 <code v-pre>\\w+</code> 将字符串划分为词。<code v-pre>find()</code> 方法像迭代器那样向前遍历输入字符串。而第二个重载的 <code v-pre>find()</code> 接收一个整型参数，该整数表示字符串中字符的位置，并以其作为搜索的起点。从结果可以看出，后一个版本的 <code v-pre>find()</code> 方法能够根据其参数的值，不断重新设定搜索的起始位置。</p>
<h3 id="组-groups" tabindex="-1"><a class="header-anchor" href="#组-groups" aria-hidden="true">#</a> 组（Groups）</h3>
<p>组是用括号划分的正则表达式，可以根据组的编号来引用某个组。组号为 0 表示整个表达式，组号 1 表示被第一对括号括起来的组，以此类推。因此，下面这个表达式，</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>中有三个组：组 0 是 <code v-pre>ABCD</code>，组 1 是 <code v-pre>BC</code>，组 2 是 <code v-pre>C</code>。</p>
<p><code v-pre>Matcher</code> 对象提供了一系列方法，用以获取与组相关的信息：</p>
<ul>
<li><code v-pre>public int groupCount()</code> 返回该匹配器的模式中的分组数目，组 0 不包括在内。</li>
<li><code v-pre>public String group()</code> 返回前一次匹配操作（例如 <code v-pre>find()</code>）的第 0 组（整个匹配）。</li>
<li><code v-pre>public String group(int i)</code> 返回前一次匹配操作期间指定的组号，如果匹配成功，但是指定的组没有匹配输入字符串的任何部分，则将返回 <code v-pre>null</code>。</li>
<li><code v-pre>public int start(int group)</code> 返回在前一次匹配操作中寻找到的组的起始索引。</li>
<li><code v-pre>public int end(int group)</code> 返回在前一次匹配操作中寻找到的组的最后一个字符索引加一的值。</li>
</ul>
<p>下面是正则表达式组的例子：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Groups.java</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这首诗来自于 Lewis Carroll 所写的 <em>Through the Looking Glass</em> 中的 “Jabberwocky”。可以看到这个正则表达式模式有许多圆括号分组，由任意数目的非空白符（<code v-pre>\\S+</code>）及随后的任意数目的空白符（<code v-pre>\\s+</code>）所组成。目的是捕获每行的最后3个词，每行最后以 <code v-pre>\$</code> 结束。不过，在正常情况下是将 <code v-pre>\$</code> 与整个输入序列的末端相匹配。所以我们一定要显式地告知正则表达式注意输入序列中的换行符。这可以由序列开头的模式标记 <code v-pre>(?m)</code> 来完成（模式标记马上就会介绍）。</p>
<h3 id="start-和-end" tabindex="-1"><a class="header-anchor" href="#start-和-end" aria-hidden="true">#</a> <code v-pre>start()</code> 和 <code v-pre>end()</code></h3>
<p>在匹配操作成功之后，<code v-pre>start()</code> 返回先前匹配的起始位置的索引，而 <code v-pre>end()</code> 返回所匹配的最后字符的索引加一的值。匹配操作失败之后（或先于一个正在进行的匹配操作去尝试）调用 <code v-pre>start()</code> 或 <code v-pre>end()</code> 将会产生 <code v-pre>IllegalStateException</code>。下面的示例还同时展示了 <code v-pre>matches()</code> 和 <code v-pre>lookingAt()</code> 的用法 [^4]：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/StartEnd.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
*/</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意，<code v-pre>find()</code> 可以在输入的任意位置定位正则表达式，而 <code v-pre>lookingAt()</code> 和 <code v-pre>matches()</code> 只有在正则表达式与输入的最开始处就开始匹配时才会成功。<code v-pre>matches()</code> 只有在整个输入都匹配正则表达式时才会成功，而 <code v-pre>lookingAt()</code> <a href="%E6%88%91%E4%B8%8D%E7%9F%A5%E9%81%93%E4%BB%96%E4%BB%AC%E6%98%AF%E5%A6%82%E4%BD%95%E6%83%B3%E5%87%BA%E8%BF%99%E4%B8%AA%E6%96%B9%E6%B3%95%E5%90%8D%E7%9A%84%EF%BC%8C%E6%88%96%E8%80%85%E5%AE%83%E5%88%B0%E5%BA%95%E6%8C%87%E7%9A%84%E4%BB%80%E4%B9%88%E3%80%82%E8%BF%99%E5%8F%AA%E6%98%AF%E4%BB%A3%E7%A0%81%E5%AE%A1%E6%9F%A5%E5%BE%88%E9%87%8D%E8%A6%81%E7%9A%84%E5%8E%9F%E5%9B%A0%E4%B9%8B%E4%B8%80%E3%80%82">^5</a> 只要输入的第一部分匹配就会成功。</p>
<h3 id="pattern-标记" tabindex="-1"><a class="header-anchor" href="#pattern-标记" aria-hidden="true">#</a> <code v-pre>Pattern</code> 标记</h3>
<p><code v-pre>Pattern</code> 类的 <code v-pre>compile()</code> 方法还有另一个版本，它接受一个标记参数，以调整匹配行为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>其中的 <code v-pre>flag</code> 来自以下 <code v-pre>Pattern</code> 类中的常量</p>
<table>
<thead>
<tr>
<th>编译标记</th>
...
<tbody>
<tr>
<td><code v-pre>Pattern.CANON_EQ</code></td>
<td>当且仅当两个字符的完全规范分解相匹配时，才认为它们是匹配的。例如，如果我们指定这个标记，表达式<code v-pre>\u003F</code>就会匹配字符串<code v-pre>?</code>。默认情况下，匹配不考虑规范的等价性</td>
</tr>
<tr>
<td><code v-pre>Pattern.CASE_INSENSITIVE(?i)</code></td>
<td>默认情况下，大小写不敏感的匹配假定只有US-ASCII字符集中的字符才能进行。这个标记允许模式匹配不考虑大小写（大写或小写）。通过指定<code v-pre>UNICODE_CASE</code>标记及结合此标记。基于Unicode的大小写不敏感的匹配就可以开启了</td>
</tr>
<tr>
<td><code v-pre>Pattern.COMMENTS(?x)</code></td>
<td>在这种模式下，空格符将被忽略掉，并且以<code v-pre>#</code>开始直到行末的注释也会被忽略掉。通过嵌入的标记表达式也可以开启Unix的行模式</td>
</tr>
<tr>
<td><code v-pre>Pattern.DOTALL(?s)</code></td>
<td>在dotall模式下，表达式<code v-pre>.</code>匹配所有字符，包括行终止符。默认情况下，<code v-pre>.</code>不会匹配行终止符</td>
</tr>
<tr>
<td><code v-pre>Pattern.MULTILINE(?m)</code></td>
<td>在多行模式下，表达式<code v-pre>^</code>和<code v-pre>$</code>分别匹配一行的开始和结束。<code v-pre>^</code>还匹配输入字符串的开始，而<code v-pre>$</code>还匹配输入字符串的结尾。默认情况下，这些表达式仅匹配输入的完整字符串的开始和结束</td>
</tr>
<tr>
<td><code v-pre>Pattern.UNICODE_CASE(?u)</code></td>
<td>当指定这个标记，并且开启<code v-pre>CASE_INSENSITIVE</code>时，大小写不敏感的匹配将按照与Unicode标准相一致的方式进行。默认情况下，大小写不敏感的匹配假定只能在US-ASCII字符集中的字符才能进行</td>
</tr>
<tr>
<td><code v-pre>Pattern.UNIX_LINES(?d)</code></td>
<td>在这种模式下，在<code v-pre>.</code>、<code v-pre>^</code>和<code v-pre>$</code>的行为中，只识别行终止符<code v-pre>\n</code></td>
</tr>
</tbody>
</table>
<p>在这些标记中，<code v-pre>Pattern.CASE_INSENSITIVE</code>、<code v-pre>Pattern.MULTILINE</code> 以及 <code v-pre>Pattern.COMMENTS</code>（对声明或文档有用）特别有用。请注意，你可以直接在正则表达式中使用其中的大多数标记，只需要将上表中括号括起来的字符插入到正则表达式中，你希望它起作用的位置即可。</p>
<p>你还可以通过“或”(<code v-pre>|</code>)操作符组合多个标记的功能：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ReFlags.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
JAVA 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个例子中，我们创建了一个模式，它将匹配所有以“java”、“Java”和“JAVA”等开头的行，并且是在设置了多行标记的状态下，对每一行（从字符序列的第一个字符开始，至每一个行终止符）都进行匹配。注意，<code v-pre>group()</code> 方法只返回已匹配的部分。</p>
<h3 id="split" tabindex="-1"><a class="header-anchor" href="#split" aria-hidden="true">#</a> <code v-pre>split()</code></h3>
<p><code v-pre>split()</code>方法将输入 <code v-pre>String</code> 断开成 <code v-pre>String</code> 对象数组，断开边界由正则表达式确定：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这是一个快速而方便的方法，可以按照通用边界断开输入文本：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/SplitDemo.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
[This, unusual use, of exclamation!!points]
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第二种形式的 <code v-pre>split()</code> 方法可以限制将输入分割成字符串的数量。</p>
<h3 id="替换操作" tabindex="-1"><a class="header-anchor" href="#替换操作" aria-hidden="true">#</a> 替换操作</h3>
<p>正则表达式在进行文本替换时特别方便，它提供了许多方法：</p>
<ul>
<li><code v-pre>replaceFirst(String replacement)</code> 以参数字符串 <code v-pre>replacement</code> 替换掉第一个匹配成功的部分。</li>
<li><code v-pre>replaceAll(String replacement)</code> 以参数字符串 <code v-pre>replacement</code> 替换所有匹配成功的部分。</li>
<li><code v-pre>appendReplacement(StringBuffer sbuf, String replacement)</code> 执行渐进式的替换，而不是像 <code v-pre>replaceFirst()</code> 和 <code v-pre>replaceAll()</code> 那样只替换第一个匹配或全部匹配。这是一个非常重要的方法。它允许你调用其他方法来生成或处理 <code v-pre>replacement</code>（<code v-pre>replaceFirst()</code> 和 <code v-pre>replaceAll()</code> 则只能使用一个固定的字符串），使你能够以编程的方式将目标分割成组，从而具备更强大的替换功能。</li>
<li><code v-pre>appendTail(StringBuffer sbuf)</code> 在执行了一次或多次 <code v-pre>appendReplacement()</code> 之后，调用此方法可以将输入字符串余下的部分复制到 <code v-pre>sbuf</code> 中。</li>
</ul>
<p>下面的程序演示了如何使用这些替换方法。开头部分注释掉的文本，就是正则表达式要处理的输入字符串：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/TheReplacements.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>nio<span class="token punctuation">.</span>file<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>stream<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span>
...
ExtrActEd blOck. 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此处使用上一章介绍过的 <RouterLink to="/OnJava8/17-Files.html"><code v-pre>Files</code></RouterLink> 类打开并读入文件。<code v-pre>Files.lines()</code> 返回一个 <code v-pre>Stream</code> 对象，包含读入的所有行，<code v-pre>Collectors.joining()</code> 在每一行的结尾追加参数字符序列，最终拼接成一个 <code v-pre>String</code> 对象。</p>
<p><code v-pre>mInput</code> 匹配 <code v-pre>/*!</code> 和 <code v-pre>！*/</code> 之间的所有文字（注意分组的括号）。接下来，将存在两个或两个以上空格的地方，缩减为一个空格，并且删除每行开头部分的所有空格（为了使每一行都达到这个效果，而不仅仅是删除文本开头部分的空格，这里特意开启了多行模式）。这两个替换操作所使用的的 <code v-pre>replaceAll()</code> 是 <code v-pre>String</code> 对象自带的方法，在这里，使用此方法更方便。注意，因为这两个替换操作都只使用了一次 <code v-pre>replaceAll()</code>，所以，与其编译为 <code v-pre>Pattern</code>，不如直接使用 <code v-pre>String</code> 的 <code v-pre>replaceAll()</code> 方法，而且开销也更小些。</p>
<p><code v-pre>replaceFirst()</code> 只对找到的第一个匹配进行替换。此外，<code v-pre>replaceFirst()</code> 和 <code v-pre>replaceAll()</code> 方法用来替换的只是普通字符串，所以，如果想对这些替换字符串进行某些特殊处理，这两个方法时无法胜任的。如果你想要那么做，就应该使用 <code v-pre>appendReplacement()</code> 方法。该方法允许你在执行替换的过程中，操作用来替换的字符串。在这个例子中，先构造了 <code v-pre>sbuf</code> 用来保存最终结果，然后用 <code v-pre>group()</code> 选择一个组，并对其进行处理，将正则表达式找到的元音字母替换成大些字母。一般情况下，你应该遍历执行所有的替换操作，然后再调用 <code v-pre>appendTail()</code> 方法，但是，如果你想模拟 <code v-pre>replaceFirst()</code>（或替换n次）的行为，那就只需要执行一次替换，然后调用 <code v-pre>appendTail()</code> 方法，将剩余未处理的部分存入 <code v-pre>sbuf</code> 即可。</p>
<p>同时，<code v-pre>appendReplacement()</code> 方法还允许你通过 <code v-pre>\$g</code> 直接找到匹配的某个组，这里的 <code v-pre>g</code> 就是组号。然而，它只能应付一些简单的处理，无法实现类似前面这个例子中的功能。</p>
<h3 id="reset" tabindex="-1"><a class="header-anchor" href="#reset" aria-hidden="true">#</a> <code v-pre>reset()</code></h3>
<p>通过 <code v-pre>reset()</code> 方法，可以将现有的 <code v-pre>Matcher</code> 对象应用于一个新的字符序列：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/Resetting.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
fix rig rag 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用不带参数的 <code v-pre>reset()</code> 方法，可以将 <code v-pre>Matcher</code> 对象重新设置到当前字符序列的起始位置。</p>
<h3 id="正则表达式与-java-i-o" tabindex="-1"><a class="header-anchor" href="#正则表达式与-java-i-o" aria-hidden="true">#</a> 正则表达式与 Java I/O</h3>
<p>到目前为止，我们看到的例子都是将正则表达式用于静态的字符串。下面的例子将向你演示，如何应用正则表达式在一个文件中进行搜索匹配操作。<code v-pre>JGrep.java</code> 的灵感源自于 Unix 上的 <em>grep</em>。它有两个参数：文件名以及要匹配的正则表达式。输出的是每行有匹配的部分以及匹配部分在行中的位置。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/JGrep.java </span>
...
1: for: 4 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Files.readAllLines()</code> 返回一个 <code v-pre>List&lt;String&gt;</code> 对象，这意味着可以用 <em>for-in</em> 进行遍历。虽然可以在 <code v-pre>for</code> 循环内部创建一个新的 <code v-pre>Matcher</code> 对象，但是，在循环体外创建一个空的 <code v-pre>Matcher</code> 对象，然后用 <code v-pre>reset()</code> 方法每次为 <code v-pre>Matcher</code> 加载一行输入，这种处理会有一定的性能优化。最后用 <code v-pre>find()</code> 搜索结果。</p>
<p>这里读入的测试参数是 <code v-pre>JGrep.java</code> 文件，然后搜索以 <code v-pre>[Ssct]</code> 开头的单词。</p>
<p>如果想要更深入地学习正则表达式，你可以阅读 Jeffrey E. F. Friedl 的《精通正则表达式（第2版）》。网络上也有很多正则表达式的介绍，你还可以从 Perl 和 Python 等其他语言的文档中找到有用的信息。</p>
<!-- Scanning Input -->
<h2 id="扫描输入" tabindex="-1"><a class="header-anchor" href="#扫描输入" aria-hidden="true">#</a> 扫描输入</h2>
<p>到目前为止，从文件或标准输入读取数据还是一件相当痛苦的事情。一般的解决办法就是读入一行文本，对其进行分词，然后使用 <code v-pre>Integer</code>、<code v-pre>Double</code> 等类的各种解析方法来解析数据：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/SimpleRead.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>io<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>input</code> 字段使用的类来自 <code v-pre>java.io</code>，<RouterLink to="/OnJava8/Appendix-IO-Streams.html">附录:流式 I/O</RouterLink> 详细介绍了相关内容。<code v-pre>StringReader</code> 将 <code v-pre>String</code> 转化为可读的流对象，然后用这个对象来构造 <code v-pre>BufferedReader</code> 对象，因为我们要使用 <code v-pre>BufferedReader</code> 的 <code v-pre>readLine()</code> 方法。最终，我们可以使用 <code v-pre>input</code> 对象一次读取一行文本，就像从控制台读入标准输入一样。</p>
<p><code v-pre>readLine()</code> 方法将一行输入转为 <code v-pre>String</code> 对象。如果每一行数据正好对应一个输入值，那这个方法也还可行。但是，如果两个输入值在同一行中，事情就不好办了，我们必须分解这个行，才能分别解析所需的输入值。在这个例子中，分解的操作发生在创建 <code v-pre>numArray</code>时。</p>
<p>终于，Java SE5 新增了 <code v-pre>Scanner</code> 类，它可以大大减轻扫描输入的工作负担：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/BetterRead.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
My favorite double is 0.809015. 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Scanner</code> 的构造器可以接收任意类型的输入对象，包括 <code v-pre>File</code>、<code v-pre>InputStream</code>、<code v-pre>String</code> 或者像此例中的<code v-pre>Readable</code> 实现类。<code v-pre>Readable</code> 是 Java SE5 中新加入的一个接口，表示“具有 <code v-pre>read()</code> 方法的某种东西”。上一个例子中的 <code v-pre>BufferedReader</code> 也归于这一类。</p>
<p>有了 <code v-pre>Scanner</code>，所有的输入、分词、以及解析的操作都隐藏在不同类型的 <code v-pre>next</code> 方法中。普通的 <code v-pre>next()</code> 方法返回下一个 <code v-pre>String</code>。所有的基本类型（除 <code v-pre>char</code> 之外）都有对应的 <code v-pre>next</code> 方法，包括 <code v-pre>BigDecimal</code> 和 <code v-pre>BigInteger</code>。所有的 next 方法，只有在找到一个完整的分词之后才会返回。<code v-pre>Scanner</code> 还有相应的 <code v-pre>hasNext</code> 方法，用以判断下一个输入分词是否是所需的类型，如果是则返回 <code v-pre>true</code>。</p>
<p>在 <code v-pre>BetterRead.java</code> 中没有用 <code v-pre>try</code> 区块捕获<code v-pre>IOException</code>。因为，<code v-pre>Scanner</code> 有一个假设，在输入结束时会抛出 <code v-pre>IOException</code>，所以 <code v-pre>Scanner</code> 会把 <code v-pre>IOException</code> 吞掉。不过，通过 <code v-pre>ioException()</code> 方法，你可以找到最近发生的异常，因此，你可以在必要时检查它。</p>
<h3 id="scanner-分隔符" tabindex="-1"><a class="header-anchor" href="#scanner-分隔符" aria-hidden="true">#</a> <code v-pre>Scanner</code> 分隔符</h3>
<p>默认情况下，<code v-pre>Scanner</code> 根据空白字符对输入进行分词，但是你可以用正则表达式指定自己所需的分隔符：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ScannerDelimiter.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span>
...
42 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个例子使用逗号（包括逗号前后任意的空白字符）作为分隔符，同样的技术也可以用来读取逗号分隔的文件。我们可以用 <code v-pre>useDelimiter()</code> 来设置分隔符，同时，还有一个 <code v-pre>delimiter()</code> 方法，用来返回当前正在作为分隔符使用的 <code v-pre>Pattern</code> 对象。</p>
<h3 id="用正则表达式扫描" tabindex="-1"><a class="header-anchor" href="#用正则表达式扫描" aria-hidden="true">#</a> 用正则表达式扫描</h3>
<p>除了能够扫描基本类型之外，你还可以使用自定义的正则表达式进行扫描，这在扫描复杂数据时非常有用。下面的例子将扫描一个防火墙日志文件中的威胁数据：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ThreatAnalyzer.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>regex<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span>
...
Threat on 08/12/2015 from 58.27.82.161 
*/</span>  
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当 <code v-pre>next()</code> 方法配合指定的正则表达式使用时，将找到下一个匹配该模式的输入部分，调用 <code v-pre>match()</code> 方法就可以获得匹配的结果。如上所示，它的工作方式与之前看到的正则表达式匹配相似。</p>
<p>在配合正则表达式使用扫描时，有一点需要注意：它仅仅针对下一个输入分词进行匹配，如果你的正则表达式中含有分隔符，那永远不可能匹配成功。</p>
<!-- StringTokenizer -->
<h2 id="stringtokenizer类" tabindex="-1"><a class="header-anchor" href="#stringtokenizer类" aria-hidden="true">#</a> StringTokenizer类</h2>
<p>在 Java 引入正则表达式（J2SE1.4）和 <code v-pre>Scanner</code> 类（Java SE5）之前，分割字符串的唯一方法是使用 <code v-pre>StringTokenizer</code> 来分词。不过，现在有了正则表达式和 <code v-pre>Scanner</code>，我们可以使用更加简单、更加简洁的方式来完成同样的工作了。下面的例子中，我们将 <code v-pre>StringTokenizer</code> 与另外两种技术简单地做了一个比较：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// strings/ReplacingStringTokenizer.java </span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token operator">*</span></span><span class="token punctuation">;</span> 
...
But I'm not dead yet! I feel happy! 
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用正则表达式或 <code v-pre>Scanner</code> 对象，我们能够以更加复杂的模式来分割一个字符串，而这对于 <code v-pre>StringTokenizer</code> 来说就很困难了。基本上，我们可以放心地说，<code v-pre>StringTokenizer</code> 已经可以废弃不用了。</p>
<!-- Summary -->
<h2 id="本章小结" tabindex="-1"><a class="header-anchor" href="#本章小结" aria-hidden="true">#</a> 本章小结</h2>
<p>过去，Java 对于字符串操作的技术相当不完善。不过随着近几个版本的升级，我们可以看到，Java 已经从其他语言中吸取了许多成熟的经验。到目前为止，它对字符串操作的支持已经很完善了。不过，有时你还要在细节上注意效率问题，例如恰当地使用 <code v-pre>StringBuilder</code> 等。</p>
<p>[^1]: C++允许编程人员任意重载操作符。这通常是很复杂的过程（参见Prentice Hall于2000年编写的《Thinking in C++（第2版）》第10章），因此Java设计者认为这是很糟糕的功能，不应该纳入到Java中。起始重载操作符并没有糟糕到只能自己去重载的地步，但具有讽刺意味的是，与C++相比，在Java中使用操作符重载要容易得多。这一点可以在Python(参见<a href="http://www.python.org" target="_blank" rel="noopener noreferrer">www.Python.org<ExternalLinkIcon/></a>)和C#中看到，它们都有垃圾回收机制，操作符重载也简单易懂。</p>
<p>[^4]: input来自于<a href="https://en.wikipedia.org/wiki/Galaxy_Quest" target="_blank" rel="noopener noreferrer">Galaxy Quest<ExternalLinkIcon/></a>中Taggart司令的一篇演讲。</p>
<!-- 分页 -->
