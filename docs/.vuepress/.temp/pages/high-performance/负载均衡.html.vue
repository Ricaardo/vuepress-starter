<template><div><h1 id="负载均衡" tabindex="-1"><a class="header-anchor" href="#负载均衡" aria-hidden="true">#</a> 负载均衡</h1>
...
<ul>
<li><a href="http://icyfenix.cn/architect-perspective/general-architecture/diversion-system/load-balancing.html" target="_blank" rel="noopener noreferrer">《凤凰架构》-负载均衡<ExternalLinkIcon/></a></li>
</ul>
</div></template>
