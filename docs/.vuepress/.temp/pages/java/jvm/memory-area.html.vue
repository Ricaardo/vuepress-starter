...
<p><img src="@source/java/jvm/pictures/java内存区域/JVM运行时数据区域.png" alt=""></p>
...
<p><img src="@source/java/jvm/pictures/java内存区域/《深入理解虚拟机》第三版的第2章-虚拟机栈.png" alt=""></p>
...
<p><img src="@source/java/jvm/pictures/java内存区域/JVM堆内存结构-JDK7.png" alt="JVM堆内存结构-JDK7"></p>
<p>JDK 8 版本之后方法区（HotSpot 的永久代）被彻底移除了（JDK1.7 就已经开始了），取而代之是元空间，元空间使用的是直接内存。</p>
<p><img src="@source/java/jvm/pictures/java内存区域/JVM堆内存结构-jdk8.png" alt="JVM堆内存结构-JDK8"></p>
...
<img src="@source/java/jvm/pictures/java内存区域/Java创建对象的过程.png" alt="Java创建对象的过程"></p>
...
<p><img src="@source/java/jvm/pictures/java内存区域/内存分配的两种方式.png" alt="内存分配的两种方式"></p>
...
<p><img src="@source/java/jvm/pictures/java内存区域/对象的访问定位-使用句柄.png" alt="对象的访问定位-使用句柄"></p>
</li>
<li>
<p><strong>直接指针：</strong> 如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而 reference 中存储的直接就是对象的地址。</p>
</li>
</ol>
<p><img src="@source/java/jvm/pictures/java内存区域/对象的访问定位-直接指针.png" alt="对象的访问定位-直接指针"></p>
