<template><div><h1 id="jwt-身份认证优缺点分析以及常见问题解决方案" tabindex="-1"><a class="header-anchor" href="#jwt-身份认证优缺点分析以及常见问题解决方案" aria-hidden="true">#</a> JWT 身份认证优缺点分析以及常见问题解决方案</h1>
<p>之前分享了一个使用 Spring Security 实现 JWT 身份认证的 Demo，文章地址：<a href="https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&amp;mid=2247485622&amp;idx=1&amp;sn=e9750ed63c47457ba1896db8dfceac6a&amp;chksm=cea2477df9d5ce6b7af20e582c6c60b7408a6459b05b849394c45f04664d1651510bdee029f7&amp;token=684071313&amp;lang=zh_CN&amp;scene=21#wechat_redirect" target="_blank" rel="noopener noreferrer">适合初学者入门 Spring Security With JWT 的 Demo<ExternalLinkIcon/></a>。 Demo 非常简单，没有介绍到 JWT 存在的一些问题。所以，单独抽了一篇文章出来介绍。为了完成这篇文章，我查阅了很多资料和文献，我觉得应该对大家有帮助。</p>
<p>相关阅读：</p>
<ul>
<li><a href="https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&amp;mid=2247485626&amp;idx=1&amp;sn=3247aa9000693dd692de8a04ccffeec1&amp;chksm=cea24771f9d5ce675ea0203633a95b68bfe412dc6a9d05f22d221161147b76161d1b470d54b3&amp;token=684071313&amp;lang=zh_CN&amp;scene=21#wechat_redirect" target="_blank" rel="noopener noreferrer">《一问带你区分清楚Authentication,Authorization以及Cookie、Session、Token》<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&amp;mid=2247485622&amp;idx=1&amp;sn=e9750ed63c47457ba1896db8dfceac6a&amp;chksm=cea2477df9d5ce6b7af20e582c6c60b7408a6459b05b849394c45f04664d1651510bdee029f7&amp;token=684071313&amp;lang=zh_CN&amp;scene=21#wechat_redirect" target="_blank" rel="noopener noreferrer">适合初学者入门 Spring Security With JWT 的 Demo<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&amp;mid=2247485640&amp;idx=1&amp;sn=0ff147808318d53b371f16bb730c96ef&amp;chksm=cea24703f9d5ce156ba67662f6f3f482330e8e6ebd9d44c61bf623083e9b941d8a180db6b0ea&amp;token=1533246333&amp;lang=zh_CN#rd" target="_blank" rel="noopener noreferrer">Spring Boot 使用 JWT 进行身份和权限验证<ExternalLinkIcon/></a></li>
</ul>
<h2 id="token-认证的优势" tabindex="-1"><a class="header-anchor" href="#token-认证的优势" aria-hidden="true">#</a> Token 认证的优势</h2>
<p>相比于 Session 认证的方式来说，使用 token 进行身份认证主要有下面四个优势：</p>
<h3 id="_1-无状态" tabindex="-1"><a class="header-anchor" href="#_1-无状态" aria-hidden="true">#</a> 1.无状态</h3>
...
<h3 id="_2-有效避免了csrf-攻击" tabindex="-1"><a class="header-anchor" href="#_2-有效避免了csrf-攻击" aria-hidden="true">#</a> 2.有效避免了CSRF 攻击</h3>
...
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.mybank.com/Transfer?bankId=11&amp;money=10000<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>科学理财，年盈利率过万<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>导致这个问题很大的原因就是： Session 认证中 Cookie 中的 session_id 是由浏览器发送到服务端的，借助这个特性，攻击者就可以通过让用户误点攻击链接，达到攻击效果。</p>
...
<p>但是这样会存在  XSS 攻击中被盗的风险，为了避免 XSS 攻击，你可以选择将 token 存储在标记为<code v-pre>httpOnly</code>  的cookie 中。但是，这样又导致了你必须自己提供CSRF保护。</p>
<p>具体采用上面哪种方式存储 token 呢，大部分情况下存放在  local storage 下都是最好的选择，某些情况下可能需要存放在标记为<code v-pre>httpOnly</code>  的cookie 中会更好。</p>
<h3 id="_3-适合移动端应用" tabindex="-1"><a class="header-anchor" href="#_3-适合移动端应用" aria-hidden="true">#</a> 3.适合移动端应用</h3>
...
<h3 id="_4-单点登录友好" tabindex="-1"><a class="header-anchor" href="#_4-单点登录友好" aria-hidden="true">#</a> 4.单点登录友好</h3>
...
<h2 id="token-认证常见问题以及解决办法" tabindex="-1"><a class="header-anchor" href="#token-认证常见问题以及解决办法" aria-hidden="true">#</a> Token 认证常见问题以及解决办法</h2>
<h3 id="_1-注销登录等场景下-token-还有效" tabindex="-1"><a class="header-anchor" href="#_1-注销登录等场景下-token-还有效" aria-hidden="true">#</a> 1.注销登录等场景下 token 还有效</h3>
<p>与之类似的具体相关场景有：</p>
<ol>
<li>退出登录;</li>
<li>修改密码;</li>
...
<h3 id="_2-token-的续签问题" tabindex="-1"><a class="header-anchor" href="#_2-token-的续签问题" aria-hidden="true">#</a> 2.token 的续签问题</h3>
...
<ul>
<li><a href="https://learnku.com/articles/17883?order_by=vote_count&amp;" target="_blank" rel="noopener noreferrer">JWT 超详细分析<ExternalLinkIcon/></a></li>
...
<li><a href="https://stackoverflow.com/questions/21978658/invalidating-json-web-tokens" target="_blank" rel="noopener noreferrer">Invalidating JSON Web Tokens<ExternalLinkIcon/></a></li>
</ul>
</div></template>
