<template><div><h1 id="java-命名之道" tabindex="-1"><a class="header-anchor" href="#java-命名之道" aria-hidden="true">#</a> Java 命名之道</h1>
...
<p>正例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">ServiceDiscovery</span>、<span class="token class-name">ServiceInstance</span>、<span class="token class-name">LruCacheFactory</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>反例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>serviceDiscovery、<span class="token class-name">Serviceinstance</span>、<span class="token class-name">LRUCacheFactory</span>
...
<p>正例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token function">getUserInfo</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//为远程传输部分抽象出来的一个抽象类（出处：Dubbo源码）</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//自定义的 NoSuchMethodException（出处：Dubbo源码）</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//为 AnnotationUtils 类写的测试类（出处：Dubbo源码）</span>
